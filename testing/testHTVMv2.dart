...
void main(List<String> arguments) {
    ...
    List<String> arrayTempOnlyGetSize1 = [Movable.array.name.prop1];
    List<String> arrayTempOnlyGetSize2 = [Movable.array.name.prop2];
    List<String> arrayTempOnlyGetSize3 = [Movable.array.name.prop3];
    List<String> arrayTempOnlyGetSize4 = [Movable.array.name.prop4];
