...
func funcName1(paramVar1 int, __HTVM_V2_TO_GO_optionalParams__ ...interface{}) {
    ...
    if len(__HTVM_V2_TO_GO_optionalParams__) > 2 {
        paramVar4 = __HTVM_V2_TO_GO_optionalParams__[2].(float64)
    }
...
func main() {
    ...
    for A_Index1 := 0; A_Index1 < HTVM_Size(array123); A_Index1++ {
    ...
    */
    ...
    for A_Index2 := 0; A_Index2 < 10; A_Index2++ {
        if (A_Index2 % 2 == 0) {
            continue
        }
        print(A_Index2)
