...
def arrayTempOnlyGetSize1 = [Movable.array.name.prop1]
def arrayTempOnlyGetSize2 = [Movable.array.name.prop2]
def arrayTempOnlyGetSize3 = [Movable.array.name.prop3]
def arrayTempOnlyGetSize4 = [Movable.array.name.prop4]
