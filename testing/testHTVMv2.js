...
let arrayTempOnlyGetSize1 = [Movable.array.name.prop1];
let arrayTempOnlyGetSize2 = [Movable.array.name.prop2];
let arrayTempOnlyGetSize3 = [Movable.array.name.prop3];
let arrayTempOnlyGetSize4 = [Movable.array.name.prop4];
