...
for A_Index1 in range(0, HTVM_Size(arrayTempOnlyGetSize1) + 0):
    print(Movable.array.name.prop1[A_Index1])
for A_Index2 in range(0, HTVM_Size(arrayTempOnlyGetSize2) + 0):
    print(Movable.array.name.prop2[A_Index2])
for A_Index3 in range(0, HTVM_Size(arrayTempOnlyGetSize3) + 0):
    print(Movable.array.name.prop3[A_Index3])
for A_Index4 in range(0, HTVM_Size(arrayTempOnlyGetSize4) + 0):
