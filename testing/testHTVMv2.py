...
def OSPHTVMOSP_Movable_Vehicles_move(OSP_OSP_THIS_KEYWORD_HTVM_OSP_THIS_HTVM_KEYWORD = ""):
    ...
    elif (OSP_OSP_THIS_KEYWORD_HTVM_OSP_THIS_HTVM_KEYWORD == "Movable.Vehicles.Bike"):
...
while (Movable_Vehicles_Car_hasFUEL == True and Movable_Vehicles_Bike_hasENERGY == True):
...
for A_Index1 in range(0, HTVM_Size(Movable_array_name_prop1) + 0):
    print(Movable_array_name_prop1[A_Index1])
for A_Index2 in range(0, HTVM_Size(Movable_array_name_prop2) + 0):
    print(Movable_array_name_prop2[A_Index2])
for A_Index3 in range(0, HTVM_Size(Movable_array_name_prop3) + 0):
    print(Movable_array_name_prop3[A_Index3])
for A_Index4 in range(0, HTVM_Size(Movable_array_name_prop4) + 0):
