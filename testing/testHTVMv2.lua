...
function OSPHTVMOSP_Movable_Vehicles_move(OSP_OSP_THIS_KEYWORD_HTVM_OSP_THIS_HTVM_KEYWORD)
    if (this == "Movable.Vehicles.Car") then
        if (Movable.Vehicles.Car.fuel > 0) then
    ...
    elseif (this == "Movable.Vehicles.Bike") then
        if (Movable.Vehicles.Bike.energy > 0) then
...
while (Movable.Vehicles.Car.hasFUEL == true and Movable.Vehicles.Bike.hasENERGY == true) do
...
for A_Index1 = 0 + 1 , HTVM_Size(arrayTempOnlyGetSize1) + 0 do
    print(Movable.array.name.prop1[A_Index1])
end
for A_Index2 = 0 + 1 , HTVM_Size(arrayTempOnlyGetSize2) + 0 do
    print(Movable.array.name.prop2[A_Index2])
end
for A_Index3 = 0 + 1 , HTVM_Size(arrayTempOnlyGetSize3) + 0 do
    print(Movable.array.name.prop3[A_Index3])
end
for A_Index4 = 0 + 1 , HTVM_Size(arrayTempOnlyGetSize4) + 0 do
