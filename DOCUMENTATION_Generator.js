...
let sentence = "Your language uses " + features.join(", ") + ".";
    ...
    for (let A_Index22 = 0; A_Index22 < HTVM_Size(parseDocumentationTemplatesARR); A_Index22++) {
        ...
        else if (A_Index22 == 10) {
            outMDsec17 = parseDocumentationTemplatesARR[A_Index22];
