...
let sentence = "Your language uses " + features.join(", ") + ".";
    ...
    var outMDsec7 = "" + Chr(10) + "### Loops" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Master the looping structures available in HTVM, such as the standard loop and infinite loops." + Chr(10) + "" + Chr(10) + "Example:" + Chr(10) + "" + Chr(96) + "" + Chr(96) + "" + Chr(96) + "htvm" + Chr(10) + "Loop, 5 {" + Chr(10) + "    print(A_Index)" + Chr(10) + "}" + Chr(10) + "" + Chr(96) + "" + Chr(96) + "" + Chr(96) + "" + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
    var outMDsec8 = "" + Chr(10) + "### If, Else, Else If" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Learn how to control the flow of your program with conditional statements like **if**, **else**, and **else if**. These structures allow you to handle decisions and branching logic in your code effectively." + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
    var outMDsec9 = "" + Chr(10) + "### Comments" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Add clarity to your code by using comments to document and explain your code. Comments are crucial for maintaining readability and ensuring that others can understand your thought process." + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
    ...
    var outMDsec14 = "" + Chr(10) + "### Extra Stuff" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Explore additional unique features and utilities HTVM offers for greater flexibility and ease of use. These features help make programming in HTVM even more powerful and efficient." + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
