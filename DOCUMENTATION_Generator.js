...
let sentence = "Your language uses " + features.join(", ") + ".";
    ...
    for (let A_Index26 = 0; A_Index26 < items26.length + 0; A_Index26++) {
        ...
        if (A_Index26 <= 161) {
            THEINSTESCEPAED += escapeStr(Trim(A_LoopField26)) + Chr(10);
        }
    }
    ...
    for (let A_Index27 = 0; A_Index27 < HTVM_Size(theCodeBuildInSnipped) + 0; A_Index27++) {
    ...
    for (let A_Index28 = 0; A_Index28 < items28.length + 0; A_Index28++) {
        ...
        if (Trim(A_LoopField28) == "AA--spettrrarateblatheCodeBuildInSnippeddxfjdzsiehdifx--sdhfkAA") {
            ...
            theCodeBuildInSnippedHelp6TEMP += A_LoopField28 + Chr(10);
        }
    }
    ...
    for (let A_Index29 = 0; A_Index29 < HTVM_Size(theCodeBuildInSnippedHelp6) + 0; A_Index29++) {
        outMD = StrReplace(outMD, Trim("AAbdsud--sblad0gblattheCodeBuildInSnippedHelpInt2reisurgfiugfusifsdygfuisdgfa--uksdusdfgusAA" + STR(A_Index29) + "AA"), Trim(theCodeBuildInSnippedHelp6[A_Index29]));
    }
    //outMD
    //outMD
    //outMD
...
async function main() {
    if (HTVM_getLang_HTVM() != "js") {
        ...
        for (let A_Index30 = 0; A_Index30 < items30.length + 0; A_Index30++) {
            ...
            if (A_Index30 == 0) {
                print(A_LoopField30);
                DOCS_param1 = Trim(A_LoopField30);
            }
            if (A_Index30 == 1) {
                print(A_LoopField30);
                DOCS_param2 = Trim(A_LoopField30);
            }
        }
