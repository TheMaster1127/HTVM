...
let sentence = "Your language uses " + features.join(", ") + ".";
    ...
    var outMDsec5 = "### Arrays" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Dive into working with arrays, one of the most essential data structures in HTVM. Arrays are simple to declare and manipulate, enabling you to store and process collections of data easily." + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
