...
function genDocs(mode) {
    ...
    for (let A_Index4 = 0; A_Index4 < items4.length + 0; A_Index4++) {
        ...
        if (A_Index4 == 100) {
            doc_keyWordComment = Trim(A_LoopField4);
        }
        if (A_Index4 == 101) {
            doc_keyWordCommentOpenMultiLine = Trim(A_LoopField4);
        }
        if (A_Index4 == 102) {
            doc_keyWordCommentCloseMultiLine = Trim(A_LoopField4);
        }
        if (A_Index4 == 69) {
        ...
        if (A_Index4 == 147) {
            doc_keyWordAIndex = Trim(A_LoopField4);
        }
        if (A_Index4 == 148) {
            doc_keyWordALoopField = Trim(A_LoopField4);
        }
        //;;;;;;;;;;;;;;;;;;;;;;;;;
        if (A_Index4 == 84) {
