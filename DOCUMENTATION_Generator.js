...
let sentence = "Your language uses " + features.join(", ") + ".";
    ...
    var outMDsec6 = "" + Chr(10) + "### Types" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Explore the different data types supported by HTVM and how to use them effectively. HTVM includes various types such as numbers, strings, and objects, making it easy to handle different kinds of data in a seamless way." + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
