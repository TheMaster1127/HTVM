...
std::string genDocs(std::string mode) {
    ...
    std::string FIXFIX_allInstructionFile = "";
    ...
    std::vector<std::string> items11 = LoopParseFunc(instructionFileData);
    ...
    std::vector<std::string> items12 = LoopParseFunc(instructionFileData, "\n", "\r");
    ...
    std::vector<std::string> items13 = LoopParseFunc(instructionFileData, "\n", "\r");
    ...
    if (DOCS_checkIfFuncNameExists == 1) {
        ...
        for (int A_Index14 = 0; A_Index14 < HTVM_Size(allFuncNames); A_Index14++) {
    ...
    std::string tempDesc = "";
    std::string tempLang = "";
    for (int A_Index15 = 0; A_Index15 < HTVM_Size(funcData_name); A_Index15++) {
        ...
        for (int A_Index16 = 0; A_Index16 < HTVM_Size(allFuncNames); A_Index16++) {
    ...
    int isDescNull = 0;
    for (int A_Index17 = 0; A_Index17 < HTVM_Size(allFuncNames); A_Index17++) {
        ...
        isLangTs = "No";
        isLangGroovy = "No";
        std::vector<std::string> items18 = LoopParseFunc(tempstr, "|");
    ...
    for (int A_Index19 = 0; A_Index19 < 20; A_Index19++) {
        //print("===========================================")
    }
    ...
    for (int A_Index20 = 0; A_Index20 < HTVM_Size(allFuncs); A_Index20++) {
        ...
        if (once == 1) {
            ...
            for (int A_Index21 = 0; A_Index21 < HTVM_Size(categories); A_Index21++) {
...
sentence += ".";
    ...
    std::string outMDsec17 = "";
    std::vector<std::string> parseDocumentationTemplatesARR;
    std::string new_osp = "";
    std::string new_osp1 = "";
    std::string new_osp2 = "";
    std::string new_osp3 = "";
    std::string new_osp4 = "";
    parseDocumentationTemplatesARR = parseDocumentationTemplates();
    std::string test123456789 = "";
    std::string test1234567892 = "";
    for (int A_Index22 = 0; A_Index22 < HTVM_Size(parseDocumentationTemplatesARR); A_Index22++) {
        if (A_Index22 == 0) {
    ...
    std::string struct_fix_4_keyWordAlliance = "";
    std::string struct_fix_5_keyWordCrew = "";
    std::string struct_fix_7_keyWordStruct = "";
    std::string struct_fix_8_keyWordProp = "";
    std::string struct_fix_47_keyWordCurlyBraceOpen = "";
    std::string struct_fix_48_keyWordCurlyBraceClose = "";
    std::string struct_fix_59_keyWordINT = "";
    std::string struct_fix_60_keyWordSTR = "";
    std::string struct_fix_61_keyWordBOOL = "";
    std::string struct_fix_62_keyWordFLOAT = "";
    std::string struct_fix_72_keyWordLoop = "";
    std::string struct_fix_85_keyWordArrayAppend = "";
    std::string struct_fix_87_keyWordArraySize = "";
    std::string struct_fix_92_keyWordArrayOfIntegersDefinition = "";
    std::string struct_fix_93_keyWordArrayOfStringsDefinition = "";
    std::string struct_fix_99_keyWordEnd = "";
    std::string struct_fix_101_keyWordComment = "";
    std::string struct_fix_105_keyWordMainLabel = "";
    std::string struct_fix_106_keyWordConcat = "";
    std::string struct_fix_130_keyWordAssign = "";
    std::string struct_fix_150_useCurlyBraces = "";
    std::string struct_fix_151_useEnd = "";
    std::string struct_fix_154_usePrefixTypeForTypeDefinition = "";
    std::string struct_fix_155_usePostfixTypeForTypeDefinition = "";
    int struct_fix_indexed = 0;
    std::vector<std::string> items23 = LoopParseFunc(instructionFileData, "\n", "\r");
    ...
    std::string str26 = "";
    std::string str27 = "";
    std::vector<std::string> theCodeBuildInSnipped;
    std::string theCodeBuildInSnippedHelp = "";
    std::string theCodeBuildInSnippedHelp1 = "";
    std::string theCodeBuildInSnippedHelp2 = "";
    int theCodeBuildInSnippedHelpInt = 0;
    int theCodeBuildInSnippedHelpInt1 = 0;
    int theCodeBuildInSnippedHelpInt2 = 0;
    for (int A_Index24 = 0; A_Index24 < HTVM_Size(categories); A_Index24++) {
    ...
    for (int A_Index25 = 0; A_Index25 < HTVM_Size(categories); A_Index25++) {
        //print(categories[A_Index])
        ...
        std::vector<std::string> items26 = LoopParseFunc(categoriesElement, "\n", "\r");
        ...
        std::vector<std::string> items27 = LoopParseFunc(categoriesElement, "\n", "\r");
        ...
        outMD += Chr(10) + "---" + Chr(10) + Chr(10);
        std::vector<std::string> items28 = LoopParseFunc(categoriesElement, "\n", "\r");
        for (size_t A_Index28 = 0; A_Index28 < items28.size(); A_Index28++) {
            ...
            if (A_Index28 != 0) {
                if (Trim(A_LoopField28) != "") {
                    ...
                    std::vector<std::string> items29 = LoopParseFunc(str9, "~~~");
                    ...
                    std::vector<std::string> items30 = LoopParseFunc(str8, "\n", "\r");
    ...
    std::vector<std::string> items31 = LoopParseFunc(instructionFileData, "\n", "\r");
    ...
    //outMD
    std::string theCodeBuildInSnippedHelp4 = "";
    std::string theCodeBuildInSnippedHelp5 = "";
    std::vector<std::string> theCodeBuildInSnippedHelp6;
    std::string theCodeBuildInSnippedHelp6TEMP = "";
    for (int A_Index32 = 0; A_Index32 < HTVM_Size(theCodeBuildInSnipped); A_Index32++) {
    ...
    std::vector<std::string> items33 = LoopParseFunc(theCodeBuildInSnippedHelp5, "\n", "\r");
    ...
    for (int A_Index34 = 0; A_Index34 < HTVM_Size(theCodeBuildInSnippedHelp6); A_Index34++) {
...
int main(int argc, char* argv[]) {
    if (HTVM_getLang_HTVM() != "js") {
        ...
        std::vector<std::string> items35 = LoopParseFunc(DOCS_params, "\n", "\r");
