...
sentence += ".";
        ...
        for (size_t A_Index23 = 0; A_Index23 < items23.size() + 0; A_Index23++) {
            ...
            if (A_Index23 != 0) {
                if (Trim(A_LoopField23) != "") {
                    ...
                    std::vector<std::string> items25 = LoopParseFunc(str8, "\n", "\r");
    ...
    std::vector<std::string> items26 = LoopParseFunc(instructionFileData, "\n", "\r");
    ...
    for (int A_Index27 = 0; A_Index27 < HTVM_Size(theCodeBuildInSnipped) + 0; A_Index27++) {
    ...
    std::vector<std::string> items28 = LoopParseFunc(theCodeBuildInSnippedHelp5, "\n", "\r");
    ...
    for (int A_Index29 = 0; A_Index29 < HTVM_Size(theCodeBuildInSnippedHelp6) + 0; A_Index29++) {
...
int main(int argc, char* argv[]) {
    if (HTVM_getLang_HTVM() != "js") {
        ...
        std::vector<std::string> items30 = LoopParseFunc(DOCS_params, "\n", "\r");
