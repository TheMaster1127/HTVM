...
std::string genDocs(std::string mode) {
    ...
    if (mode == "html") {
        ...
        std::vector<std::string> items6 = LoopParseFunc(instructionFileData, "\n", "\r");
        ...
        std::vector<std::string> items7 = LoopParseFunc(instructionFileData, "\n", "\r");
    ...
    if (DOCS_checkIfFuncNameExists == 1) {
        ...
        for (int A_Index9 = 0; A_Index9 < HTVM_Size(allFuncNames) + 0; A_Index9++) {
    ...
    std::string tempDesc = "";
    std::string tempLang = "";
    for (int A_Index10 = 0; A_Index10 < HTVM_Size(funcData_name) + 0; A_Index10++) {
    ...
    int isDescNull = 0;
    for (int A_Index12 = 0; A_Index12 < HTVM_Size(allFuncNames) + 0; A_Index12++) {
        ...
        isLangTs = "No";
        isLangGroovy = "No";
        std::vector<std::string> items13 = LoopParseFunc(tempstr, "|");
    ...
    for (int A_Index14 = 0; A_Index14 < 20 + 0; A_Index14++) {
        //print("===========================================")
    }
    ...
    for (int A_Index15 = 0; A_Index15 < HTVM_Size(allFuncs) + 0; A_Index15++) {
        ...
        if (once == 1) {
            ...
            for (int A_Index16 = 0; A_Index16 < HTVM_Size(categories) + 0; A_Index16++) {
...
sentence += ".";
    ...
    std::string outMDsec11 = "";
    std::string outMDsec12 = "";
    ...
    std::string str26 = "";
    std::string str27 = "";
    for (int A_Index17 = 0; A_Index17 < HTVM_Size(categories) + 0; A_Index17++) {
    ...
    for (int A_Index18 = 0; A_Index18 < HTVM_Size(categories) + 0; A_Index18++) {
        ...
        std::vector<std::string> items19 = LoopParseFunc(categoriesElement, "\n", "\r");
        ...
        std::vector<std::string> items20 = LoopParseFunc(categoriesElement, "\n", "\r");
        ...
        for (size_t A_Index21 = 0; A_Index21 < items21.size() + 0; A_Index21++) {
            ...
            if (A_Index21 != 0) {
                if (Trim(A_LoopField21) != "") {
                    ...
                    std::vector<std::string> items22 = LoopParseFunc(str9, "~~~");
...
int main(int argc, char* argv[]) {
    if (HTVM_getLang_HTVM() != "js") {
        ...
        std::vector<std::string> items24 = LoopParseFunc(DOCS_params, "\n", "\r");
