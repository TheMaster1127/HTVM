...
std::string genDocs(std::string mode) {
    ...
    std::string outMDsec5 = "### Arrays" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Dive into working with arrays, one of the most essential data structures in HTVM. Arrays are simple to declare and manipulate, enabling you to store and process collections of data easily." + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
    std::string outMDsec6 = "" + Chr(10) + "### Types" + Chr(10) + "" + Chr(10) + "[Go back](#htvm-documentation)" + Chr(10) + "" + Chr(10) + "Explore the different data types supported by HTVM and how to use them effectively. HTVM includes various types such as numbers, strings, and objects, making it easy to handle different kinds of data in a seamless way." + Chr(10) + "" + Chr(10) + "---" + Chr(10) + "";
