...
{ token: "comment", regex: ";.*$" },
              ...
              { token: "functions", regex: "\\b(HTVM_func1|HTVM_func1|HTVM_func1|LoopParseFunc|LoopParseFunc|LoopParseFunc|print|print|print|STR|INT|FLOAT|STR|INT|FLOAT|INT|STR|FLOAT|InStr|Random|Sleep|input|FileRead|FileAppend|FileDelete|StrLen|Asc|Abs|ACos|ASin|ATan|Ceil|Cos|Exp|Ln|Log|Round|Sin|Sqrt|Tan|SubStr|Trim|StrReplace|StringTrimLeft|StringTrimRight|StrLower|StrSplit|Chr|Mod|Floor|Sort|getDataFromAPI|FileCreateDir|FileRemoveDir|FileExist|isWindows|GetParams|BuildInVars|RegExReplace|RunCMD|RegExMatch|ExitApp|InStr|InStr|Random|Random|Sleep|Sleep|input|input|FileAppendJs|FileDelete|FileAppend|FileRead|StrLen|StrLen|Chr|Chr|Asc|Abs|ACos|ASin|ATan|Ceil|Cos|Exp|Ln|Log|Round|Sin|Sqrt|Tan|Asc|Abs|ACos|ASin|ATan|Ceil|Cos|Exp|Ln|Log|Round|Sin|Sqrt|Tan|SubStr|SubStr|Trim|StrReplace|StringTrimLeft|StringTrimRight|StrLower|StrSplit|Mod|Floor|Trim|StrReplace|StringTrimLeft|StringTrimRight|StrLower|StrSplit|Mod|Floor|Sort|getDataFromAPI|FileCreateDir|FileRemoveDir|FileExist|isWindows|GetParams|BuildInVars|RegExReplace|RunCMD|RegExMatch|ExitApp|Sort|getDataFromAPI|getUrlParams|BuildInVars|RegExReplace|RegExMatch|MsgBox|Gui_Show|Gui_Update|Gui_Button|Gui_Edit|Gui_Text|Gui_Size|Gui_Font|Gui_Font_Id|Gui_Size_Id|GuiControl|Gui_DropDownList|Gui_Hide|Gui_Move|Gui_Color|Gui_Image|Gui_Toggle|Gui_CheckBox|MakeHotKey|sortArr|sortArr|sortArr|countChars|countChars|countChars|StrTitleCase|StrTitleCase|StrTitleCase|createBackendInit|addEndpoint|startServer|getDataFromEndpoint|ErrorMsg)(?=\\()" },
