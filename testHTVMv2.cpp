...
int main(int argc, char* argv[]) {
    ...
    for (size_t A_IndexA4 = 0; A_IndexA4 < items4.size() + 0; A_IndexA4++) {
        std::string A_LoopFieldA4 = items4[A_IndexA4 - 0];
        if (A_IndexA4 == 0) {
            print(A_IndexA4);
        }
        print(A_LoopFieldA4);
    ...
    for (size_t A_IndexA5 = 0; A_IndexA5 < items5.size() + 0; A_IndexA5++) {
        std::string A_LoopFieldA5 = items5[A_IndexA5 - 0];
        if (A_IndexA5 == 0) {
            print(A_IndexA5);
        }
        print(A_LoopFieldA5);
    ...
    for (size_t A_IndexA6 = 0; A_IndexA6 < items6.size() + 0; A_IndexA6++) {
        std::string A_LoopFieldA6 = items6[A_IndexA6 - 0];
        print(A_LoopFieldA6);
    }
    return 0;
}
