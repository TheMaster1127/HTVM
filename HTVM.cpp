...
std::string ALoopField = "";
std::string ALoopField1 = "";
for (int A_Index62 = 1; A_Index62<= 2; ++A_Index62)
{
std::vector<std::string> items63 = LoopParseFunc(str_2, "\n", "\r");
for (size_t A_Index63 = 1; A_Index63 < items63.size() + 1; A_Index63++)
{
std::string A_LoopField63 = items63[A_Index63 - 1];
if (Trim (A_LoopField63)!= "") 
{
if (InStr (str123 , " += ")) 
{
if (CheckStringPosition (str123 , StrSplit (A_LoopField63 , "[" , 1) , " += ") == "left") 
{
str123 = replaceTheOSPpathsLEFT ( str123 , A_LoopField63 ) ;
}
else
{
str123 = replaceTheOSPpathsRIGHT ( str123 , A_LoopField63 ) ;
}
}
...
std::vector<std::string> items64 = LoopParseFunc(expression);
for (size_t A_Index64 = 1; A_Index64 < items64.size() + 1; A_Index64++)
{
std::string A_LoopField64 = items64[A_Index64 - 1];
if (A_Index64 >= result1 && A_Index64 <= result2) 
{
concatResults += A_LoopField64;
}
}
...
std::vector<std::string> items66 = LoopParseFunc(params, "\n", "\r");
...
{
print(A_LoopField66);
filePathOfCode = Trim ( A_LoopField66 ) ;
...
{
print(A_LoopField66);
instructions = FileRead(A_LoopField66);
}
if (A_Index66 == 3) 
{
...
//MsgBox, % code
std::vector<std::string> items67 = LoopParseFunc(instructions, "\n", "\r");
...
{
langToTranspileTo = Trim ( A_LoopField67 ) ;
}
}
if (A_Index67 == 2) 
{
fileExtention = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 3) 
{
keyWordsCommands = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 4) 
{
keyWordINT = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 5) 
{
keyWordSTR = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 6) 
{
keyWordBOOL = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 7) 
{
keyWordFLOAT = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 8) 
{
keyWordINT8 = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 9) 
{
keyWordINT16 = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 10) 
{
keyWordINT32 = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 11) 
{
keyWordINT64 = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 12) 
{
keyWordIF = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 13) 
{
keyWordElseIf = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 14) 
{
keyWordElse = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 15) 
{
keyWordWhileLoop = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 16) 
{
keyWordForLoop = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 17) 
{
keyWordLoopInfinite = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 18) 
{
keyWordLoop = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 19) 
{
keyWordLoopParse = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 20) 
{
keyWordContinue = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 21) 
{
keyWordBreak = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 22) 
{
keyWordFunc = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 23) 
{
keyWordAwait = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 24) 
{
keyWordVariablesAssignmentOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 25) 
{
keyWordConcatenationAssignmentOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 26) 
{
keyWordAdditionAssignmentOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 27) 
{
keyWordSubtractionAssignmentOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 28) 
{
keyWordMultiplicationAssignmentOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 29) 
{
keyWordDivisionAssignmentOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 30) 
{
keyWordAdditionOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 31) 
{
keyWordConcatenationOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 32) 
{
keyWordEqualOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 33) 
{
keyWordNotOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 34) 
{
keyWordGreaterThanOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 35) 
{
keyWordLessThanOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 36) 
{
keyWordGreaterThanOrEqualToOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 37) 
{
keyWordLessThanOrEqualToOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 38) 
{
keyWordOrOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 39) 
{
keyWordAndOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 40) 
{
keyWordNotEqualToOperator = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 41) 
{
keyWordTrue = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 42) 
{
keyWordFalse = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 43) 
{
keyWordSwitch = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 44) 
{
keyWordSwitchCase = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 45) 
{
keyWordSwitchDefault = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 46) 
{
keyWordThrow = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 47) 
{
keyWordErrorMsg = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 48) 
{
keyWordTry = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 49) 
{
keyWordCatch = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 50) 
{
keyWordFinally = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 51) 
{
keyWordArrayAppend = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 52) 
{
keyWordArrayPop = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 53) 
{
keyWordArraySize = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 54) 
{
keyWordArrayInsert = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 55) 
{
keyWordArrayRemove = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 56) 
{
keyWordArrayIndexOf = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 57) 
{
keyWordArrayDefinition = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 58) 
{
keyWordArrayOfIntegersDefinition = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 59) 
{
keyWordArrayOfStringsDefinition = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 60) 
{
keyWordArrayOfFloatingPointNumbersDefinition = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 61) 
{
keyWordArrayOfBooleansDefinition = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 62) 
{
keyWordJavaScriptVar = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 63) 
{
keyWordJavaScriptLet = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 64) 
{
keyWordJavaScriptConst = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 65) 
{
keyWordReturnStatement = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 66) 
{
keyWordEnd = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 67) 
{
keyWordGlobal = Trim ( A_LoopField67 ) + " ";
}
if (A_Index67 == 68) 
{
keyWordComment = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 69) 
{
keyWordCommentOpenMultiLine = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 70) 
{
keyWordCommentCloseMultiLine = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 71) 
{
keyWordEscpaeChar = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 72) 
{
AHKlikeLoopsIndexedAt = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 73) 
{
keyWordAIndex = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 74) 
{
keyWordALoopField = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 75) 
{
keyWordMainLabel = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 76) 
{
useFuncKeyWord = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 77) 
{
useCurlyBraces = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 78) 
{
useEnd = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 79) 
{
useSemicolon = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 80) 
{
useParentheses = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 81) 
{
usePythonicColonSyntax = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 82) 
{
forLoopLang = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 83) 
{
useInJavaScriptAlwaysUseVar = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 84) 
{
useJavaScriptInAfullHTMLfile = Trim ( A_LoopField67 ) ;
}
if (A_Index67 == 85) 
{
useJavaScriptAmainFuncDef = Trim ( A_LoopField67 ) ;
}
}
...
getAllCharForTheFurtureSoIcanAddEscapeChar.add(A_LoopField68);
}
...
if (A_LoopField71!= Chr (34)) 
{
//MsgBox, % A_LoopField71 . " = " . keyWordEscpaeChar . ") && (" . keyWordEscpaeChar . " = " . getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index71 + 1] . ")"
...
if (!(SubStr (StrLower (A_LoopField73) , 1 , StrLen (StrLower (keyWordForLoop))) == StrLower (keyWordForLoop))) 
{
...
if (StrLower (Trim (A_LoopField74)) == StrLower (keyWordEnd)) 
{
htCodeOutFixEnd += str10 + "}" + "\n";
}
else if (SubStr (StrLower (Trim (A_LoopField74)) , 1 , StrLen (StrLower (keyWordIF))) == StrLower (keyWordIF)) 
{
...
if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordIF))) == StrLower (keyWordIF)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordElseIf))) == StrLower (keyWordElseIf)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordElse))) == StrLower (keyWordElse)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordWhileLoop))) == StrLower (keyWordWhileLoop)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordForLoop))) == StrLower (keyWordForLoop)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordLoopInfinite))) == StrLower (keyWordLoopInfinite)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordLoop))) == StrLower (keyWordLoop)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordLoopParse))) == StrLower (keyWordLoopParse)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordSwitch))) == StrLower (keyWordSwitch)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordSwitchCase))) == StrLower (keyWordSwitchCase)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordSwitchDefault))) == StrLower (keyWordSwitchDefault)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordTry))) == StrLower (keyWordTry)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower ("alliance"))) == StrLower ("alliance")) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower ("crew"))) == StrLower ("crew")) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower ("def obj"))) == StrLower ("def obj")) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower ("method"))) == StrLower ("method")) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordCatch))) == StrLower (keyWordCatch)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordFinally))) == StrLower (keyWordFinally)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else if (SubStr (StrLower (Trim (A_LoopField75)) , 1 , StrLen (StrLower (keyWordFunc))) == StrLower (keyWordFunc)) 
{
htCodeOutFixEnd += A_LoopField75 + ":\n";
}
else
...
for (size_t A_Index76 = 1; A_Index76 < items76.size() + 1; A_Index76++)
{
std::string A_LoopField76 = items76[A_Index76 - 1];
outTrimCode += Trim ( A_LoopField76 ) + "\n";
}
code = StringTrimRight(outTrimCode, 1);
// for converting c++ to js and py
code = StrReplace ( code , "{}" , "[]" ) ;
std::string outCodeFixBraces;
for (int A_Index77 = 1; A_Index77<= 2; ++A_Index77)
{
outCodeFixBraces = "";
...
if (InStr (Trim (A_LoopField78) , "{") && Trim (A_LoopField78)!= "{") 
{
outCodeFixBraces += Trim ( StrReplace ( Trim ( A_LoopField78 ) , "{" , "" ) ) + "\n{\n";
}
else if (InStr (Trim (A_LoopField78) , "}") && Trim (A_LoopField78)!= "}") 
{
outCodeFixBraces += "}\n" + Trim ( StrReplace ( Trim ( A_LoopField78 ) , "}" , "" ) ) + "\n";
}
else
{
outCodeFixBraces += Trim ( A_LoopField78 ) + "\n";
}
}
...
if (StrLower (A_LoopField79) == StrLower (keyWordMainLabel)) 
{
didWeUseMainLabel = 1;
...
{
codeOutFixAndAddMainFunc += A_LoopField79 + "\n";
}
}
...
lookIntoTheNextLineForFuncWhitNoKeyWord.add(A_LoopField80);
}
...
lineDone = 0;
if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordINT))) == StrLower (keyWordINT)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordINT ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "int ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordSTR))) == StrLower (keyWordSTR)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordSTR ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "std::string ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordBOOL))) == StrLower (keyWordBOOL)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordBOOL ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "bool ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordFLOAT))) == StrLower (keyWordFLOAT)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordFLOAT ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "float ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordINT8))) == StrLower (keyWordINT8)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordINT8 ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "int8_t ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordINT16))) == StrLower (keyWordINT16)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordINT16 ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "int16_t ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordINT32))) == StrLower (keyWordINT32)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordINT32 ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "int32_t ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordINT64))) == StrLower (keyWordINT64)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordINT64 ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "long long ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordIF))) == StrLower (keyWordIF)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordIF ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordElseIf))) == StrLower (keyWordElseIf)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordElseIf ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordElse))) == StrLower (keyWordElse)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordElse ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordWhileLoop))) == StrLower (keyWordWhileLoop)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordWhileLoop ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
{
...
str8 = "";
str9 = expressionParserTranspiler ( str1 ) ;
std::vector<std::string> items84 = LoopParseFunc(str9, " ");
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordForLoop))) == StrLower (keyWordForLoop)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordForLoop ) ) ;
//MsgBox, % A_LoopField81
...
else if (StrLower (A_LoopField81) == StrLower (keyWordLoopInfinite) || StrLower (A_LoopField81) == StrLower (keyWordLoopInfinite + ":")) 
{
// infinity loops
...
else if (SubStr (Trim (StrLower (A_LoopField81)) , 1 , StrLen (StrLower (keyWordLoop))) == StrLower (keyWordLoop) && SubStr (Trim (StrLower (A_LoopField81)) , 1 , StrLen (StrLower (keyWordLoop)) + 2)!= StrLower (keyWordLoop) + "% " && SubStr (Trim (StrLower (A_LoopField81)) , 1 , StrLen (StrLower (keyWordLoopParse)))!= StrLower (keyWordLoopParse)) 
{
out2 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordLoop ) ) ;
...
else if (SubStr (Trim (StrLower (A_LoopField81)) , 1 , StrLen (StrLower (keyWordLoop)) + 2) == StrLower (keyWordLoop) + "% ") 
{
out2 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordLoop ) + 2 ) ;
out2 = StrReplace ( out2 , ":" , "" ) ;
//MsgBox % out2
//MsgBox, % out2
out2 = Trim ( out2 ) ;
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordLoopParse))) == StrLower (keyWordLoopParse)) 
{
var1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordLoopParse ) ) ;
out2 = StrReplace ( out2 , ":" , "" ) ;
lineDone = 1;
...
else if (StrLower (A_LoopField81) == StrLower (keyWordContinue) || StrLower (A_LoopField81) == StrLower (keyWordContinue + ";")) 
{
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
...
else if (StrLower (A_LoopField81) == StrLower (keyWordBreak) || StrLower (A_LoopField81) == StrLower (keyWordBreak + ";")) 
{
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordFunc))) == StrLower (keyWordFunc) && useFuncKeyWord == "on") 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordFunc ) ) ;
//MsgBox, % A_LoopField81
str2 = str1;
str2 = StrReplace ( str2 , ":" , "" ) ;
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordAwait))) == StrLower (keyWordAwait)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordAwait ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordSwitch))) == StrLower (keyWordSwitch)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordSwitch ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
str1 = StrReplace ( str1 , ":" , "" ) ;
if (langToTranspileTo == "py") 
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordSwitchCase))) == StrLower (keyWordSwitchCase)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordSwitchCase ) ) ;
//MsgBox, % A_LoopField81
str1 = StrReplace ( str1 , ":" , "" ) ;
...
else if (StrLower (A_LoopField81) == StrLower (keyWordSwitchDefault) || StrLower (A_LoopField81) == StrLower (keyWordSwitchDefault + ":")) 
{
//MsgBox, % A_LoopField81
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordThrow))) == StrLower (keyWordThrow)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordThrow ) ) ;
//MsgBox, % A_LoopField81
//#include <stdexcept>
lineDone = 1;
if (langToTranspileTo == "py") 
...
else if (StrLower (A_LoopField81) == StrLower (keyWordTry) || StrLower (A_LoopField81) == StrLower (keyWordTry + ":")) 
{
//MsgBox, % A_LoopField81
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordCatch))) == StrLower (keyWordCatch)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordCatch ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
str1 = StrReplace ( str1 , ":" , "" ) ;
if (langToTranspileTo == "cpp") 
...
else if (StrLower (A_LoopField81) == StrLower (keyWordFinally) || StrLower (A_LoopField81) == StrLower (keyWordFinally + ":")) 
{
//MsgBox, % A_LoopField81
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordArrayOfIntegersDefinition))) == StrLower (keyWordArrayOfIntegersDefinition)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordArrayOfIntegersDefinition ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "std::vector<int> ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordArrayOfStringsDefinition))) == StrLower (keyWordArrayOfStringsDefinition)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordArrayOfStringsDefinition ) ) ;
if (langToTranspileTo == "cpp") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordArrayOfFloatingPointNumbersDefinition))) == StrLower (keyWordArrayOfFloatingPointNumbersDefinition)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordArrayOfFloatingPointNumbersDefinition ) ) ;
if (langToTranspileTo == "cpp") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordArrayOfBooleansDefinition))) == StrLower (keyWordArrayOfBooleansDefinition)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordArrayOfBooleansDefinition ) ) ;
if (langToTranspileTo == "cpp") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordArrayDefinition))) == StrLower (keyWordArrayDefinition) && lineDone == 0) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordArrayDefinition ) ) ;
if (langToTranspileTo == "cpp") 
{
str5 = "std::vector<std::string> ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordJavaScriptVar))) == StrLower (keyWordJavaScriptVar)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordJavaScriptVar ) ) ;
if (langToTranspileTo == "js") 
{
str5 = "var ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordJavaScriptLet))) == StrLower (keyWordJavaScriptLet)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordJavaScriptLet ) ) ;
if (langToTranspileTo == "js") 
{
str5 = "let ";
}
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordJavaScriptConst))) == StrLower (keyWordJavaScriptConst)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordJavaScriptConst ) ) ;
if (langToTranspileTo == "js") 
{
str5 = "const ";
}
...
else if (isItAPlusPlusOrMinusMinus (Trim (A_LoopField81) , 0)!= "no" && (InStr (A_LoopField81 , "++") || InStr (A_LoopField81 , "--"))) 
{
str1 = isItAPlusPlusOrMinusMinus ( Trim ( A_LoopField81 ) , 1 ) ;
lineDone = 1;
htCode += str1 + "\n";
}
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordReturnStatement))) == StrLower (keyWordReturnStatement)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordReturnStatement ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
...
else if (StrLower (Trim (A_LoopField81)) == StrLower (Trim (keyWordReturnStatement))) 
{
//MsgBox, % A_LoopField81
lineDone = 1;
str2 = "return;";
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordGlobal))) == StrLower (keyWordGlobal)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordGlobal ) ) ;
//MsgBox, % A_LoopField81
str1 = StrReplace ( str1 , ";" , "" ) ;
lineDone = 1;
if (langToTranspileTo == "py") 
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordComment))) == StrLower (keyWordComment)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordComment ) ) ;
//MsgBox, % A_LoopField81
if (langToTranspileTo == "py") 
{
str2 = "#" + str1;
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordCommentOpenMultiLine))) == StrLower (keyWordCommentOpenMultiLine)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordCommentOpenMultiLine ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
{
...
else if (SubStr (StrLower (A_LoopField81) , 1 , StrLen (StrLower (keyWordCommentCloseMultiLine))) == StrLower (keyWordCommentCloseMultiLine)) 
{
str1 = StringTrimLeft ( A_LoopField81 , StrLen ( keyWordCommentCloseMultiLine ) ) ;
//MsgBox, % A_LoopField81
lineDone = 1;
if (langToTranspileTo == "py") 
{
...
else if (KeyWordsCommands (A_LoopField81 , "check" , keyWordsCommands , langToTranspileTo) == "true" && lineDone == 0) 
{
out_KeyWordsCommands = KeyWordsCommands ( A_LoopField81 , "transpile" , keyWordsCommands , langToTranspileTo ) ;
//MsgBox, % out_KeyWordsCommands
lineDone = 1;
htCode += out_KeyWordsCommands + "\n";
}
else if (InStr (A_LoopField81 , keyWordArrayAppend) || InStr (A_LoopField81 , keyWordArrayPop) || InStr (A_LoopField81 , keyWordArraySize) || InStr (A_LoopField81 , keyWordArrayInsert) || InStr (A_LoopField81 , keyWordArrayRemove) || InStr (A_LoopField81 , keyWordArrayIndexOf) && lineDone == 0) 
{
//MsgBox, % A_LoopField81
lineDone = 1;
str2 = expressionParserTranspiler ( A_LoopField81 ) + theSemicolon;
if (langToTranspileTo == "py") 
{
str2 = StrReplace ( str2 , ";" , "" ) ;
}
...
else if (InStr (A_LoopField81 , keyWordVariablesAssignmentOperator) || InStr (A_LoopField81 , keyWordConcatenationAssignmentOperator) || InStr (A_LoopField81 , keyWordAdditionAssignmentOperator) || InStr (A_LoopField81 , keyWordSubtractionAssignmentOperator) || InStr (A_LoopField81 , keyWordMultiplicationAssignmentOperator) || InStr (A_LoopField81 , keyWordDivisionAssignmentOperator) && lineDone == 0) 
{
str1 = A_LoopField81;
str5 = "";
if (InStr (str1 , keyWordVariablesAssignmentOperator)) 
...
else if ((SubStr (Trim (A_LoopField81) , -2) == ");" || SubStr (Trim (A_LoopField81) , -1) == ")") &&!(InStr (A_LoopField81 , "int main(int argc, char* argv[])")) &&!(InStr (A_LoopField81 , "async function main()")) && lineDone == 0) 
{
lineDone = 1;
str1 = A_LoopField81;
if (langToTranspileTo == "py") 
...
if (Trim (lookIntoTheNextLineForFuncWhitNoKeyWord[A_Index81 + 1]) == "{" && useFuncKeyWord == "off") 
{
str2 = str1;
str2 = StrReplace ( str2 , Trim ( keyWordVariablesAssignmentOperator ) , "=" ) ;
str2 = StrReplace ( str2 , "):" , ")" ) ;
...
{
//MsgBox, % "else else else " . A_LoopField81
// this is THE else
if (lineDone!= 1) 
{
if (skipLeftCuleyForFuncPLS!= 1) 
{
if (SubStr (Trim (StrLower (A_LoopField81)) , 1 , 1) == Chr (125)) 
{
htCode += Chr ( 125 ) + "\n";
}
else
{
if (htCodeAcurlyBraceAddSomeVrasFixLP == 1 && SubStr (Trim (StrLower (A_LoopField81)) , 1 , 1) == Chr (123)) 
{
htCodeAcurlyBraceAddSomeVrasFixLP = 0;
htCode += A_LoopField81 + "\n" + theFixTextLoopLP + "\n";
}
else
{
if (htCodeAcurlyBraceAddSomeVrasFixNL == 1 && SubStr (Trim (StrLower (A_LoopField81)) , 1 , 1) == Chr (123)) 
{
...
if (SubStr (StrLower (Trim (A_LoopField85)) , 1 , 9) == "alliance ") 
{
foundAllianceCrewOrOtehrs = 1;
OSPpasringHoldNameFirstPart = StringTrimLeft(A_LoopField85, 9);
...
if (SubStr (StrLower (Trim (A_LoopField86)) , 1 , 5) == "crew ") 
{
foundAllianceCrewOrOtehrs = 1;
OSPpasringHoldNameFirstPart = StringTrimLeft(A_LoopField86, 5);
OSPpasringHoldNameFirstPart = Trim ( OSPpasringHoldNameFirstPart ) ;
INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_itsOVERover = 0;
INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_INSIDE = 1;
...
if (SubStr (StrLower (Trim (A_LoopField87)) , 1 , 8) == "def obj ") 
{
foundAllianceCrewOrOtehrs = 1;
OSPpasringHoldNameFirstPart = StringTrimLeft(A_LoopField87, 8);
OSPpasringHoldNameFirstPart = Trim ( OSPpasringHoldNameFirstPart ) ;
INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_itsOVERover = 0;
INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_INSIDE = 1;
...
if (SubStr (StrLower (Trim (A_LoopField88)) , 1 , 7) == "method ") 
{
foundAllianceCrewOrOtehrs = 1;
OSPpasringHoldNameFirstPart = StringTrimLeft(A_LoopField88, 7);
OSPpasringHoldNameFirstPart = Trim ( OSPpasringHoldNameFirstPart ) ;
INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_itsOVERover = 0;
INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_INSIDE = 1;
indentTrackCurlyBraceOpenCloseSTARTEDAT = A_Index88;
indentTrackCurlyBraceOpenClose = 0;
canEndIndentTrackCurlyBraceOpenClose = 0;
indentTrackCurlyBraceOpenCloseENDNEXT = 0;
indentTrackCurlyBraceOpenCloseENDNEXTonce = 0;
...
//MsgBox, % "foundCLose } at line " . STR(A_Index88) . " and started at " . STR(indentTrackCurlyBraceOpenCloseSTARTEDAT)
INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_INSIDE = 0;
}
}
if (INSIDEindentTrackCurlyBraceOpenCloseENDNEXT_INSIDEdoneDONE == 0) 
...
for (size_t A_Index89 = 1; A_Index89 < items89.size() + 1; A_Index89++)
{
std::string A_LoopField89 = items89[A_Index89 - 1];
if (InStr (A_LoopField89 , "alliance|start|")) 
{
statckOSPgetData.add(Trim(StrSplit(A_LoopField89, "|", 3)));
}
else if (InStr (A_LoopField89 , "crew|start|")) 
{
statckOSPgetData.add(Trim(StrSplit(A_LoopField89, "|", 3)));
}
else if (InStr (A_LoopField89 , "def obj|start|")) 
{
OSPholdPROPstrForArray = "";
areWeInDefObj = 1;
statckOSPgetData.add(Trim(StrSplit(A_LoopField89, "|", 3)));
}
else if (SubStr (Trim (StrLower (A_LoopField89)) , 1 , 5) == "prop ") 
{
OSPholdPROPstrForArray += A_LoopField89 + "|";
}
else if (InStr (A_LoopField89 , "method|start|")) 
{
if (InStr (Trim (A_LoopField89) , " ")) 
{
statckOSPgetData.add(Trim(StrSplit(Trim(StrSplit(Trim(StrSplit(A_LoopField89, "|", 3)), "(", 1)), " ", 2)));
}
else
{
statckOSPgetData.add(Trim(StrSplit(Trim(StrSplit(A_LoopField89, "|", 3)), "(", 1)));
}
OSPconnectionStrHOLD = "";
for (int A_Index90 = 1; A_Index90<= INT ( statckOSPgetData[0] ) ; ++A_Index90)
{
//MsgBox, % "aswadsfadsfasdfasd::::::::::::::" . statckOSPgetData[A_Index90]
OSPconnectionStrHOLD += statckOSPgetData[A_Index90] + "_";
str5 = statckOSPgetData[A_Index90];
}
...
str1 = Trim ( StrSplit ( Trim ( StrSplit ( A_LoopField89 , "|" , 3 ) ) , " " , 1 ) ) ;
...
else if (InStr (A_LoopField89 , "alliance|end|")) 
{
OSPconnectionStrHOLD = "";
...
else if (InStr (A_LoopField89 , "crew|end|")) 
{
OSPconnectionStrHOLD = "";
...
else if (InStr (A_LoopField89 , "def obj|end|")) 
{
...
areWeInDefObj = 0;
OSPconnectionStrHOLD = "";
for (int A_Index93 = 1; A_Index93<= INT ( statckOSPgetData[0] ) ; ++A_Index93)
{
OSPconnectionStrHOLD += statckOSPgetData[A_Index93] + ".";
}
OSPconnectionStrHOLD = StringTrimRight(OSPconnectionStrHOLD, 1);
OSPconnectionArrayHOLD.add(OSPconnectionStrHOLD);
statckOSPgetData.pop_back ( ) ;
...
std::vector<std::string> items94 = LoopParseFunc(OSPholdPROPstrForArray, "|");
for (size_t A_Index94 = 1; A_Index94 < items94.size() + 1; A_Index94++)
{
std::string A_LoopField94 = items94[A_Index94 - 1];
str1 = A_LoopField94;
if (Trim (A_LoopField94)!= "") 
{
// prop str typeOf := ""
// path.path.path:propName1[str],propName2[bool],propName3[str array]|path.path.path:propName1[str],propName2[bool],propName3[str array]
//;;;;;;;
...
else if (InStr (A_LoopField89 , "method|end|")) 
{
addOSPtoHTVM += "}\n";
OSPconnectionStrHOLD = "";
for (int A_Index95 = 1; A_Index95<= INT ( statckOSPgetData[0] ) ; ++A_Index95)
{
OSPconnectionStrHOLD += statckOSPgetData[A_Index95] + ".";
}
OSPconnectionStrHOLD = StringTrimRight(OSPconnectionStrHOLD, 1);
OSPconnectionArrayHOLD.add(OSPconnectionStrHOLD);
statckOSPgetData.pop_back ( ) ;
...
{
addOSPtoHTVM += parserOSPgloabl ( OSPstrArrayStrALLobjInOSP , A_LoopField89 ) + "\n";
}
}
htCode = StringTrimRight(addOSPtoHTVM, 1);
OSPstrArrayStrALLobjInOSP = StringTrimRight(OSPstrArrayStrALLobjInOSP, 1);
