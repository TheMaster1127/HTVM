...
std::string compiler(std::string htCode, std::string allInstructionFile, std::string mode, std::string langToConvertToParam = "") {
    ...
    */
    ...
    if (langToConvertTo == "go") {
        ...
        for (size_t A_Index151 = 0; A_Index151 < items151.size() + 0; A_Index151++) {
            ...
            if (Trim(A_LoopField151) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index151 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                std::vector<std::string> items152 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index151 + 1]);
                ...
                for (int A_Index153 = 0; A_Index153 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index153++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (int A_Index154 = 0; A_Index154 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index154++) {
    ...
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (int A_Index155 = 0; A_Index155 < COUNT_programmingBlock_CPP + 0; A_Index155++) {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (int A_Index156 = 0; A_Index156 < COUNT_programmingBlock_CPP + 0; A_Index156++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (int A_Index157 = 0; A_Index157 < COUNT_programmingBlock_PY + 0; A_Index157++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index157 + 1) + "AA", programmingBlock_PY[A_Index157]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (int A_Index158 = 0; A_Index158 < COUNT_programmingBlock_PY + 0; A_Index158++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (int A_Index159 = 0; A_Index159 < COUNT_programmingBlock_JS + 0; A_Index159++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index159 + 1) + "AA", programmingBlock_JS[A_Index159]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (int A_Index160 = 0; A_Index160 < COUNT_programmingBlock_JS + 0; A_Index160++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (int A_Index161 = 0; A_Index161 < COUNT_programmingBlock_GO + 0; A_Index161++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index161 + 1) + "AA", programmingBlock_GO[A_Index161]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (int A_Index162 = 0; A_Index162 < COUNT_programmingBlock_GO + 0; A_Index162++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (int A_Index163 = 0; A_Index163 < COUNT_programmingBlock_LUA + 0; A_Index163++) {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (int A_Index164 = 0; A_Index164 < COUNT_programmingBlock_LUA + 0; A_Index164++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (int A_Index165 = 0; A_Index165 < COUNT_programmingBlock_CS + 0; A_Index165++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index165 + 1) + "AA", programmingBlock_CS[A_Index165]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (int A_Index166 = 0; A_Index166 < COUNT_programmingBlock_CS + 0; A_Index166++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (int A_Index167 = 0; A_Index167 < COUNT_programmingBlock_JAVA + 0; A_Index167++) {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (int A_Index168 = 0; A_Index168 < COUNT_programmingBlock_JAVA + 0; A_Index168++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (int A_Index169 = 0; A_Index169 < COUNT_programmingBlock_KT + 0; A_Index169++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index169 + 1) + "AA", programmingBlock_KT[A_Index169]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (int A_Index170 = 0; A_Index170 < COUNT_programmingBlock_KT + 0; A_Index170++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (int A_Index171 = 0; A_Index171 < COUNT_programmingBlock_RB + 0; A_Index171++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index171 + 1) + "AA", programmingBlock_RB[A_Index171]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (int A_Index172 = 0; A_Index172 < COUNT_programmingBlock_RB + 0; A_Index172++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (int A_Index173 = 0; A_Index173 < COUNT_programmingBlock_NIM + 0; A_Index173++) {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (int A_Index174 = 0; A_Index174 < COUNT_programmingBlock_NIM + 0; A_Index174++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (int A_Index175 = 0; A_Index175 < COUNT_programmingBlock_AHK + 0; A_Index175++) {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (int A_Index176 = 0; A_Index176 < COUNT_programmingBlock_AHK + 0; A_Index176++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (int A_Index177 = 0; A_Index177 < COUNT_programmingBlock_SWIFT + 0; A_Index177++) {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (int A_Index178 = 0; A_Index178 < COUNT_programmingBlock_SWIFT + 0; A_Index178++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (int A_Index179 = 0; A_Index179 < COUNT_programmingBlock_DART + 0; A_Index179++) {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (int A_Index180 = 0; A_Index180 < COUNT_programmingBlock_DART + 0; A_Index180++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (int A_Index181 = 0; A_Index181 < COUNT_programmingBlock_TS + 0; A_Index181++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index181 + 1) + "AA", programmingBlock_TS[A_Index181]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (int A_Index182 = 0; A_Index182 < COUNT_programmingBlock_TS + 0; A_Index182++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (int A_Index183 = 0; A_Index183 < COUNT_programmingBlock_GROOVY + 0; A_Index183++) {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (int A_Index184 = 0; A_Index184 < COUNT_programmingBlock_GROOVY + 0; A_Index184++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (int A_Index185 = 0; A_Index185 < COUNT_programmingBlock_HTVM + 0; A_Index185++) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (int A_Index186 = 0; A_Index186 < COUNT_programmingBlock_HTVM + 0; A_Index186++) {
    ...
    int correctLang = 0;
    std::vector<std::string> items187 = LoopParseFunc(instructions, "\n", "\r");
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (int A_Index188 = 0; A_Index188 < HTVM_Size(allFuncNames) + 0; A_Index188++) {
        ...
        std::vector<std::string> items189 = LoopParseFunc(allLibsToPutAtTop, "|");
    ...
    for (int A_Index190 = 0; A_Index190 < theIdNumOfThe34 + 0; A_Index190++) {
...
void HTVMv2() {
    ...
    std::vector<std::string> items191 = LoopParseFunc(str0);
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        std::vector<std::string> items192 = LoopParseFunc(allArgs, "\n", "\r");
        ...
        for (int A_Index193 = 0; A_Index193 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index193++) {
