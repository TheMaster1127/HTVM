...
std::string compiler(std::string htCode, std::string allInstructionFile, std::string mode, std::string langToConvertToParam = "") {
    ...
    */
    ...
    int correctLang = 0;
    std::vector<std::string> items230 = LoopParseFunc(instructions, "\n", "\r");
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (int A_Index231 = 0; A_Index231 < HTVM_Size(allFuncNames) + 0; A_Index231++) {
        ...
        std::vector<std::string> items232 = LoopParseFunc(allLibsToPutAtTop, "|");
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (int A_Index233 = 0; A_Index233 < HTVM_Size(ospDic1) + 0; A_Index233++) {
    ...
    if (size_ospDic != 0) {
        for (int A_Index234 = 0; A_Index234 < size_ospDic + 0; A_Index234++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (int A_Index235 = 0; A_Index235 < size_ospDic1 + 0; A_Index235++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (int A_Index236 = 0; A_Index236 < size_ospDic2 + 0; A_Index236++) {
            HTVM_Pop(ospDic2);
        }
    }
    availableFuncsInHTVMInHTVM = "";
    ...
    for (int A_Index237 = 0; A_Index237 < theIdNumOfThe34 + 0; A_Index237++) {
...
void HTVMv2() {
    ...
    std::vector<std::string> items238 = LoopParseFunc(str0);
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        std::vector<std::string> items239 = LoopParseFunc(allArgs, "\n", "\r");
        ...
        for (int A_Index240 = 0; A_Index240 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index240++) {
