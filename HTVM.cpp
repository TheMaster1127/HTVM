...
std::string handleMultiLineStrings(std::string code) {
    ...
    for (size_t A_Index100 = 0; A_Index100 < items100.size() + 0; A_Index100++) {
        ...
        HTVM_Append(lookAhead, Trim(A_LoopField100));
    }
    ...
    for (size_t A_Index101 = 0; A_Index101 < items101.size() + 0; A_Index101++) {
        ...
        if (weAreIn == 1 && Trim(A_LoopField101) == "mle") {
            out = StringTrimRight(out, 2);
            out += Chr(34) + Chr(10);
            weAreIn = 0;
        }
        if (weAreIn == 1 && Trim(A_LoopField101) == "HTVM-newLineAHw4y9w730q8237w4e8srhgesw0s8rgw04e5g08sgr0e8srdgt--YOU-BETERNOTUSETHISAH--aesdfssz") {
            if (lookAhead[A_Index101 + 1] == "HTVM-newLineAHw4y9w730q8237w4e8srhgesw0s8rgw04e5g08sgr0e8srdgt--YOU-BETERNOTUSETHISAH--aesdfssz") {
                out += keyWordEscpaeChar + "n";
            }
        }
        if (weAreIn == 1 && Trim(A_LoopField101) != "HTVM-newLineAHw4y9w730q8237w4e8srhgesw0s8rgw04e5g08sgr0e8srdgt--YOU-BETERNOTUSETHISAH--aesdfssz") {
            out += Trim(A_LoopField101) + keyWordEscpaeChar + "n";
        }
...
std::vector<std::string> slidingWinFixCommentsRmFUNC(std::string line) {
    ...
    for (size_t A_Index102 = 0; A_Index102 < items102.size() + 0; A_Index102++) {
        ...
        HTVM_Append(slidingWinFixCommentsRmFFFF, A_LoopField102);
    }
    for (int A_Index103 = 0; A_Index103 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index103++) {
...
std::string fixIfElseIfMultiLineStatementHELP(std::string aloopfield) {
    std::string out = "";
    int count = 0;
    std::vector<std::string> items104 = LoopParseFunc(aloopfield);
...
std::string fixIfElseIfMultiLineStatement(std::string someHTVMcode) {
    ...
    for (int A_Index105 = 0; A_Index105 < 2147483000 + 0; A_Index105++) {
        out2 = out;
        out = "";
        doWeExit = false;
        std::vector<std::string> items106 = LoopParseFunc(out2, "\n", "\r");
        for (size_t A_Index106 = 0; A_Index106 < items106.size() + 0; A_Index106++) {
            ...
            if (SubStr(StrLower(Trim(A_LoopField106)), 1, StrLen(keyWordIF)) == keyWordIF) {
                doWeJustExit = 1;
                if (fixIfElseIfMultiLineStatementHELP(A_LoopField106) == "") {
                    out += Trim(A_LoopField106) + " ";
                    doWeExit = false;
                    doWeExitHELP--;
                } else {
                    doWeExit = true;
                    out += Trim(A_LoopField106) + Chr(10);
                }
            }
...
std::string compiler(std::string htCode, std::string allInstructionFile, std::string mode, std::string langToConvertToParam = "") {
    ...
    std::vector<std::string> items107 = LoopParseFunc(allInstructionFile, "\n", "\r");
    for (size_t A_Index107 = 0; A_Index107 < items107.size() + 0; A_Index107++) {
        std::string A_LoopField107 = items107[A_Index107 - 0];
        if (A_Index107 == 0) {
            langToConvertTo = Trim(A_LoopField107);
        }
        if (A_Index107 == 1) {
            langFileExtension = Trim(A_LoopField107);
        }
        if (A_Index107 == 2) {
            commands = Trim(A_LoopField107);
        }
        if (A_Index107 == 3) {
            keyWordAlliance = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 4) {
            keyWordCrew = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 5) {
            keyWordMethod = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 6) {
            keyWordDefObj = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 7) {
            keyWordProp = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 8) {
            keyWordThis = Trim(A_LoopField107);
        }
        if (A_Index107 == 9) {
            keyWordInclude = Trim(A_LoopField107);
        }
        if (A_Index107 == 10) {
            keyWordCodeInTheTranspiledLangStart = Trim(A_LoopField107);
        }
        if (A_Index107 == 11) {
            keyWordCodeInTheTranspiledLangEnd = Trim(A_LoopField107);
        }
        if (A_Index107 == 12) {
            keyWordCodeInTheTranspiledLangStartCPP = Trim(A_LoopField107);
        }
        if (A_Index107 == 13) {
            keyWordCodeInTheTranspiledLangEndCPP = Trim(A_LoopField107);
        }
        if (A_Index107 == 14) {
            keyWordCodeInTheTranspiledLangStartPY = Trim(A_LoopField107);
        }
        if (A_Index107 == 15) {
            keyWordCodeInTheTranspiledLangEndPY = Trim(A_LoopField107);
        }
        if (A_Index107 == 16) {
            keyWordCodeInTheTranspiledLangStartJS = Trim(A_LoopField107);
        }
        if (A_Index107 == 17) {
            keyWordCodeInTheTranspiledLangEndJS = Trim(A_LoopField107);
        }
        if (A_Index107 == 18) {
            keyWordCodeInTheTranspiledLangStartGO = Trim(A_LoopField107);
        }
        if (A_Index107 == 19) {
            keyWordCodeInTheTranspiledLangEndGO = Trim(A_LoopField107);
        }
        if (A_Index107 == 20) {
            keyWordCodeInTheTranspiledLangStartLUA = Trim(A_LoopField107);
        }
        if (A_Index107 == 21) {
            keyWordCodeInTheTranspiledLangEndLUA = Trim(A_LoopField107);
        }
        if (A_Index107 == 22) {
            keyWordCodeInTheTranspiledLangStartCS = Trim(A_LoopField107);
        }
        if (A_Index107 == 23) {
            keyWordCodeInTheTranspiledLangEndCS = Trim(A_LoopField107);
        }
        if (A_Index107 == 24) {
            keyWordCodeInTheTranspiledLangStartJAVA = Trim(A_LoopField107);
        }
        if (A_Index107 == 25) {
            keyWordCodeInTheTranspiledLangEndJAVA = Trim(A_LoopField107);
        }
        if (A_Index107 == 26) {
            keyWordCodeInTheTranspiledLangStartKT = Trim(A_LoopField107);
        }
        if (A_Index107 == 27) {
            keyWordCodeInTheTranspiledLangEndKT = Trim(A_LoopField107);
        }
        if (A_Index107 == 28) {
            keyWordCodeInTheTranspiledLangStartRB = Trim(A_LoopField107);
        }
        if (A_Index107 == 29) {
            keyWordCodeInTheTranspiledLangEndRB = Trim(A_LoopField107);
        }
        if (A_Index107 == 30) {
            keyWordCodeInTheTranspiledLangStartNIM = Trim(A_LoopField107);
        }
        if (A_Index107 == 31) {
            keyWordCodeInTheTranspiledLangEndNIM = Trim(A_LoopField107);
        }
        if (A_Index107 == 32) {
            keyWordCodeInTheTranspiledLangStartAHK = Trim(A_LoopField107);
        }
        if (A_Index107 == 33) {
            keyWordCodeInTheTranspiledLangEndAHK = Trim(A_LoopField107);
        }
        if (A_Index107 == 34) {
            keyWordCodeInTheTranspiledLangStartSWIFT = Trim(A_LoopField107);
        }
        if (A_Index107 == 35) {
            keyWordCodeInTheTranspiledLangEndSWIFT = Trim(A_LoopField107);
        }
        if (A_Index107 == 36) {
            keyWordCodeInTheTranspiledLangStartDART = Trim(A_LoopField107);
        }
        if (A_Index107 == 37) {
            keyWordCodeInTheTranspiledLangEndDART = Trim(A_LoopField107);
        }
        if (A_Index107 == 38) {
            keyWordCodeInTheTranspiledLangStartTS = Trim(A_LoopField107);
        }
        if (A_Index107 == 39) {
            keyWordCodeInTheTranspiledLangEndTS = Trim(A_LoopField107);
        }
        if (A_Index107 == 40) {
            keyWordCodeInTheTranspiledLangStartGROOVY = Trim(A_LoopField107);
        }
        if (A_Index107 == 41) {
            keyWordCodeInTheTranspiledLangEndGROOVY = Trim(A_LoopField107);
        }
        if (A_Index107 == 42) {
            keyWordCodeInTheTranspiledLangStartHTVM = Trim(A_LoopField107);
        }
        if (A_Index107 == 43) {
            keyWordCodeInTheTranspiledLangEndHTVM = Trim(A_LoopField107);
        }
        if (A_Index107 == 44) {
            keyWordCodeInHTVMstart = Trim(A_LoopField107);
        }
        if (A_Index107 == 45) {
            keyWordCodeInHTVMend = Trim(A_LoopField107);
        }
        if (A_Index107 == 46) {
            keyWordCurlyBraceOpen = Trim(A_LoopField107);
        }
        if (A_Index107 == 47) {
            keyWordCurlyBraceClose = Trim(A_LoopField107);
        }
        if (A_Index107 == 48) {
            keyWordNull = Trim(A_LoopField107);
        }
        if (A_Index107 == 49) {
            keyWordTrue = Trim(A_LoopField107);
        }
        if (A_Index107 == 50) {
            keyWordFalse = Trim(A_LoopField107);
        }
        if (A_Index107 == 51) {
            keyWordVoid = Trim(A_LoopField107);
        }
        if (A_Index107 == 52) {
            keyWordDouble = Trim(A_LoopField107);
        }
        if (A_Index107 == 53) {
            keyWordChar = Trim(A_LoopField107);
        }
        if (A_Index107 == 54) {
            keyWordUint8 = Trim(A_LoopField107);
        }
        if (A_Index107 == 55) {
            keyWordUint16 = Trim(A_LoopField107);
        }
        if (A_Index107 == 56) {
            keyWordUint32 = Trim(A_LoopField107);
        }
        if (A_Index107 == 57) {
            keyWordUint64 = Trim(A_LoopField107);
        }
        if (A_Index107 == 58) {
            keyWordINT = Trim(A_LoopField107);
        }
        if (A_Index107 == 59) {
            keyWordSTR = Trim(A_LoopField107);
        }
        if (A_Index107 == 60) {
            keyWordBOOL = Trim(A_LoopField107);
        }
        if (A_Index107 == 61) {
            keyWordFLOAT = Trim(A_LoopField107);
        }
        if (A_Index107 == 62) {
            keyWordINT8 = Trim(A_LoopField107);
        }
        if (A_Index107 == 63) {
            keyWordINT16 = Trim(A_LoopField107);
        }
        if (A_Index107 == 64) {
            keyWordINT32 = Trim(A_LoopField107);
        }
        if (A_Index107 == 65) {
            keyWordINT64 = Trim(A_LoopField107);
        }
        if (A_Index107 == 66) {
            keyWordIF = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 67) {
            keyWordElseIf = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 68) {
            keyWordElse = Trim(A_LoopField107);
        }
        if (A_Index107 == 69) {
            keyWordWhileLoop = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 70) {
            keyWordLoopInfinite = Trim(A_LoopField107);
        }
        if (A_Index107 == 71) {
            keyWordLoop = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 72) {
            keyWordLoopParse = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 73) {
            keyWordContinue = Trim(A_LoopField107);
        }
        if (A_Index107 == 74) {
            keyWordBreak = Trim(A_LoopField107);
        }
        if (A_Index107 == 75) {
            keyWordFunc = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 76) {
            keyWordAwait = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 77) {
            keyWordAsync = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 78) {
            keyWordThrow = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 79) {
            keyWordErrorMsg = Trim(A_LoopField107);
        }
        if (A_Index107 == 80) {
            keyWordTry = Trim(A_LoopField107);
        }
        if (A_Index107 == 81) {
            keyWordCatch = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 82) {
            keyWordFinally = Trim(A_LoopField107);
        }
        if (A_Index107 == 83) {
            keyWordReturnStatement = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 84) {
            keyWordArrayAppend = Trim(A_LoopField107);
        }
        if (A_Index107 == 85) {
            keyWordArrayPop = Trim(A_LoopField107);
        }
        if (A_Index107 == 86) {
            keyWordArraySize = Trim(A_LoopField107);
        }
        if (A_Index107 == 87) {
            keyWordArrayInsert = Trim(A_LoopField107);
        }
        if (A_Index107 == 88) {
            keyWordArrayRemove = Trim(A_LoopField107);
        }
        if (A_Index107 == 89) {
            keyWordArrayIndexOf = Trim(A_LoopField107);
        }
        if (A_Index107 == 90) {
            keyWordArrayDefinition = Trim(A_LoopField107);
        }
        if (A_Index107 == 91) {
            keyWordArrayOfIntegersDefinition = Trim(A_LoopField107);
        }
        if (A_Index107 == 92) {
            keyWordArrayOfStringsDefinition = Trim(A_LoopField107);
        }
        if (A_Index107 == 93) {
            keyWordArrayOfFloatingPointNumbersDefinition = Trim(A_LoopField107);
        }
        if (A_Index107 == 94) {
            keyWordArrayOfBooleansDefinition = Trim(A_LoopField107);
        }
        if (A_Index107 == 95) {
            keyWordVar = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 96) {
            keyWordLet = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 97) {
            keyWordConst = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 98) {
            keyWordEnd = Trim(A_LoopField107);
        }
        if (A_Index107 == 99) {
            keyWordGlobal = Trim(A_LoopField107) + " ";
        }
        if (A_Index107 == 100) {
            keyWordComment = Trim(A_LoopField107);
        }
        if (A_Index107 == 101) {
            keyWordCommentOpenMultiLine = Trim(A_LoopField107);
        }
        if (A_Index107 == 102) {
            keyWordCommentCloseMultiLine = Trim(A_LoopField107);
        }
        if (A_Index107 == 103) {
            keyWordEscpaeChar = Trim(A_LoopField107);
        }
        if (A_Index107 == 104) {
            keyWordMainLabel = Trim(A_LoopField107);
        }
        if (A_Index107 == 105) {
            keyWordConcat = Trim(A_LoopField107);
        }
        if (A_Index107 == 106) {
            keyWordAdd = Trim(A_LoopField107);
        }
        if (A_Index107 == 107) {
            keyWordSub = Trim(A_LoopField107);
        }
        if (A_Index107 == 108) {
            keyWordMul = Trim(A_LoopField107);
        }
        if (A_Index107 == 109) {
            keyWordDiv = Trim(A_LoopField107);
        }
        if (A_Index107 == 110) {
            keyWordMod = Trim(A_LoopField107);
        }
        if (A_Index107 == 111) {
            keyWordExp = Trim(A_LoopField107);
        }
        if (A_Index107 == 112) {
            keyWordEqual = Trim(A_LoopField107);
        }
        if (A_Index107 == 113) {
            keyWordStrictEqual = Trim(A_LoopField107);
        }
        if (A_Index107 == 114) {
            keyWordNotEqual = Trim(A_LoopField107);
        }
        if (A_Index107 == 115) {
            keyWordGreater = Trim(A_LoopField107);
        }
        if (A_Index107 == 116) {
            keyWordLess = Trim(A_LoopField107);
        }
        if (A_Index107 == 117) {
            keyWordGreaterEqual = Trim(A_LoopField107);
        }
        if (A_Index107 == 118) {
            keyWordLessEqual = Trim(A_LoopField107);
        }
        if (A_Index107 == 119) {
            keyWordAnd = Trim(A_LoopField107);
        }
        if (A_Index107 == 120) {
            keyWordOr = Trim(A_LoopField107);
        }
        if (A_Index107 == 121) {
            keyWordNot = Trim(A_LoopField107);
        }
        if (A_Index107 == 122) {
            keyWordBitAnd = Trim(A_LoopField107);
        }
        if (A_Index107 == 123) {
            keyWordBitOr = Trim(A_LoopField107);
        }
        if (A_Index107 == 124) {
            keyWordBitXor = Trim(A_LoopField107);
        }
        if (A_Index107 == 125) {
            keyWordBitNot = Trim(A_LoopField107);
        }
        if (A_Index107 == 126) {
            keyWordShiftLeft = Trim(A_LoopField107);
        }
        if (A_Index107 == 127) {
            keyWordShiftRight = Trim(A_LoopField107);
        }
        if (A_Index107 == 128) {
            keyWordShiftUnsignedRight = Trim(A_LoopField107);
        }
        if (A_Index107 == 129) {
            keyWordAssign = Trim(A_LoopField107);
        }
        if (A_Index107 == 130) {
            keyWordAssignAdd = Trim(A_LoopField107);
        }
        if (A_Index107 == 131) {
            keyWordAssignConcat = Trim(A_LoopField107);
        }
        if (A_Index107 == 132) {
            keyWordAssignSub = Trim(A_LoopField107);
        }
        if (A_Index107 == 133) {
            keyWordAssignMul = Trim(A_LoopField107);
        }
        if (A_Index107 == 134) {
            keyWordAssignDiv = Trim(A_LoopField107);
        }
        if (A_Index107 == 135) {
            keyWordAssignMod = Trim(A_LoopField107);
        }
        if (A_Index107 == 136) {
            keyWordAssignShiftLeft = Trim(A_LoopField107);
        }
        if (A_Index107 == 137) {
            keyWordAssignShiftRight = Trim(A_LoopField107);
        }
        if (A_Index107 == 138) {
            keyWordLogicalAssignShiftRight = Trim(A_LoopField107);
        }
        if (A_Index107 == 139) {
            keyWordAssignBitAnd = Trim(A_LoopField107);
        }
        if (A_Index107 == 140) {
            keyWordAssignBitOr = Trim(A_LoopField107);
        }
        if (A_Index107 == 141) {
            keyWordAssignBitXor = Trim(A_LoopField107);
        }
        if (A_Index107 == 142) {
            keyWordTernary1 = Trim(A_LoopField107);
        }
        if (A_Index107 == 143) {
            keyWordTernary2 = Trim(A_LoopField107);
        }
        if (A_Index107 == 144) {
            keyWordInc = Trim(A_LoopField107);
        }
        if (A_Index107 == 145) {
            keyWordDec = Trim(A_LoopField107);
        }
        if (A_Index107 == 146) {
            AHKlikeLoopsIndexedAt = Trim(A_LoopField107);
        }
        if (A_Index107 == 147) {
            keyWordAIndex = Trim(A_LoopField107);
        }
        if (A_Index107 == 148) {
            keyWordALoopField = Trim(A_LoopField107);
        }
        if (A_Index107 == 149) {
            useCurlyBraces = Trim(A_LoopField107);
        }
        if (A_Index107 == 150) {
            useEnd = Trim(A_LoopField107);
        }
        if (A_Index107 == 151) {
            useSemicolon = Trim(A_LoopField107);
        }
        if (A_Index107 == 152) {
            useParentheses = Trim(A_LoopField107);
        }
        if (A_Index107 == 153) {
            usePrefixTypeForTypeDefinition = Trim(A_LoopField107);
        }
        if (A_Index107 == 154) {
            usePostfixTypeForTypeDefinition = Trim(A_LoopField107);
        }
        if (A_Index107 == 155) {
            usePythonicColonSyntax = Trim(A_LoopField107);
        }
        if (A_Index107 == 156) {
            useCurlyBracesSyntaxForArrayDef = Trim(A_LoopField107);
        }
        if (A_Index107 == 157) {
            useInJavaScriptAlwaysUseVar = Trim(A_LoopField107);
        }
        if (A_Index107 == 158) {
            useJavaScriptInAfullHTMLfile = Trim(A_LoopField107);
        }
        if (A_Index107 == 159) {
            useJavaScriptAmainFuncDef = Trim(A_LoopField107);
        }
        if (A_Index107 == 160) {
            useJavaScriptAllFuncsAreAsync = Trim(A_LoopField107);
        }
        if (A_Index107 == 161) {
            useJavaScriptAlwaysTripleEqual = Trim(A_LoopField107);
        }
    }
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        std::vector<std::string> items108 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
        for (size_t A_Index108 = 0; A_Index108 < items108.size() + 0; A_Index108++) {
            std::string A_LoopField108 = items108[A_Index108 - 0];
            if (A_Index108 == 0) {
                langToConvertTo_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 1) {
                langFileExtension_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 2) {
                commands_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 3) {
                keyWordAlliance_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 4) {
                keyWordCrew_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 5) {
                keyWordMethod_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 6) {
                keyWordDefObj_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 7) {
                keyWordProp_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 8) {
                keyWordThis_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 9) {
                keyWordInclude_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 10) {
                keyWordCodeInTheTranspiledLangStart_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 11) {
                keyWordCodeInTheTranspiledLangEnd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 12) {
                keyWordCodeInTheTranspiledLangStartCPP_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 13) {
                keyWordCodeInTheTranspiledLangEndCPP_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 14) {
                keyWordCodeInTheTranspiledLangStartPY_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 15) {
                keyWordCodeInTheTranspiledLangEndPY_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 16) {
                keyWordCodeInTheTranspiledLangStartJS_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 17) {
                keyWordCodeInTheTranspiledLangEndJS_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 18) {
                keyWordCodeInTheTranspiledLangStartGO_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 19) {
                keyWordCodeInTheTranspiledLangEndGO_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 20) {
                keyWordCodeInTheTranspiledLangStartLUA_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 21) {
                keyWordCodeInTheTranspiledLangEndLUA_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 22) {
                keyWordCodeInTheTranspiledLangStartCS_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 23) {
                keyWordCodeInTheTranspiledLangEndCS_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 24) {
                keyWordCodeInTheTranspiledLangStartJAVA_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 25) {
                keyWordCodeInTheTranspiledLangEndJAVA_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 26) {
                keyWordCodeInTheTranspiledLangStartKT_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 27) {
                keyWordCodeInTheTranspiledLangEndKT_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 28) {
                keyWordCodeInTheTranspiledLangStartRB_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 29) {
                keyWordCodeInTheTranspiledLangEndRB_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 30) {
                keyWordCodeInTheTranspiledLangStartNIM_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 31) {
                keyWordCodeInTheTranspiledLangEndNIM_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 32) {
                keyWordCodeInTheTranspiledLangStartAHK_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 33) {
                keyWordCodeInTheTranspiledLangEndAHK_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 34) {
                keyWordCodeInTheTranspiledLangStartSWIFT_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 35) {
                keyWordCodeInTheTranspiledLangEndSWIFT_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 36) {
                keyWordCodeInTheTranspiledLangStartDART_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 37) {
                keyWordCodeInTheTranspiledLangEndDART_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 38) {
                keyWordCodeInTheTranspiledLangStartTS_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 39) {
                keyWordCodeInTheTranspiledLangEndTS_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 40) {
                keyWordCodeInTheTranspiledLangStartGROOVY_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 41) {
                keyWordCodeInTheTranspiledLangEndGROOVY_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 42) {
                keyWordCodeInTheTranspiledLangStartHTVM_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 43) {
                keyWordCodeInTheTranspiledLangEndHTVM_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 44) {
                keyWordCodeInHTVMstart_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 45) {
                keyWordCodeInHTVMend_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 46) {
                keyWordCurlyBraceOpen_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 47) {
                keyWordCurlyBraceClose_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 48) {
                keyWordNull_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 49) {
                keyWordTrue_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 50) {
                keyWordFalse_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 51) {
                keyWordVoid_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 52) {
                keyWordDouble_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 53) {
                keyWordChar_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 54) {
                keyWordUint8_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 55) {
                keyWordUint16_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 56) {
                keyWordUint32_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 57) {
                keyWordUint64_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 58) {
                keyWordINT_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 59) {
                keyWordSTR_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 60) {
                keyWordBOOL_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 61) {
                keyWordFLOAT_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 62) {
                keyWordINT8_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 63) {
                keyWordINT16_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 64) {
                keyWordINT32_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 65) {
                keyWordINT64_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 66) {
                keyWordIF_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 67) {
                keyWordElseIf_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 68) {
                keyWordElse_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 69) {
                keyWordWhileLoop_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 70) {
                keyWordLoopInfinite_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 71) {
                keyWordLoop_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 72) {
                keyWordLoopParse_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 73) {
                keyWordContinue_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 74) {
                keyWordBreak_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 75) {
                keyWordFunc_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 76) {
                keyWordAwait_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 77) {
                keyWordAsync_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 78) {
                keyWordThrow_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 79) {
                keyWordErrorMsg_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 80) {
                keyWordTry_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 81) {
                keyWordCatch_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 82) {
                keyWordFinally_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 83) {
                keyWordReturnStatement_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 84) {
                keyWordArrayAppend_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 85) {
                keyWordArrayPop_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 86) {
                keyWordArraySize_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 87) {
                keyWordArrayInsert_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 88) {
                keyWordArrayRemove_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 89) {
                keyWordArrayIndexOf_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 90) {
                keyWordArrayDefinition_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 91) {
                keyWordArrayOfIntegersDefinition_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 92) {
                keyWordArrayOfStringsDefinition_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 93) {
                keyWordArrayOfFloatingPointNumbersDefinition_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 94) {
                keyWordArrayOfBooleansDefinition_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 95) {
                keyWordVar_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 96) {
                keyWordLet_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 97) {
                keyWordConst_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 98) {
                keyWordEnd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 99) {
                keyWordGlobal_2 = Trim(A_LoopField108) + " ";
            }
            if (A_Index108 == 100) {
                keyWordComment_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 101) {
                keyWordCommentOpenMultiLine_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 102) {
                keyWordCommentCloseMultiLine_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 103) {
                keyWordEscpaeChar_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 104) {
                keyWordMainLabel_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 105) {
                keyWordConcat_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 106) {
                keyWordAdd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 107) {
                keyWordSub_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 108) {
                keyWordMul_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 109) {
                keyWordDiv_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 110) {
                keyWordMod_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 111) {
                keyWordExp_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 112) {
                keyWordEqual_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 113) {
                keyWordStrictEqual_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 114) {
                keyWordNotEqual_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 115) {
                keyWordGreater_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 116) {
                keyWordLess_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 117) {
                keyWordGreaterEqual_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 118) {
                keyWordLessEqual_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 119) {
                keyWordAnd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 120) {
                keyWordOr_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 121) {
                keyWordNot_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 122) {
                keyWordBitAnd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 123) {
                keyWordBitOr_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 124) {
                keyWordBitXor_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 125) {
                keyWordBitNot_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 126) {
                keyWordShiftLeft_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 127) {
                keyWordShiftRight_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 128) {
                keyWordShiftUnsignedRight_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 129) {
                keyWordAssign_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 130) {
                keyWordAssignAdd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 131) {
                keyWordAssignConcat_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 132) {
                keyWordAssignSub_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 133) {
                keyWordAssignMul_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 134) {
                keyWordAssignDiv_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 135) {
                keyWordAssignMod_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 136) {
                keyWordAssignShiftLeft_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 137) {
                keyWordAssignShiftRight_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 138) {
                keyWordLogicalAssignShiftRight_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 139) {
                keyWordAssignBitAnd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 140) {
                keyWordAssignBitOr_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 141) {
                keyWordAssignBitXor_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 142) {
                keyWordTernary1_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 143) {
                keyWordTernary2_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 144) {
                keyWordInc_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 145) {
                keyWordDec_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 146) {
                AHKlikeLoopsIndexedAt_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 147) {
                keyWordAIndex_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 148) {
                keyWordALoopField_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 149) {
                useCurlyBraces_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 150) {
                useEnd_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 151) {
                useSemicolon_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 152) {
                useParentheses_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 153) {
                usePrefixTypeForTypeDefinition_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 154) {
                usePostfixTypeForTypeDefinition_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 155) {
                usePythonicColonSyntax_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 156) {
                useCurlyBracesSyntaxForArrayDef_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 157) {
                useInJavaScriptAlwaysUseVar_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 158) {
                useJavaScriptInAfullHTMLfile_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 159) {
                useJavaScriptAmainFuncDef_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 160) {
                useJavaScriptAllFuncsAreAsync_2 = Trim(A_LoopField108);
            }
            if (A_Index108 == 161) {
                useJavaScriptAlwaysTripleEqual_2 = Trim(A_LoopField108);
            }
        }
    }
    ...
    */
    ...
    std::vector<std::string> items109 = LoopParseFunc(allInstructionFile, "\n", "\r");
    for (size_t A_Index109 = 0; A_Index109 < items109.size() + 0; A_Index109++) {
        std::string A_LoopField109 = items109[A_Index109 - 0];
        if (RegExMatch(Trim(A_LoopField109), "^name: [A-Za-z0-9_]+")) {
            availableFuncsInHTVMInHTVM += Trim(StrSplit(Trim(A_LoopField109), "name: ", 2)) + Chr(10);
        }
    }
    ...
    for (size_t A_Index110 = 0; A_Index110 < items110.size() + 0; A_Index110++) {
        ...
        if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEnd)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndCPP)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndPY)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndJS)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndGO)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndLUA)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndCS)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndJAVA)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndKT)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndRB)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndNIM)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndAHK)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndSWIFT)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndDART)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndTS)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndGROOVY)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangEndHTVM)) {
        ...
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInHTVMend)) {
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            ...
            holdTempDataProgrammingBlockThenPutInArr += A_LoopField110 + Chr(10);
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStart)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartCPP)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartPY)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartJS)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartGO)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartLUA)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartCS)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartJAVA)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartKT)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartRB)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartNIM)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartAHK)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartSWIFT)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartDART)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartTS)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartGROOVY)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInTheTranspiledLangStartHTVM)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField110)) == StrLower(keyWordCodeInHTVMstart)) {
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
            ...
            programmingBlocksTemp += A_LoopField110 + Chr(10);
        }
    }
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            if (InStr(StrLower(code), StrLower(keyWordInclude + " "))) {
                for (int A_Index111 = 0; A_Index111 < 10000 + 0; A_Index111++) {
                    doseCodeHaveLibs = 0;
                    allLibCODE = "";
                    if (A_Index111 == 0) {
                        ...
                        for (size_t A_Index112 = 0; A_Index112 < items112.size() + 0; A_Index112++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField112)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                HTVM_Append(allLibsWeSee, StrReplace(StringTrimLeft(Trim(A_LoopField112), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                HTVM_Append(allLibsWeSeeSEE, StrReplace(StringTrimLeft(Trim(A_LoopField112), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                doseCodeHaveLibs = 1;
                            }
                        }
                    } else {
                        ...
                        for (size_t A_Index113 = 0; A_Index113 < items113.size() + 0; A_Index113++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField113)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                doseCodeHaveLibs_HAS_SEEN = 0;
                                for (int A_Index114 = 0; A_Index114 < HTVM_Size(allLibsWeSee) + 0; A_Index114++) {
                                    if (StrReplace(StringTrimLeft(Trim(ALoopField), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), "") == allLibsWeSee[A_Index114]) {
                                        doseCodeHaveLibs_HAS_SEEN = 1;
                                    }
                                }
                                if (doseCodeHaveLibs_HAS_SEEN == 0) {
                                    HTVM_Append(allLibsWeSee, StrReplace(StringTrimLeft(Trim(A_LoopField113), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                    HTVM_Append(allLibsWeSeeSEE, StrReplace(StringTrimLeft(Trim(A_LoopField113), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                    doseCodeHaveLibs = 1;
                                }
                            }
                        }
                    }
                    for (int A_Index115 = 0; A_Index115 < HTVM_Size(allLibsWeSee) + 0; A_Index115++) {
                        allLibsWeSeeHOLD = allLibsWeSee[A_Index115];
                        doseCodeHaveLibs_HAS_SEEN2 = 0;
                        for (int A_Index116 = 0; A_Index116 < HTVM_Size(allLibsWeSeeSEE) - HTVM_Size(allLibsWeSee) + 0; A_Index116++) {
                            if (allLibsWeSeeHOLD == allLibsWeSeeSEE[A_Index116]) {
                                doseCodeHaveLibs_HAS_SEEN2 = 1;
                            }
                        }
                        if (doseCodeHaveLibs_HAS_SEEN2 == 0) {
                            allLibCODE += FileRead(Trim(allLibsWeSee[HTVM_Size(allLibsWeSee) - A_Index115 - 1])) + Chr(10);
                        }
                    ...
                    for (size_t A_Index117 = 0; A_Index117 < items117.size() + 0; A_Index117++) {
                        ...
                        if (SubStr(StrLower(Trim(A_LoopField117)), 1, StrLen(StrLower(keyWordInclude + " "))) != StrLower(keyWordInclude + " ")) {
                            allLibCODEfix += A_LoopField117 + Chr(10);
                        }
                    }
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (size_t A_Index119 = 0; A_Index119 < items119.size() + 0; A_Index119++) {
            ...
            theIdNumOfThe34theVar[A_Index119] = theIdNumOfThe34theVar[A_Index119] + Chr(34);
            HTVM_Append(getAllCharForTheFurtureSoIcanAddEscapeChar, A_LoopField119);
        }
        ...
        for (size_t A_Index120 = 0; A_Index120 < items120.size() + 0; A_Index120++) {
            ...
            if (A_LoopField120 == keyWordEscpaeChar && getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index120 + 1] == Chr(34)) {
                ...
                if (fixOutFixDoubleQuotesInsideDoubleQuotesFIXok != 1) {
                    OutFixDoubleQuotesInsideDoubleQuotes += A_LoopField120;
                } else {
        ...
        if (keyWordEscpaeChar == Chr(92) && langToConvertTo != langFileExtension_2) {
            ...
            for (size_t A_Index121 = 0; A_Index121 < items121.size() + 0; A_Index121++) {
                ...
                if (A_LoopField121 == Chr(34)) {
                    areWEinSome34sNum++;
                }
                if (areWEinSome34sNum == 1) {
                    if (A_LoopField121 != Chr(34)) {
                        if (A_LoopField121 == keyWordEscpaeChar && langToConvertTo != langFileExtension_2) {
                            theIdNumOfThe34theVar[theIdNumOfThe34] = theIdNumOfThe34theVar[theIdNumOfThe34] + Chr(92);
                        } else {
                            theIdNumOfThe34theVar[theIdNumOfThe34] = theIdNumOfThe34theVar[theIdNumOfThe34] + A_LoopField121;
                        }
                    } else {
                        theIdNumOfThe34++;
                ...
                if (areWEinSome34sNum == 2 || areWEinSome34sNum == 0) {
                    if (A_LoopField121 != Chr(34)) {
                        htCodeOUT754754 += A_LoopField121;
                    }
                    areWEinSome34sNum = 0;
                }
            }
            ...
            for (size_t A_Index122 = 0; A_Index122 < items122.size() + 0; A_Index122++) {
                ...
                if (A_LoopField122 == Chr(34)) {
                    areWEinSome34sNum++;
                }
                if (areWEinSome34sNum == 1) {
                    if (A_LoopField122 != Chr(34)) {
                        if (A_LoopField122 == keyWordEscpaeChar && keyWordEscpaeChar == getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index122 + 1] && langToConvertTo != langFileExtension_2) {
                        ...
                        else if (A_LoopField122 == keyWordEscpaeChar && langToConvertTo != langFileExtension_2) {
                            ...
                            theIdNumOfThe34theVar[theIdNumOfThe34] = theIdNumOfThe34theVar[theIdNumOfThe34] + A_LoopField122;
                        }
                    } else {
                        theIdNumOfThe34++;
                        htCodeOUT754754 += "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(theIdNumOfThe34) + Chr(65) + Chr(65);
                ...
                if (areWEinSome34sNum == 2 || areWEinSome34sNum == 0) {
                    if (A_LoopField122 != Chr(34)) {
                        htCodeOUT754754 += A_LoopField122;
                    }
                    areWEinSome34sNum = 0;
                }
            }
        ...
        for (int A_Index123 = 0; A_Index123 < theIdNumOfThe34 + 0; A_Index123++) {
        ...
        for (size_t A_Index124 = 0; A_Index124 < items124.size() + 0; A_Index124++) {
            ...
            if (InStr(A_LoopField124, " " + keyWordComment) != false && SubStr(Trim(A_LoopField124), 1, StrLen(keyWordComment)) != keyWordComment) {
                posForRemoveCommentsOnTheEndOfTheLine = 0;
                slidingWinFixCommentsRmI = 0;
                slidingWinFixCommentsRm = slidingWinFixCommentsRmFUNC(A_LoopField124);
                for (int A_Index125 = 0; A_Index125 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index125++) {
                    slidingWinFixCommentsRmI = A_Index125;
                    slidingWinFixCommentsRmHold = "";
                    for (int A_Index126 = 0; A_Index126 < StrLen(" " + keyWordComment) + 0; A_Index126++) {
                        slidingWinFixCommentsRmHold += slidingWinFixCommentsRm[slidingWinFixCommentsRmI + A_Index126];
                    }
                    if (Trim(slidingWinFixCommentsRmHold) == keyWordComment) {
                        posForRemoveCommentsOnTheEndOfTheLine = A_Index125;
                        break;
                    }
                }
                if (posForRemoveCommentsOnTheEndOfTheLine > 0) {
                    newStringOutCode += SubStr(A_LoopField124, 1, posForRemoveCommentsOnTheEndOfTheLine) + Chr(10);
                } else {
                    newStringOutCode += A_LoopField124 + Chr(10);
                }
            } else {
                newStringOutCode += A_LoopField124 + Chr(10);
            }
        ...
        if (useCurlyBraces == "on") {
            ...
            for (size_t A_Index127 = 0; A_Index127 < items127.size() + 0; A_Index127++) {
                ...
                str1 = "";
                if (InStr(A_LoopField127, keyWordCurlyBraceOpen) || InStr(A_LoopField127, keyWordCurlyBraceClose)) {
                    str1 = StrReplace(A_LoopField127, keyWordCurlyBraceOpen, "{");
                    ...
                    fixSomeCurlyBraceForExratFlexability += A_LoopField127 + Chr(10);
                }
            }
            ...
            for (size_t A_Index128 = 0; A_Index128 < items128.size() + 0; A_Index128++) {
                ...
                fixSomeCurlyBraceForExratFlexabilityTriHELP += Trim(A_LoopField128) + Chr(10);
            }
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (size_t A_Index129 = 0; A_Index129 < items129.size() + 0; A_Index129++) {
                    ...
                    htCodeOutFixINT2 = 0;
                    if (isLineAconstruct(Trim(A_LoopField129)) == true || Trim(A_LoopField129) == keyWordCurlyBraceOpen) {
                        htCodeOutFixINT2 = 1;
                    }
                    htCodeOutFixINT = 0;
                    std::vector<std::string> items130 = LoopParseFunc(A_LoopField129, " ");
                    for (size_t A_Index130 = 0; A_Index130 < items130.size() + 0; A_Index130++) {
                        std::string A_LoopField130 = items130[A_Index130 - 0];
                        htCodeOutFixINT++;
                    }
                    htCodeOutFixINT--;
                    std::vector<std::string> items131 = LoopParseFunc(A_LoopField129, " ");
                    for (size_t A_Index131 = 0; A_Index131 < items131.size() + 0; A_Index131++) {
                        std::string A_LoopField131 = items131[A_Index131 - 0];
                        if (htCodeOutFixINT == A_Index131 && htCodeOutFixINT2 == 1) {
                            htCodeOutFixINT2 = 0;
                            htCodeOutFixEnd += HTVMmatchStrRrplace(A_LoopField131, keyWordCurlyBraceOpen, "{") + " ";
                        } else {
                            htCodeOutFixEnd += A_LoopField131 + " ";
                        }
                    }
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (size_t A_Index132 = 0; A_Index132 < items132.size() + 0; A_Index132++) {
                    ...
                    htCodeOutFixINT2 = 0;
                    if (isLineAconstruct(Trim(A_LoopField132)) == true || Trim(A_LoopField132) == keyWordCurlyBraceClose) {
                        htCodeOutFixINT2 = 1;
                    }
                    std::vector<std::string> items133 = LoopParseFunc(A_LoopField132, " ");
                    for (size_t A_Index133 = 0; A_Index133 < items133.size() + 0; A_Index133++) {
                        std::string A_LoopField133 = items133[A_Index133 - 0];
                        if (htCodeOutFixINT2 == 1 || Trim(A_LoopField133) == keyWordCurlyBraceClose) {
                            htCodeOutFixINT2 = 0;
                            htCodeOutFixEnd += HTVMmatchStrRrplace(A_LoopField133, keyWordCurlyBraceClose, "}") + " ";
                        } else {
        ...
        if (useEnd == "on") {
            ...
            for (size_t A_Index134 = 0; A_Index134 < items134.size() + 0; A_Index134++) {
                ...
                if (StrLower(Trim(A_LoopField134)) == StrLower(keyWordEnd)) {
                    htCodeOutFixEnd += "}\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField134)), 1, StrLen(StrLower(keyWordIF))) == StrLower(keyWordIF) && isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += A_LoopField134 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField134)), 1, StrLen(StrLower(keyWordWhileLoop))) == StrLower(keyWordWhileLoop) && isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += A_LoopField134 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField134)), 1, StrLen(StrLower(keyWordElseIf))) == StrLower(keyWordElseIf) && isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField134 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField134)), 1, StrLen(StrLower(keyWordElse))) == StrLower(keyWordElse) && isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField134 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField134)), 1, StrLen(StrLower(keyWordCatch))) == StrLower(keyWordCatch) && isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField134 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField134)), 1, StrLen(StrLower(keyWordFinally))) == StrLower(keyWordFinally) && isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField134 + "\n{\n";
                }
                else if (isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += A_LoopField134 + "\n{\n";
                } else {
                    htCodeOutFixEnd += A_LoopField134 + Chr(10);
                }
            }
            code = StringTrimRight(htCodeOutFixEnd, 1);
        }
        ...
        for (int A_Index137 = 0; A_Index137 < 2 + 0; A_Index137++) {
            ...
            for (size_t A_Index138 = 0; A_Index138 < items138.size() + 0; A_Index138++) {
                ...
                if (InStr(A_LoopField138, " " + keyWordAssign + " ") || InStr(A_LoopField138, " " + keyWordAssignAdd + " ") || InStr(A_LoopField138, " " + keyWordAssignConcat + " ") || InStr(A_LoopField138, " " + keyWordAssignSub + " ") || InStr(A_LoopField138, " " + keyWordAssignMul + " ") || InStr(A_LoopField138, " " + keyWordAssignDiv + " ") || InStr(A_LoopField138, " " + keyWordAssignMod + " ") || InStr(A_LoopField138, " " + keyWordAssignShiftLeft + " ") || InStr(A_LoopField138, " " + keyWordAssignShiftRight + " ") || InStr(A_LoopField138, " " + keyWordLogicalAssignShiftRight + " ") || InStr(A_LoopField138, " " + keyWordAssignBitAnd + " ") || InStr(A_LoopField138, " " + keyWordAssignBitOr + " ") || InStr(A_LoopField138, " " + keyWordAssignBitXor + " ") && useCurlyBracesSyntaxForArrayDef == "on") {
                    if (SubStr(StrLower(A_LoopField138), 1, StrLen(StrLower(keyWordFunc))) == StrLower(keyWordFunc) || SubStr(StrLower(A_LoopField138), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc)) {
                        if (InStr(Trim(A_LoopField138), "{") && Trim(A_LoopField138) != "{") {
                            outCodeFixBraces += Trim(StrReplace(Trim(A_LoopField138), "{", "")) + "\n{\n";
                        }
                        else if (InStr(Trim(A_LoopField138), "}") && Trim(A_LoopField138) != "}") {
                            outCodeFixBraces += "}\n" + Trim(StrReplace(Trim(A_LoopField138), "}", "")) + Chr(10);
                        } else {
                            outCodeFixBraces += Trim(A_LoopField138) + Chr(10);
                        }
                    } else {
                        outCodeFixBraces += Trim(A_LoopField138) + Chr(10);
                    }
        ...
        if (usePythonicColonSyntax == "on" || useCurlyBraces == "off" && useEnd == "off") {
            ...
            for (size_t A_Index139 = 0; A_Index139 < items139.size() + 0; A_Index139++) {
                ...
                if (isLineAconstruct(Trim(A_LoopField139)) == true) {
                    htCodeOutFixEnd += StringTrimRight(A_LoopField139, 1) + Chr(10);
                } else {
                    htCodeOutFixEnd += A_LoopField139 + Chr(10);
                }
            }
            code = StringTrimRight(htCodeOutFixEnd, 1);
        }
        ...
        if (isNotHTVMfile2 == 0) {
            ...
            for (size_t A_Index140 = 0; A_Index140 < items140.size() + 0; A_Index140++) {
                ...
                if (StrLower(Trim(A_LoopField140)) == StrLower(keyWordMainLabel)) {
                    didWeUseMainLabel = 1;
                    if (langToConvertTo == langFileExtension_2) {
                    ...
                    codeOutFixAndAddMainFunc += A_LoopField140 + Chr(10);
                }
            }
        ...
        for (size_t A_Index141 = 0; A_Index141 < items141.size() + 0; A_Index141++) {
            ...
            HTVM_Append(lookIntoTheNextLineForFuncWhitNoKeyWord, A_LoopField141);
        }
        ...
        for (size_t A_Index142 = 0; A_Index142 < items142.size() + 0; A_Index142++) {
            ...
            lineDone = 0;
            if (SubStr(A_LoopField142, 1, StrLen(keyWordComment)) == keyWordComment) {
                lineDone = 1;
                str1 = StringTrimLeft(A_LoopField142, StrLen(keyWordComment));
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (Trim(A_LoopField142) == keyWordCommentOpenMultiLine) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (Trim(A_LoopField142) == keyWordCommentCloseMultiLine) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (InStr(A_LoopField142, "[][][][][] ")) {
                lineDone = 1;
                str1 = StrSplit(A_LoopField142, " ", 2);
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordDefObj))) == StrLower(keyWordDefObj)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordDefObj)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordDefObj_2) + " " + str0 + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordAlliance))) == StrLower(keyWordAlliance)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordAlliance)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordAlliance_2) + " " + str0 + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordCrew))) == StrLower(keyWordCrew)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordCrew)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordCrew_2) + " " + str0 + Chr(10);
                }
            }
            else if (InStr(A_LoopField142, "[end][end][end][end][end] ")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += "}" + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordProp))) == StrLower(keyWordProp)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordProp)));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordMethod))) == StrLower(keyWordMethod)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordMethod)));
                str1 = Trim(StrSplit(str0, "-----------------------HTVM-OSP-HTVM-OBJ--------------", 1));
                str20 = Trim(StrSplit(str0, "-----------------------HTVM-OSP-HTVM-OBJ--------------", 2));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordIF))) == StrLower(keyWordIF) && SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordElseIf))) != StrLower(keyWordElseIf)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordIF)));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordElseIf))) == StrLower(keyWordElseIf) && SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordIF))) != StrLower(keyWordIF)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordElseIf)));
                str1 = Trim(expressionParserTranspiler("(" + str1 + ")"));
                str1 = StringTrimRight(str1, 1);
                str1 = StringTrimLeft(str1, 1);
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(Trim(A_LoopField142)) == StrLower(keyWordElse) || StrLower(Trim(A_LoopField142)) == StrLower(keyWordElse + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordWhileLoop))) == StrLower(keyWordWhileLoop)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordWhileLoop)));
                str1 = Trim(expressionParserTranspiler("(" + str1 + ")"));
                str1 = StringTrimRight(str1, 1);
                str1 = StringTrimLeft(str1, 1);
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(Trim(A_LoopField142)) == StrLower(keyWordTry) || StrLower(Trim(A_LoopField142)) == StrLower(keyWordTry + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
                        htCode += keyWordTry_2 + ":\n";
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordCatch))) == StrLower(keyWordCatch)) {
                lineDone = 1;
                str1 = Trim(StrReplace(StrReplace(StringTrimLeft(A_LoopField142, StrLen(keyWordCatch)), "(", ""), ")", ""));
            ...
            else if (StrLower(Trim(A_LoopField142)) == StrLower(keyWordFinally) || StrLower(Trim(A_LoopField142)) == StrLower(keyWordFinally + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordThrow))) == StrLower(keyWordThrow)) {
                lineDone = 1;
                str1 = Trim(A_LoopField142);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
                }
            ...
            else if (StrLower(A_LoopField142) == StrLower(keyWordBreak) || StrLower(A_LoopField142) == StrLower(keyWordBreak + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (StrLower(A_LoopField142) == StrLower(Trim(keyWordReturnStatement)) || StrLower(A_LoopField142) == StrLower(Trim(keyWordReturnStatement) + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (SubStr(Trim(StrLower(A_LoopField142)), 1, StrLen(StrLower(keyWordReturnStatement))) == StrLower(keyWordReturnStatement)) {
                lineDone = 1;
                str1 = Trim(expressionParserTranspiler(Trim(StringTrimLeft(A_LoopField142, StrLen(keyWordReturnStatement)))));
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
                }
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(A_LoopField142) == StrLower(keyWordContinue) || StrLower(A_LoopField142) == StrLower(keyWordContinue + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (StrLower(A_LoopField142) == "::" + keyWordContinue || StrLower(A_LoopField142) == "::" + keyWordContinue + ";") {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += "::" + keyWordContinue_2 + Chr(10);
                }
            ...
            else if (StrLower(A_LoopField142) == StrLower(keyWordLoopInfinite) || StrLower(A_LoopField142) == StrLower(keyWordLoopInfinite + ":")) {
                // infinity loops
            ...
            else if (SubStr(Trim(StrLower(A_LoopField142)), 1, StrLen(StrLower(keyWordLoop))) == StrLower(keyWordLoop) && SubStr(Trim(StrLower(A_LoopField142)), 1, StrLen(StrLower(keyWordLoop)) + 2) != StrLower(keyWordLoop) + "% " && SubStr(Trim(StrLower(A_LoopField142)), 1, StrLen(StrLower(keyWordLoopParse))) != StrLower(keyWordLoopParse)) {
                out2 = StringTrimLeft(A_LoopField142, StrLen(keyWordLoop));
            ...
            else if (SubStr(Trim(StrLower(A_LoopField142)), 1, StrLen(StrLower(keyWordLoop)) + 2) == StrLower(keyWordLoop) + "% ") {
                howMany_fixAindexInGoUnused++;
                out2 = StringTrimLeft(A_LoopField142, StrLen(keyWordLoop) + 2);
                out2 = StrReplace(out2, ":", "");
                //MsgBox % out2
                //MsgBox, % out2
                out2 = Trim(out2);
            ...
            else if (SubStr(StrLower(A_LoopField142), 1, StrLen(StrLower(keyWordLoopParse))) == StrLower(keyWordLoopParse)) {
                howMany_fixAindexInGoUnused++;
                var1 = StringTrimLeft(A_LoopField142, StrLen(keyWordLoopParse));
                out2 = StrReplace(out2, ":", "");
                lineDone = 1;
            ...
            else if (SubStrLastChars(Trim(A_LoopField142), StrLen(keyWordInc)) == keyWordInc || SubStrLastChars(Trim(A_LoopField142), StrLen(keyWordInc + ";")) == keyWordInc + ";" && lineDone == 0) {
                if (useSemicolon == "on") {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField142), StrLen(keyWordInc + ";")));
                } else {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField142), StrLen(keyWordInc)));
                }
                str1 = Trim(expressionParserTranspiler(str1));
            ...
            else if (SubStrLastChars(Trim(A_LoopField142), StrLen(keyWordDec)) == keyWordDec || SubStrLastChars(Trim(A_LoopField142), StrLen(keyWordDec + ";")) == keyWordDec + ";" && lineDone == 0) {
                if (useSemicolon == "on") {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField142), StrLen(keyWordDec + ";")));
                } else {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField142), StrLen(keyWordDec)));
                }
                str1 = Trim(expressionParserTranspiler(str1));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField142)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ") && langToConvertTo == langFileExtension_2) {
                htCode += keyWordInclude_2 + " " + Trim(StringTrimLeft(Trim(A_LoopField142), StrLen(StrLower(keyWordInclude) + " "))) + Chr(10);
            }
            else if (StrLower(A_LoopField142) == StrLower(keyWordGlobal) || StrLower(A_LoopField142) == StrLower(keyWordGlobal + ";")) {
                if (langToConvertTo == "ahk") {
                    htCode += "global\n";
                }
            }
            else if (SubStr(StrLower(A_LoopField142), 1, StrLen(StrLower(keyWordAwait))) == StrLower(keyWordAwait)) {
                str1 = StringTrimLeft(A_LoopField142, StrLen(keyWordAwait));
            ...
            else if (SubStr(StrLower(A_LoopField142), 1, StrLen(StrLower(keyWordGlobal))) == StrLower(keyWordGlobal)) {
                str1 = StringTrimLeft(A_LoopField142, StrLen(keyWordGlobal));
                //MsgBox, % A_LoopField142
            ...
            else if (SubStr(StrLower(A_LoopField142), 1, StrLen(keyWordFunc)) == StrLower(keyWordFunc) || SubStr(StrLower(A_LoopField142), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc) && InStr(StrLower(A_LoopField142), " main(") == false && lineDone == 0) {
                lineDone = 1;
                if (SubStr(StrLower(A_LoopField142), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc)) {
                    // is async
                    int1 = 1;
                    str1 = Trim(StringTrimLeft(A_LoopField142, StrLen(StrLower(keyWordAsync + keyWordFunc))));
                } else {
                    // is async
                    int1 = 0;
                    str1 = Trim(StringTrimLeft(A_LoopField142, StrLen(StrLower(keyWordFunc))));
                }
                if (langToConvertTo != langFileExtension_2 && langToConvertTo != "cpp" && langToConvertTo != "go" && langToConvertTo != "cs" && langToConvertTo != "java" && langToConvertTo != "kt" && langToConvertTo != "nim" && langToConvertTo != "swift" && langToConvertTo != "dart" && langToConvertTo != "ts") {
                    if (str1 != "") {
                        ...
                        for (size_t A_Index144 = 0; A_Index144 < items144.size() + 0; A_Index144++) {
                            ...
                            if (InStr(A_LoopField144, " := ")) {
                                if (InStr(Trim(StrSplit(A_LoopField144, " := ", 1)), " ") != true) {
                                    str4 += "optanal-HTVM-opt-parmsNOtWorking-theirewIs-a-bug-Iusfbudfbuoeshfuisbav=-fwaegs-awedsf-dd-sfgc " + A_LoopField144 + ", ";
                                } else {
                                    str4 += A_LoopField144 + ", ";
                                }
                            }
                            ...
                            else if (InStr(A_LoopField144, " " + Trim(keyWordAssign) + " ")) {
                                if (InStr(Trim(StrSplit(A_LoopField144, " " + Trim(keyWordAssign) + " ", 1)), " ") != true) {
                                    str4 += "optanal-HTVM-opt-parmsNOtWorking-theirewIs-a-bug-Iusfbudfbuoeshfuisbav=-fwaegs-awedsf-dd-sfgc " + A_LoopField144 + ", ";
                                } else {
                                    str4 += A_LoopField144 + ", ";
                                }
                ...
                if (Trim(str1) == "") {
                    ...
                    for (size_t A_Index145 = 0; A_Index145 < items145.size() + 0; A_Index145++) {
                        ...
                        //print("|" . Trim(A_LoopField145) . "|")
                        if (InStr(Trim(A_LoopField145), " ")) {
                            // there is space aka there is a type
                            if (InStr(A_LoopField145, " " + Trim(keyWordAssign) + " ") == false) {
                                if (usePrefixTypeForTypeDefinition == "on") {
                                    // normal
                                    str6 = Trim(A_LoopField145);
                                ...
                                // optanal param
                                if (InStr(Trim(StrSplit(Trim(A_LoopField145), " " + Trim(keyWordAssign) + " ", 1)), " ")) {
                                    // there is a type
                                    if (usePrefixTypeForTypeDefinition == "on") {
                                        // normal
                                        str6 = Trim(StrSplit(Trim(A_LoopField145), " " + Trim(keyWordAssign) + " ", 1));
                                        str9 = Trim(expressionParserTranspiler(Trim(StrSplit(Trim(A_LoopField145), " " + Trim(keyWordAssign) + " ", 2))));
                                        str7 = getTheLastWord(str6);
                                        str8 = getFuncTypeConvert(Trim(StringTrimRight(str6, StrLen(Trim(str7)) + 1)));
                                        //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                        //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    // there is no type
                                    str8 = Trim(StrSplit(Trim(A_LoopField145), " " + Trim(keyWordAssign) + " ", 1));
                                    str9 = Trim(expressionParserTranspiler(Trim(StrSplit(Trim(A_LoopField145), " " + Trim(keyWordAssign) + " ", 2))));
                                    // str10
                                    // skipLeftCuleyForFuncPLS := 1
                                    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            str5 += Trim(A_LoopField145) + Chr(10);
                        }
                    }
                    //print(str5)
                    //print(str10)
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        ...
                        if (langToConvertTo == "lua") {
                            std::vector<std::string> items148 = LoopParseFunc(str12, ",");
                            for (size_t A_Index148 = 0; A_Index148 < items148.size() + 0; A_Index148++) {
                                std::string A_LoopField148 = items148[A_Index148 - 0];
                                str14 += Trim(StrSplit(Trim(A_LoopField148), " = ", 1)) + ", ";
                            }
                            str14 = StringTrimRight(str14, 2);
                            str13 += "{" + Chr(10);
                            std::vector<std::string> items149 = LoopParseFunc(str12, ",");
                            for (size_t A_Index149 = 0; A_Index149 < items149.size() + 0; A_Index149++) {
                                std::string A_LoopField149 = items149[A_Index149 - 0];
                                str13 += Trim(StrSplit(Trim(A_LoopField149), " = ", 1)) + " = " + Trim(StrSplit(Trim(A_LoopField149), " = ", 1)) + " or " + Trim(StrSplit(Trim(A_LoopField149), " = ", 2)) + Chr(10);
                            }
                            str12 = str14;
                        }
                        if (langToConvertTo == "go") {
                            ...
                            for (size_t A_Index150 = 0; A_Index150 < items150.size() + 0; A_Index150++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField150), " = ", 1)), " ", 1));
                                str17 = Trim(StrSplit(Trim(A_LoopField150), " = ", 2));
                            ...
                            for (size_t A_Index151 = 0; A_Index151 < items151.size() + 0; A_Index151++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField151), " = ", 1)), " ", 1));
                                str18 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField151), " = ", 1)), " ", 2));
                                // str16 = var name
                                // str18 = var type
                                str13 += "if len(__HTVM_V2_TO_GO_optionalParams__) " + Chr(62) + " " + STR(A_Index151) + Chr(10) + "{" + Chr(10) + str16 + " = __HTVM_V2_TO_GO_optionalParams__[" + STR(A_Index151) + "].(" + str18 + ")" + Chr(10) + "}" + Chr(10);
                            }
                            str12 = str14;
                        }
                        if (langToConvertTo == "java") {
                            ...
                            for (size_t A_Index152 = 0; A_Index152 < items152.size() + 0; A_Index152++) {
                                ...
                                str19 = Trim(A_LoopField152);
                                str20 = "";
                                std::vector<std::string> items153 = LoopParseFunc(str19, " ");
                                for (size_t A_Index153 = 0; A_Index153 < items153.size() + 0; A_Index153++) {
                                    std::string A_LoopField153 = items153[A_Index153 - 0];
                                    if (A_Index153 == 3) {
                                        if (RegExMatch(A_LoopField153, "^\\d+(\\.\\d+)?$")) {
                                            str20 += A_LoopField153 + "f ";
                                        } else {
                                            str20 += A_LoopField153 + " ";
                                        }
                                    } else {
                                        str20 += A_LoopField153 + " ";
                                    }
                            ...
                            for (size_t A_Index154 = 0; A_Index154 < items154.size() + 0; A_Index154++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField154), " = ", 1)), " ", 2));
                                str17 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField154), " = ", 1)), " ", 1));
                                // str16 = var name
                                // str17 = type name
                                str13 += "if (__HTVM_V2_TO_JAVA_optionalParams__.length " + Chr(62) + " " + STR(A_Index154) + ") " + str16 + " = (" + str17 + ") __HTVM_V2_TO_JAVA_optionalParams__[" + STR(A_Index154) + "];" + Chr(10);
                            }
                            str12 = str14;
                        }
                        str11 += str12;
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        ...
                        if (langToConvertTo == "lua") {
                            std::vector<std::string> items157 = LoopParseFunc(str11, ",");
                            for (size_t A_Index157 = 0; A_Index157 < items157.size() + 0; A_Index157++) {
                                std::string A_LoopField157 = items157[A_Index157 - 0];
                                str14 += Trim(StrSplit(Trim(A_LoopField157), " = ", 1)) + ", ";
                            }
                            str14 = StringTrimRight(str14, 2);
                            str13 += "{" + Chr(10);
                            std::vector<std::string> items158 = LoopParseFunc(str11, ",");
                            for (size_t A_Index158 = 0; A_Index158 < items158.size() + 0; A_Index158++) {
                                std::string A_LoopField158 = items158[A_Index158 - 0];
                                str13 += Trim(StrSplit(Trim(A_LoopField158), " = ", 1)) + " = " + Trim(StrSplit(Trim(A_LoopField158), " = ", 1)) + " or " + Trim(StrSplit(Trim(A_LoopField158), " = ", 2)) + Chr(10);
                            }
                            str11 = str14;
                        }
                        if (langToConvertTo == "go") {
                            ...
                            for (size_t A_Index159 = 0; A_Index159 < items159.size() + 0; A_Index159++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField159), " = ", 1)), " ", 1));
                                str17 = Trim(StrSplit(Trim(A_LoopField159), " = ", 2));
                                str13 += str16 + " := " + str17 + Chr(10);
                            }
                            ...
                            for (size_t A_Index160 = 0; A_Index160 < items160.size() + 0; A_Index160++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField160), " = ", 1)), " ", 1));
                                str18 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField160), " = ", 1)), " ", 2));
                                // str16 = var name
                                // str18 = var type
                                str13 += "if len(__HTVM_V2_TO_GO_optionalParams__) " + Chr(62) + " " + STR(A_Index160) + Chr(10) + "{" + Chr(10) + str16 + " = __HTVM_V2_TO_GO_optionalParams__[" + STR(A_Index160) + "].(" + str18 + ")" + Chr(10) + "}" + Chr(10);
                            }
                            str11 = str14;
                        }
                        if (langToConvertTo == "java") {
                            ...
                            for (size_t A_Index161 = 0; A_Index161 < items161.size() + 0; A_Index161++) {
                                ...
                                str19 = Trim(A_LoopField161);
                                str20 = "";
                                std::vector<std::string> items162 = LoopParseFunc(str19, " ");
                                for (size_t A_Index162 = 0; A_Index162 < items162.size() + 0; A_Index162++) {
                                    std::string A_LoopField162 = items162[A_Index162 - 0];
                                    if (A_Index162 == 3) {
                                        if (RegExMatch(A_LoopField162, "^\\d+(\\.\\d+)?$")) {
                                            str20 += A_LoopField162 + "f ";
                                        } else {
                                            str20 += A_LoopField162 + " ";
                                        }
                                    } else {
                                        str20 += A_LoopField162 + " ";
                                    }
                            ...
                            for (size_t A_Index163 = 0; A_Index163 < items163.size() + 0; A_Index163++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField163), " = ", 1)), " ", 2));
                                str17 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField163), " = ", 1)), " ", 1));
                                // str16 = var name
                                // str17 = type name
                                str13 += "if (__HTVM_V2_TO_JAVA_optionalParams__.length " + Chr(62) + " " + STR(A_Index163) + ") " + str16 + " = (" + str17 + ") __HTVM_V2_TO_JAVA_optionalParams__[" + STR(A_Index163) + "];" + Chr(10);
                            }
                            str11 = str14;
                        }
                    }
            ...
            else if (InStr(StrLower(A_LoopField142), " main(") && lineDone == 0) {
                lineDone = 1;
                javaMainFuncSeen = 1;
                csMainFuncSeen = 1;
                htCode += A_LoopField142 + Chr(10);
            }
            else if (InStr(A_LoopField142, " " + keyWordAssign + " ") || InStr(A_LoopField142, " " + keyWordAssignAdd + " ") || InStr(A_LoopField142, " " + keyWordAssignConcat + " ") || InStr(A_LoopField142, " " + keyWordAssignSub + " ") || InStr(A_LoopField142, " " + keyWordAssignMul + " ") || InStr(A_LoopField142, " " + keyWordAssignDiv + " ") || InStr(A_LoopField142, " " + keyWordAssignMod + " ") || InStr(A_LoopField142, " " + keyWordAssignShiftLeft + " ") || InStr(A_LoopField142, " " + keyWordAssignShiftRight + " ") || InStr(A_LoopField142, " " + keyWordLogicalAssignShiftRight + " ") || InStr(A_LoopField142, " " + keyWordAssignBitAnd + " ") || InStr(A_LoopField142, " " + keyWordAssignBitOr + " ") || InStr(A_LoopField142, " " + keyWordAssignBitXor + " ") && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                //keyWordAssign
                //keyWordAssignAdd
                //keyWordAssignConcat
                ...
                //allVarsSoWeDontReDecVars_FIX_int64
                //allVarsSoWeDontReDecVars_FIX_float
                if (InStr(A_LoopField142, " " + keyWordAssign + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssign + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssign + " ", 2);
                    str10 = keyWordAssign;
                    str11 = keyWordAssign_2;
                    if (langToConvertTo == "ahk") {
                        str12 = ":=";
                ...
                else if (InStr(A_LoopField142, " " + keyWordAssignAdd + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignAdd + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignAdd + " ", 2);
                    str10 = keyWordAssignAdd;
                    str11 = keyWordAssignAdd_2;
                    str12 = "+=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignConcat + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignConcat + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignConcat + " ", 2);
                    str10 = keyWordAssignConcat;
                    str11 = keyWordAssignConcat_2;
                    if (langToConvertTo == "ahk") {
                        str12 = ".=";
                ...
                else if (InStr(A_LoopField142, " " + keyWordAssignSub + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignSub + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignSub + " ", 2);
                    str10 = keyWordAssignSub;
                    str11 = keyWordAssignSub_2;
                    str12 = "-=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignMul + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignMul + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignMul + " ", 2);
                    str10 = keyWordAssignMul;
                    str11 = keyWordAssignMul_2;
                    str12 = "*=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignDiv + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignDiv + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignDiv + " ", 2);
                    str10 = keyWordAssignDiv;
                    str11 = keyWordAssignDiv_2;
                    str12 = "/=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignMod + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignMod + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignMod + " ", 2);
                    str10 = keyWordAssignMod;
                    str11 = keyWordAssignMod_2;
                    str12 = "%=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignShiftLeft + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignShiftLeft + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignShiftLeft + " ", 2);
                    str10 = keyWordAssignShiftLeft;
                    str11 = keyWordAssignShiftLeft_2;
                    str12 = "<<=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignShiftRight + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignShiftRight + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignShiftRight + " ", 2);
                    str10 = keyWordAssignShiftRight;
                    str11 = keyWordAssignShiftRight_2;
                    str12 = ">>=";
                }
                else if (InStr(A_LoopField142, " " + keyWordLogicalAssignShiftRight + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordLogicalAssignShiftRight + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordLogicalAssignShiftRight + " ", 2);
                    str10 = keyWordLogicalAssignShiftRight;
                    str11 = keyWordLogicalAssignShiftRight_2;
                    str12 = ">>>=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignBitAnd + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignBitAnd + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignBitAnd + " ", 2);
                    str10 = keyWordAssignBitAnd;
                    str11 = keyWordAssignBitAnd_2;
                    str12 = "&=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignBitOr + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignBitOr + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignBitOr + " ", 2);
                    str10 = keyWordAssignBitOr;
                    str11 = keyWordAssignBitOr_2;
                    str12 = "|=";
                }
                else if (InStr(A_LoopField142, " " + keyWordAssignBitXor + " ")) {
                    str1 = StrSplit(A_LoopField142, " " + keyWordAssignBitXor + " ", 1);
                    str6 = StrSplit(A_LoopField142, " " + keyWordAssignBitXor + " ", 2);
                    str10 = keyWordAssignBitXor;
                    str11 = keyWordAssignBitXor_2;
                    str12 = "^=";
                }
                ...
                if (InStr(ALoopField, " ") == false || SubStrLastChars(ALoopField, 1) == "]") {
                    ...
                    if (usePostfixTypeForTypeDefinition == "off") {
                        lineDone = 1;
                        str1 = Trim(StringTrimLeft(Trim(str1), StrLen(keyWordConst)));
                        std::vector<std::string> items164 = LoopParseFunc(str1, " ");
                    ...
                    if (usePostfixTypeForTypeDefinition == "off") {
                        str1 = Trim(StringTrimLeft(Trim(str1), StrLen(keyWordVar)));
                        std::vector<std::string> items165 = LoopParseFunc(str1, " ");
            ...
            else if (SubStr(Trim(A_LoopField142), 1, StrLen(keyWordVar)) == keyWordVar && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                if (usePostfixTypeForTypeDefinition == "off") {
                    lineDone = 1;
                    str1 = Trim(StringTrimLeft(Trim(A_LoopField142), StrLen(keyWordVar)));
                    if (SubStrLastChars(str1, 1) == ";") {
                        str1 = StringTrimRight(str1, 1);
                    }
            ...
            else if (SubStr(Trim(A_LoopField142), 1, StrLen(keyWordLet)) == keyWordLet && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                if (usePostfixTypeForTypeDefinition == "off") {
                    lineDone = 1;
                    str1 = Trim(StringTrimLeft(Trim(A_LoopField142), StrLen(keyWordLet)));
                    if (SubStrLastChars(str1, 1) == ";") {
                        str1 = StringTrimRight(str1, 1);
                    }
            ...
            else if (SubStr(Trim(A_LoopField142), 1, StrLen(keyWordDouble + " ")) == keyWordDouble + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordChar + " ")) == keyWordChar + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordUint8 + " ")) == keyWordUint8 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordUint16 + " ")) == keyWordUint16 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordUint32 + " ")) == keyWordUint32 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordUint64 + " ")) == keyWordUint64 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordINT + " ")) == keyWordINT + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordSTR + " ")) == keyWordSTR + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordBOOL + " ")) == keyWordBOOL + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordFLOAT + " ")) == keyWordFLOAT + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordINT8 + " ")) == keyWordINT8 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordINT16 + " ")) == keyWordINT16 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordINT32 + " ")) == keyWordINT32 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordINT64 + " ")) == keyWordINT64 + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordArrayDefinition + " ")) == keyWordArrayDefinition + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordArrayOfIntegersDefinition + " ")) == keyWordArrayOfIntegersDefinition + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordArrayOfStringsDefinition + " ")) == keyWordArrayOfStringsDefinition + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordArrayOfFloatingPointNumbersDefinition + " ")) == keyWordArrayOfFloatingPointNumbersDefinition + " " || SubStr(Trim(A_LoopField142), 1, StrLen(keyWordArrayOfBooleansDefinition + " ")) == keyWordArrayOfBooleansDefinition + " " && usePrefixTypeForTypeDefinition == "on" && lineDone == 0) {
                lineDone = 1;
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                str1 = Trim(A_LoopField142);
                if (SubStrLastChars(str1, 1) == ";") {
            ...
            else if (RegExMatch(Trim(A_LoopField142), "^[a-zA-Z_][a-zA-Z0-9_]*: [^:]*;?$") && usePostfixTypeForTypeDefinition == "on" && lineDone == 0) {
                lineDone = 1;
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                str1 = Trim(A_LoopField142);
                if (SubStrLastChars(str1, 1) == ";") {
            ...
            else if (RegExMatch(Trim(A_LoopField142), "^[a-zA-Z0-9_\\.]+\\(") && !(InStr(StrLower(A_LoopField142), " main(")) && lineDone == 0) {
                lineDone = 1;
                str1 = Trim(A_LoopField142);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
            ...
            else if (RegExMatch(A_LoopField142, "\\.[a-zA-Z_][a-zA-Z0-9_]*") && lineDone == 0) {
                lineDone = 1;
                str1 = Trim(A_LoopField142);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
            ...
            else if (KeyWordsCommands(A_LoopField142, "check", commands, langToConvertTo) == "true" && lineDone == 0) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += A_LoopField142 + Chr(10);
                } else {
                    out_KeyWordsCommands = KeyWordsCommands(A_LoopField142, "transpile", commands, langToConvertTo);
                    htCode += out_KeyWordsCommands + Chr(10);
                }
            } else {
                //print("else else else " . A_LoopField142)
                // this is THE else
                //;;;;;;;;;;;;;;;;;;
                if (lineDone != 1) {
                    if (skipLeftCuleyForFuncPLS != 1) {
                        if (SubStr(Trim(StrLower(A_LoopField142)), 1, 1) == Chr(125)) {
                            htCode += Chr(125) + Chr(10);
                        } else {
                            if (htCodeAcurlyBraceAddSomeVrasFixLP == 1 && SubStr(Trim(StrLower(A_LoopField142)), 1, 1) == Chr(123)) {
                                htCodeAcurlyBraceAddSomeVrasFixLP = 0;
                                htCode += A_LoopField142 + Chr(10) + theFixTextLoopLP + Chr(10);
                            } else {
                                if (htCodeAcurlyBraceAddSomeVrasFixNL == 1 && SubStr(Trim(StrLower(A_LoopField142)), 1, 1) == Chr(123)) {
                                    htCodeAcurlyBraceAddSomeVrasFixNL = 0;
                                    htCode += A_LoopField142 + Chr(10) + theFixTextLoopNL + Chr(10);
                                } else {
                                    htCode += A_LoopField142 + Chr(10);
                                }
                            }
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                std::vector<std::string> items171 = LoopParseFunc(htCodeLoopfixa, "\n", "\r");
                for (size_t A_Index171 = 0; A_Index171 < items171.size() + 0; A_Index171++) {
                    std::string A_LoopField171 = items171[A_Index171 - 0];
                    sstr123 = A_LoopField171;
                    fixLoopLokingFor = A_LoopField171;
                    ...
                    if (out1 == "nl") {
                        ...
                        for (size_t A_Index172 = 0; A_Index172 < items172.size() + 0; A_Index172++) {
                            ...
                            //MsgBox, |%A_LoopField172%|`n|%fixLoopLokingFor%|
                            if (InStr(A_LoopField172, fixLoopLokingFor) && insdeAnestedLoopBAD != 1) {
                                fixLoopLokingForNum = 1;
                                //MsgBox, do we came here 1
                            }
                            if (SubStr(Trim(A_LoopField172), 1, 4) == "for " && weAreDoneHereCurly != 1 && insdeAnestedLoopBAD != 1 && fixLoopLokingForNum == 1) {
                                s = StrSplit(A_LoopField172 ,"" + keyWordAIndex + "", 2);
                                out1z = s;
                                s = StrSplit(out1z, " ", 1);
                                out1z = Trim(s);
                                //MsgBox, % out1z
                                ...
                                foundTheTopLoop++;
                                inTarget = 1;
                                //MsgBox, % A_LoopField172
                                dontSaveStr = 1;
                                ALoopField = A_LoopField172;
                                DeleayOneCuzOfLoopParse = 1;
                                out4758686d86d86d86578991a += ALoopField + Chr(10);
                            }
                            if (inTarget == 1 && InStr(A_LoopField172, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                insideBracket = 1;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField172, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly++;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField172, Chr(125)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly--;
                                readyToEnd = 1;
                            }
                            if (SubStr(Trim(A_LoopField172), 1, 4) == "for " && insdeAnestedLoopBAD != 1 && foundTheTopLoop >= 2) {
                            ...
                            if (insdeAnestedLoopBAD == 1) {
                                if (InStr(A_LoopField172, Chr(123))) {
                                    insideBracket1 = 1;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField172, Chr(123))) {
                                    netsedCurly1++;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField172, Chr(125))) {
                                    netsedCurly1--;
                                    readyToEnd1 = 1;
                                }
                                if (InStr(A_LoopField172, Chr(125)) && readyToEnd1 == 1 && netsedCurly1 == 0 && insideBracket == 1) {
                                    //MsgBox, % A_LoopField172
                                    eldLoopNestedBADlol = 1;
                                }
                                out4758686d86d86d86578991a += A_LoopField172 + Chr(10);
                            }
                            ...
                            if (inTarget == 1 && InStr(A_LoopField172, Chr(125)) && readyToEnd == 1 && netsedCurly == 0 && weAreDoneHereCurly == 0 && dontSaveStr != 1 && insdeAnestedLoopBAD != 1) {
                                //MsgBox, % A_LoopField172
                        ...
                        for (size_t A_Index173 = 0; A_Index173 < items173.size() + 0; A_Index173++) {
                            ...
                            if (InStr(A_LoopField173 , fixLoopLokingFor) && insdeAnestedLoopBAD != 1) {
                                fixLoopLokingForNum = 1;
                                //MsgBox, do we came here 3
                            }
                            if (SubStr(Trim(A_LoopField173), 1, 4) == "for " && weAreDoneHereCurly != 1 && insdeAnestedLoopBAD != 1 && fixLoopLokingForNum == 1) {
                                s = StrSplit(A_LoopField173 ,"" + keyWordAIndex + "", 2);
                                out1z = s;
                                s = StrSplit(out1z, " ", 1);
                                ...
                                foundTheTopLoop++;
                                inTarget = 1;
                                //MsgBox, % A_LoopField173
                                dontSaveStr = 1;
                                ALoopField = A_LoopField173;
                                DeleayOneCuzOfLoopParse = 1;
                                out4758686d86d86d86578991a += ALoopField + Chr(10);
                            }
                            if (inTarget == 1 && InStr(A_LoopField173, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                insideBracket = 1;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField173, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly++;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField173, Chr(125)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly--;
                                readyToEnd = 1;
                            }
                            if (SubStr(Trim(A_LoopField173), 1, 4) == "for " && insdeAnestedLoopBAD != 1 && foundTheTopLoop >= 2) {
                                insdeAnestedLoopBAD = 1;
                                insideBracket1 = 0;
                                netsedCurly1 = 0;
                            }
                            ...
                            if (insdeAnestedLoopBAD == 1) {
                                if (InStr(A_LoopField173, Chr(123))) {
                                    insideBracket1 = 1;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField173, Chr(123))) {
                                    netsedCurly1++;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField173, Chr(125))) {
                                    netsedCurly1--;
                                    readyToEnd1 = 1;
                                }
                                if (InStr(A_LoopField173, Chr(125)) && readyToEnd1 == 1 && netsedCurly1 == 0 && insideBracket == 1) {
                                    //MsgBox, % A_LoopField173
                                    eldLoopNestedBADlol = 1;
                                }
                                out4758686d86d86d86578991a += A_LoopField173 + Chr(10);
                            }
                            if (inTarget == 1 && dontSaveStr != 1 && fixLoopLokingForNum != 1 && insdeAnestedLoopBAD != 1) {
                                ALoopField = A_LoopField173;
                                // Replace "A_Index" with or without a following digit with "A_Index" + out1z
                            ...
                            if ((inTarget == 1 && InStr(A_LoopField173, Chr(125)) && readyToEnd == 1 && netsedCurly == 0 && weAreDoneHereCurly == 0 && dontSaveStr != 1 && insdeAnestedLoopBAD != 1)) {
                                //MsgBox, % A_LoopField173
                                weAreDoneHereCurly = 1;
                                inTarget = 0;
                                endBracketDOntPutThere = 1;
                ...
                for (size_t A_Index174 = 0; A_Index174 < items174.size() + 0; A_Index174++) {
                    ...
                    ignore = 0;
                    if (SubStr(Trim(A_LoopField174), 1, 4) == "for ") {
                        if (hold == 1 && holdText == A_LoopField174) {
                            ignore = 1;
                        } else {
                            holdText = A_LoopField174;
                            hold = 1;
                        }
                    }
                    if (!ignore) {
                        out4758686d86dgt8r754444444 += A_LoopField174 + Chr(10);
                    }
                }
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (int A_Index176 = 0; A_Index176 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index176++) {
            ADD_ALL_programmingBlock_HTVMsyntax += programmingBlock_HTVMsyntax[A_Index176] + Chr(10);
        }
        ...
        isNotHTVMfile2 = 1;
        for (int A_Index177 = 0; A_Index177 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index177++) {
            htCode = StrReplace(htCode, "programmingBlock_HTVMsyntax-programmingBlock_HTVMsyntax-AA" + STR(A_Index177 + 1) + "AA", compiler(programmingBlock_HTVMsyntax[A_Index177], allInstructionFile, "full", langToConvertToParam));
        }
        isNotHTVMfile2 = 0;
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (langToConvertTo == langFileExtension_2) {
        ...
        if (useEnd_2 == "on") {
            ...
            for (size_t A_Index178 = 0; A_Index178 < items178.size() + 0; A_Index178++) {
                ...
                if (Trim(A_LoopField178) == keyWordCurlyBraceClose_2) {
                    fixLuaAndRuby += StrReplace(A_LoopField178, keyWordCurlyBraceClose_2, Trim(keyWordEnd_2)) + Chr(10);
                }
                else if (SubStrLastChars(A_LoopField178, 2) == " " + keyWordCurlyBraceOpen_2) {
                    fixLuaAndRuby += StringTrimRight(A_LoopField178, 2) + Chr(10);
                } else {
                    fixLuaAndRuby += A_LoopField178 + Chr(10);
                }
            }
        ...
        if (langToConvertTo == "lua" || langToConvertTo == "rb" || langToConvertTo == langFileExtension_2) {
            if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
                ...
                for (size_t A_Index179 = 0; A_Index179 < items179.size() + 0; A_Index179++) {
                    ...
                    if (Trim(A_LoopField179) == "}") {
                        fixLuaAndRuby += StrReplace(A_LoopField179, "}", fixLuaAndRubyHELP) + Chr(10);
                    }
                    else if (SubStrLastChars(A_LoopField179, 2) == " {") {
                        fixLuaAndRuby += StringTrimRight(A_LoopField179, 2) + Chr(10);
                    } else {
                        fixLuaAndRuby += A_LoopField179 + Chr(10);
                    }
                }
                htCode = StringTrimRight(fixLuaAndRuby, 1);
            } else {
                ...
                for (size_t A_Index180 = 0; A_Index180 < items180.size() + 0; A_Index180++) {
                    ...
                    if (Trim(A_LoopField180) == "}") {
                        fixLuaAndRuby += StrReplace(A_LoopField180, "}", fixLuaAndRubyHELP) + Chr(10);
                    }
                    else if (SubStrLastChars(A_LoopField180, 2) == " {") {
    ...
    if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
        ...
        for (size_t A_Index181 = 0; A_Index181 < items181.size() + 0; A_Index181++) {
            ...
            HTVM_Append(nextWordEndFix, A_LoopField181);
        }
        ...
        for (size_t A_Index182 = 0; A_Index182 < items182.size() + 0; A_Index182++) {
            ...
            if (Trim(A_LoopField182) == Trim(keyWordEnd_2) && SubStr(Trim(nextWordEndFix[A_Index182 + 1]), 1, StrLen(Trim(keyWordElseIf_2) + " ")) == Trim(keyWordElseIf_2) + " " || Trim(A_LoopField182) == Trim(keyWordEnd_2) && (Trim(nextWordEndFix[A_Index182 + 1]) == Trim(keyWordElse_2) || Trim(nextWordEndFix[A_Index182 + 1]) == Trim(keyWordElse_2 + ":"))) {
                nextWordEndFixOut += "";
            } else {
                nextWordEndFixOut += A_LoopField182 + Chr(10);
            }
        }
    ...
    if (langToConvertTo == "lua") {
        ...
        for (size_t A_Index184 = 0; A_Index184 < items184.size() + 0; A_Index184++) {
            ...
            if (Trim(A_LoopField184) == "end" && SubStr(Trim(nextWordEndFix[A_Index184 + 1]), 1, StrLen("elseif ")) == "elseif " || Trim(A_LoopField184) == "end" && Trim(nextWordEndFix[A_Index184 + 1]) == "else") {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "rb") {
        ...
        for (size_t A_Index186 = 0; A_Index186 < items186.size() + 0; A_Index186++) {
            ...
            if (Trim(A_LoopField186) == "end" && SubStr(Trim(nextWordEndFix[A_Index186 + 1]), 1, StrLen("elsif ")) == "elsif " || Trim(A_LoopField186) == "end" && Trim(nextWordEndFix[A_Index186 + 1]) == "else") {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "rb") {
        ...
        for (size_t A_Index187 = 0; A_Index187 < items187.size() + 0; A_Index187++) {
            ...
            HTVM_Append(nextWordEndFixRB, A_LoopField187);
        }
        ...
        for (size_t A_Index188 = 0; A_Index188 < items188.size() + 0; A_Index188++) {
            ...
            if (Trim(A_LoopField188) == "end" && SubStr(Trim(nextWordEndFixRB[A_Index188 + 1]), 1, StrLen("rescue ")) == "rescue " || Trim(A_LoopField188) == "end" && Trim(nextWordEndFixRB[A_Index188 + 1]) == "ensure") {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
        ...
        for (size_t A_Index190 = 0; A_Index190 < items190.size() + 0; A_Index190++) {
            ...
            if (Trim(A_LoopField190) == Trim(keyWordEnd_2) && SubStr(Trim(nextWordEndFixRB[A_Index190 + 1]), 1, StrLen(Trim(keyWordCatch_2) + " ")) == Trim(keyWordCatch_2) + " " || Trim(A_LoopField190) == Trim(keyWordEnd_2) && Trim(nextWordEndFixRB[A_Index190 + 1]) == Trim(keyWordFinally_2) || Trim(nextWordEndFixRB[A_Index190 + 1]) == Trim(keyWordFinally_2 + ":")) {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "ahk") {
        ...
        for (size_t A_Index191 = 0; A_Index191 < items191.size() + 0; A_Index191++) {
            ...
            if (SubStr(Trim(A_LoopField191), 1, StrLen("Loop, Parse, ")) == "Loop, Parse, ") {
                nextWordEndFixOut += StrReplace(A_LoopField191, "{", Chr(10) + "{" + Chr(10)) + Chr(10);
            } else {
    ...
    if (langToConvertTo == "go") {
        ...
        for (size_t A_Index192 = 0; A_Index192 < items192.size() + 0; A_Index192++) {
            ...
            HTVM_Append(fixGoManGoIsSoAnnoyingBroooFurure, A_LoopField192);
        }
        ...
        for (size_t A_Index193 = 0; A_Index193 < items193.size() + 0; A_Index193++) {
            ...
            if (Trim(A_LoopField193) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index193 + 1]), 1, StrLen("else if ")) == "else if ") {
                fixGoManGoIsSoAnnoyingBroooSkip = 1;
                fixGoManGoIsSoAnnoyingBroooCount = 0;
                std::vector<std::string> items194 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index193 + 1]);
                ...
                for (int A_Index195 = 0; A_Index195 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index195++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
                fixGoManGoIsSoAnnoyingBrooo += fixGoManGoIsSoAnnoyingBroooCountSpaceses + "} " + Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index193 + 1]) + Chr(10);
            } else {
                if (fixGoManGoIsSoAnnoyingBroooSkip == 0) {
                    fixGoManGoIsSoAnnoyingBrooo += A_LoopField193 + Chr(10);
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (int A_Index196 = 0; A_Index196 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index196++) {
            htCode = StrReplace(htCode, "programmingBlock_InTheTranspiledLang-programmingBlock_InTheTranspiledLang-AA" + STR(A_Index196 + 1) + "AA", programmingBlock_InTheTranspiledLang[A_Index196]);
        }
    }
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (int A_Index197 = 0; A_Index197 < COUNT_programmingBlock_CPP + 0; A_Index197++) {
                htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index197 + 1) + "AA", programmingBlock_CPP[A_Index197]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CPP != 0) {
            for (int A_Index198 = 0; A_Index198 < COUNT_programmingBlock_CPP + 0; A_Index198++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index198 + 1) + "AA", keyWordCodeInTheTranspiledLangStartCPP_2 + Chr(10) + programmingBlock_CPP[A_Index198] + Chr(10) + keyWordCodeInTheTranspiledLangEndCPP_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index198 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (int A_Index199 = 0; A_Index199 < COUNT_programmingBlock_PY + 0; A_Index199++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index199 + 1) + "AA", programmingBlock_PY[A_Index199]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (int A_Index200 = 0; A_Index200 < COUNT_programmingBlock_PY + 0; A_Index200++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index200 + 1) + "AA", keyWordCodeInTheTranspiledLangStartPY_2 + Chr(10) + programmingBlock_PY[A_Index200] + Chr(10) + keyWordCodeInTheTranspiledLangEndPY_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index200 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (int A_Index201 = 0; A_Index201 < COUNT_programmingBlock_JS + 0; A_Index201++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index201 + 1) + "AA", programmingBlock_JS[A_Index201]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (int A_Index202 = 0; A_Index202 < COUNT_programmingBlock_JS + 0; A_Index202++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index202 + 1) + "AA", keyWordCodeInTheTranspiledLangStartJS_2 + Chr(10) + programmingBlock_JS[A_Index202] + Chr(10) + keyWordCodeInTheTranspiledLangEndJS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index202 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (int A_Index203 = 0; A_Index203 < COUNT_programmingBlock_GO + 0; A_Index203++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index203 + 1) + "AA", programmingBlock_GO[A_Index203]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (int A_Index204 = 0; A_Index204 < COUNT_programmingBlock_GO + 0; A_Index204++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index204 + 1) + "AA", keyWordCodeInTheTranspiledLangStartGO_2 + Chr(10) + programmingBlock_GO[A_Index204] + Chr(10) + keyWordCodeInTheTranspiledLangEndGO_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index204 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (int A_Index205 = 0; A_Index205 < COUNT_programmingBlock_LUA + 0; A_Index205++) {
                htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index205 + 1) + "AA", programmingBlock_LUA[A_Index205]);
            }
        }
    } else {
        if (COUNT_programmingBlock_LUA != 0) {
            for (int A_Index206 = 0; A_Index206 < COUNT_programmingBlock_LUA + 0; A_Index206++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index206 + 1) + "AA", keyWordCodeInTheTranspiledLangStartLUA_2 + Chr(10) + programmingBlock_LUA[A_Index206] + Chr(10) + keyWordCodeInTheTranspiledLangEndLUA_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index206 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (int A_Index207 = 0; A_Index207 < COUNT_programmingBlock_CS + 0; A_Index207++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index207 + 1) + "AA", programmingBlock_CS[A_Index207]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (int A_Index208 = 0; A_Index208 < COUNT_programmingBlock_CS + 0; A_Index208++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index208 + 1) + "AA", keyWordCodeInTheTranspiledLangStartCS_2 + Chr(10) + programmingBlock_CS[A_Index208] + Chr(10) + keyWordCodeInTheTranspiledLangEndCS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index208 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (int A_Index209 = 0; A_Index209 < COUNT_programmingBlock_JAVA + 0; A_Index209++) {
                htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index209 + 1) + "AA", programmingBlock_JAVA[A_Index209]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (int A_Index210 = 0; A_Index210 < COUNT_programmingBlock_JAVA + 0; A_Index210++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index210 + 1) + "AA", keyWordCodeInTheTranspiledLangStartJAVA_2 + Chr(10) + programmingBlock_JAVA[A_Index210] + Chr(10) + keyWordCodeInTheTranspiledLangEndJAVA_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index210 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (int A_Index211 = 0; A_Index211 < COUNT_programmingBlock_KT + 0; A_Index211++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index211 + 1) + "AA", programmingBlock_KT[A_Index211]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (int A_Index212 = 0; A_Index212 < COUNT_programmingBlock_KT + 0; A_Index212++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index212 + 1) + "AA", keyWordCodeInTheTranspiledLangStartKT_2 + Chr(10) + programmingBlock_KT[A_Index212] + Chr(10) + keyWordCodeInTheTranspiledLangEndKT_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index212 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (int A_Index213 = 0; A_Index213 < COUNT_programmingBlock_RB + 0; A_Index213++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index213 + 1) + "AA", programmingBlock_RB[A_Index213]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (int A_Index214 = 0; A_Index214 < COUNT_programmingBlock_RB + 0; A_Index214++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index214 + 1) + "AA", keyWordCodeInTheTranspiledLangStartRB_2 + Chr(10) + programmingBlock_RB[A_Index214] + Chr(10) + keyWordCodeInTheTranspiledLangEndRB_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index214 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (int A_Index215 = 0; A_Index215 < COUNT_programmingBlock_NIM + 0; A_Index215++) {
                htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index215 + 1) + "AA", programmingBlock_NIM[A_Index215]);
            }
        }
    } else {
        if (COUNT_programmingBlock_NIM != 0) {
            for (int A_Index216 = 0; A_Index216 < COUNT_programmingBlock_NIM + 0; A_Index216++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index216 + 1) + "AA", keyWordCodeInTheTranspiledLangStartNIM_2 + Chr(10) + programmingBlock_NIM[A_Index216] + Chr(10) + keyWordCodeInTheTranspiledLangEndNIM_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index216 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (int A_Index217 = 0; A_Index217 < COUNT_programmingBlock_AHK + 0; A_Index217++) {
                htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index217 + 1) + "AA", programmingBlock_AHK[A_Index217]);
            }
        }
    } else {
        if (COUNT_programmingBlock_AHK != 0) {
            for (int A_Index218 = 0; A_Index218 < COUNT_programmingBlock_AHK + 0; A_Index218++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index218 + 1) + "AA", keyWordCodeInTheTranspiledLangStartAHK_2 + Chr(10) + programmingBlock_AHK[A_Index218] + Chr(10) + keyWordCodeInTheTranspiledLangEndAHK_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index218 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (int A_Index219 = 0; A_Index219 < COUNT_programmingBlock_SWIFT + 0; A_Index219++) {
                htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index219 + 1) + "AA", programmingBlock_SWIFT[A_Index219]);
            }
        }
    } else {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (int A_Index220 = 0; A_Index220 < COUNT_programmingBlock_SWIFT + 0; A_Index220++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index220 + 1) + "AA", keyWordCodeInTheTranspiledLangStartSWIFT_2 + Chr(10) + programmingBlock_SWIFT[A_Index220] + Chr(10) + keyWordCodeInTheTranspiledLangEndSWIFT_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index220 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (int A_Index221 = 0; A_Index221 < COUNT_programmingBlock_DART + 0; A_Index221++) {
                htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index221 + 1) + "AA", programmingBlock_DART[A_Index221]);
            }
        }
    } else {
        if (COUNT_programmingBlock_DART != 0) {
            for (int A_Index222 = 0; A_Index222 < COUNT_programmingBlock_DART + 0; A_Index222++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index222 + 1) + "AA", keyWordCodeInTheTranspiledLangStartDART_2 + Chr(10) + programmingBlock_DART[A_Index222] + Chr(10) + keyWordCodeInTheTranspiledLangEndDART_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index222 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (int A_Index223 = 0; A_Index223 < COUNT_programmingBlock_TS + 0; A_Index223++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index223 + 1) + "AA", programmingBlock_TS[A_Index223]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (int A_Index224 = 0; A_Index224 < COUNT_programmingBlock_TS + 0; A_Index224++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index224 + 1) + "AA", keyWordCodeInTheTranspiledLangStartTS_2 + Chr(10) + programmingBlock_TS[A_Index224] + Chr(10) + keyWordCodeInTheTranspiledLangEndTS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index224 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (int A_Index225 = 0; A_Index225 < COUNT_programmingBlock_GROOVY + 0; A_Index225++) {
                htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index225 + 1) + "AA", programmingBlock_GROOVY[A_Index225]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (int A_Index226 = 0; A_Index226 < COUNT_programmingBlock_GROOVY + 0; A_Index226++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index226 + 1) + "AA", keyWordCodeInTheTranspiledLangStartGROOVY_2 + Chr(10) + programmingBlock_GROOVY[A_Index226] + Chr(10) + keyWordCodeInTheTranspiledLangEndGROOVY_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index226 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (int A_Index227 = 0; A_Index227 < COUNT_programmingBlock_HTVM + 0; A_Index227++) {
                htCode = StrReplace(htCode, "programmingBlock_HTVM-programmingBlock_HTVM-AA" + STR(A_Index227 + 1) + "AA", programmingBlock_HTVM[A_Index227]);
            }
        }
    } else {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (int A_Index228 = 0; A_Index228 < COUNT_programmingBlock_HTVM + 0; A_Index228++) {
                htCode = StrReplace(htCode, "programmingBlock_HTVM-programmingBlock_HTVM-AA" + STR(A_Index228 + 1) + "AA", Chr(10));
            }
        }
    }
    ...
    for (size_t A_Index229 = 0; A_Index229 < items229.size() + 0; A_Index229++) {
        ...
        if (areWeInAFuncFromInstructions == 1) {
            if (areWeInAFuncFromInstructionsLineNum == 1) {
                // name of the func
                funcLangHolder = StringTrimLeft(A_LoopField229, 5);
            ...
            if (areWeInAFuncFromInstructionsLineNum == 2) {
                // name of the func
                funcNameHolder = StringTrimLeft(A_LoopField229, 5);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
            ...
            if (areWeInAFuncFromInstructionsLineNum == 3) {
                // all libs
                funcLibsHolder = StringTrimLeft(A_LoopField229, 5);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
            ...
            if (areWeInAFuncFromInstructionsLineNum == 4) {
                // func description
                funcDescriptionHolder = StringTrimLeft(A_LoopField229, 12);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
            ...
            if (areWeInAFuncFromInstructionsLineNum >= 5) {
                // the full func
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
                    funcFuncHolder += A_LoopField229 + Chr(10);
                }
            }
            //MsgBox, % A_LoopField229
            areWeInAFuncFromInstructionsLineNum++;
        }
        if (Trim(A_LoopField229) == "func======================func==============") {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (int A_Index230 = 0; A_Index230 < HTVM_Size(allFuncNames) + 0; A_Index230++) {
            if (InStr(htCode, allFuncNames[A_Index230]) + "(") {
                //MsgBox, % allFuncNames[A_Index230]
                allFuncsToPutAtTop += allFuncs[A_Index230] + Chr(10);
                if (Trim(allFuncLibs[A_Index230]) != "null") {
                    allLibsToPutAtTop += allFuncLibs[A_Index230] + "|";
                }
            }
        }
        allLibsToPutAtTop = StringTrimRight(allLibsToPutAtTop, 1);
        std::string allLibsToPutAtTopTEMP = "";
        std::vector<std::string> items231 = LoopParseFunc(allLibsToPutAtTop, "|");
        for (size_t A_Index231 = 0; A_Index231 < items231.size() + 0; A_Index231++) {
            std::string A_LoopField231 = items231[A_Index231 - 0];
            allLibsToPutAtTopTEMP += A_LoopField231 + Chr(10);
        }
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (int A_Index232 = 0; A_Index232 < HTVM_Size(ospDic1) + 0; A_Index232++) {
            str00 = ospDic1[A_Index232];
            if (langToConvertTo == "rb") {
    ...
    if (size_ospDic != 0) {
        for (int A_Index233 = 0; A_Index233 < size_ospDic + 0; A_Index233++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (int A_Index234 = 0; A_Index234 < size_ospDic1 + 0; A_Index234++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (int A_Index235 = 0; A_Index235 < size_ospDic2 + 0; A_Index235++) {
            HTVM_Pop(ospDic2);
        }
    }
    availableFuncsInHTVMInHTVM = "";
    ...
    for (int A_Index236 = 0; A_Index236 < theIdNumOfThe34 + 0; A_Index236++) {
        if (theIdNumOfThe34 == A_Index236 + 1) {
            if (langToConvertTo == langFileExtension_2) {
                if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index236 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(theIdNumOfThe34theVar[A_Index236 + 1], "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                } else {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index236 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index236 + 1], keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                }
            } else {
                htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index236 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index236 + 1], keyWordEscpaeChar, "\\") + Chr(34));
            }
        } else {
            if (langToConvertTo == langFileExtension_2) {
                if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index236 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(theIdNumOfThe34theVar[A_Index236 + 1], "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2));
                } else {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index236 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index236 + 1], keyWordEscpaeChar, keyWordEscpaeChar_2));
                }
            } else {
                htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index236 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index236 + 1], keyWordEscpaeChar, "\\"));
            }
        }
    }
    if (langToConvertTo == langFileExtension_2) {
...
void HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        std::vector<std::string> items238 = LoopParseFunc(allArgs, "\n", "\r");
        for (size_t A_Index238 = 0; A_Index238 < items238.size() + 0; A_Index238++) {
            std::string A_LoopField238 = items238[A_Index238 - 0];
            if (A_Index238 == 0) {
                numOfParams++;
                argCODE = FileRead(Trim(A_LoopField238));
                argCODEfile = Trim(A_LoopField238);
            }
            else if (A_Index238 == 1) {
                numOfParams++;
                argHTVMinstr = Trim(A_LoopField238);
            }
            else if (A_Index238 == 2) {
                numOfParams++;
                argLangTo = Trim(A_LoopField238);
            } else {
                numOfParams++;
                HTVM_Append(argHTVMinstrMORE, Trim(A_LoopField238));
            }
        }
        //print("===============123431234===========start=====")
        for (int A_Index239 = 0; A_Index239 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index239++) {
            //print(argHTVMinstrMORE[A_Index239])
        }
        //print("===============123431234==========end======")
