...
std::vector<std::string> slidingWinFixCommentsRmFUNC(std::string line) {
    ...
    for (size_t A_Index100 = 0; A_Index100 < items100.size() + 0; A_Index100++) {
        ...
        HTVM_Append(slidingWinFixCommentsRmFFFF, A_LoopField100);
    }
    for (int A_Index101 = 0; A_Index101 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index101++) {
...
std::string compiler(std::string htCode, std::string allInstructionFile, std::string mode, std::string langToConvertToParam = "") {
    ...
    std::vector<std::string> items102 = LoopParseFunc(allInstructionFile, "\n", "\r");
    for (size_t A_Index102 = 0; A_Index102 < items102.size() + 0; A_Index102++) {
        std::string A_LoopField102 = items102[A_Index102 - 0];
        if (A_Index102 == 0) {
            langToConvertTo = Trim(A_LoopField102);
        }
        if (A_Index102 == 1) {
            langFileExtension = Trim(A_LoopField102);
        }
        if (A_Index102 == 2) {
            commands = Trim(A_LoopField102);
        }
        if (A_Index102 == 3) {
            keyWordAlliance = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 4) {
            keyWordCrew = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 5) {
            keyWordMethod = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 6) {
            keyWordDefObj = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 7) {
            keyWordProp = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 8) {
            keyWordThis = Trim(A_LoopField102);
        }
        if (A_Index102 == 9) {
            keyWordInclude = Trim(A_LoopField102);
        }
        if (A_Index102 == 10) {
            keyWordCodeInTheTranspiledLangStart = Trim(A_LoopField102);
        }
        if (A_Index102 == 11) {
            keyWordCodeInTheTranspiledLangEnd = Trim(A_LoopField102);
        }
        if (A_Index102 == 12) {
            keyWordCodeInTheTranspiledLangStartCPP = Trim(A_LoopField102);
        }
        if (A_Index102 == 13) {
            keyWordCodeInTheTranspiledLangEndCPP = Trim(A_LoopField102);
        }
        if (A_Index102 == 14) {
            keyWordCodeInTheTranspiledLangStartPY = Trim(A_LoopField102);
        }
        if (A_Index102 == 15) {
            keyWordCodeInTheTranspiledLangEndPY = Trim(A_LoopField102);
        }
        if (A_Index102 == 16) {
            keyWordCodeInTheTranspiledLangStartJS = Trim(A_LoopField102);
        }
        if (A_Index102 == 17) {
            keyWordCodeInTheTranspiledLangEndJS = Trim(A_LoopField102);
        }
        if (A_Index102 == 18) {
            keyWordCodeInTheTranspiledLangStartGO = Trim(A_LoopField102);
        }
        if (A_Index102 == 19) {
            keyWordCodeInTheTranspiledLangEndGO = Trim(A_LoopField102);
        }
        if (A_Index102 == 20) {
            keyWordCodeInTheTranspiledLangStartLUA = Trim(A_LoopField102);
        }
        if (A_Index102 == 21) {
            keyWordCodeInTheTranspiledLangEndLUA = Trim(A_LoopField102);
        }
        if (A_Index102 == 22) {
            keyWordCodeInTheTranspiledLangStartCS = Trim(A_LoopField102);
        }
        if (A_Index102 == 23) {
            keyWordCodeInTheTranspiledLangEndCS = Trim(A_LoopField102);
        }
        if (A_Index102 == 24) {
            keyWordCodeInTheTranspiledLangStartJAVA = Trim(A_LoopField102);
        }
        if (A_Index102 == 25) {
            keyWordCodeInTheTranspiledLangEndJAVA = Trim(A_LoopField102);
        }
        if (A_Index102 == 26) {
            keyWordCodeInTheTranspiledLangStartKT = Trim(A_LoopField102);
        }
        if (A_Index102 == 27) {
            keyWordCodeInTheTranspiledLangEndKT = Trim(A_LoopField102);
        }
        if (A_Index102 == 28) {
            keyWordCodeInTheTranspiledLangStartRB = Trim(A_LoopField102);
        }
        if (A_Index102 == 29) {
            keyWordCodeInTheTranspiledLangEndRB = Trim(A_LoopField102);
        }
        if (A_Index102 == 30) {
            keyWordCodeInTheTranspiledLangStartNIM = Trim(A_LoopField102);
        }
        if (A_Index102 == 31) {
            keyWordCodeInTheTranspiledLangEndNIM = Trim(A_LoopField102);
        }
        if (A_Index102 == 32) {
            keyWordCodeInTheTranspiledLangStartAHK = Trim(A_LoopField102);
        }
        if (A_Index102 == 33) {
            keyWordCodeInTheTranspiledLangEndAHK = Trim(A_LoopField102);
        }
        if (A_Index102 == 34) {
            keyWordCodeInTheTranspiledLangStartSWIFT = Trim(A_LoopField102);
        }
        if (A_Index102 == 35) {
            keyWordCodeInTheTranspiledLangEndSWIFT = Trim(A_LoopField102);
        }
        if (A_Index102 == 36) {
            keyWordCodeInTheTranspiledLangStartDART = Trim(A_LoopField102);
        }
        if (A_Index102 == 37) {
            keyWordCodeInTheTranspiledLangEndDART = Trim(A_LoopField102);
        }
        if (A_Index102 == 38) {
            keyWordCodeInTheTranspiledLangStartTS = Trim(A_LoopField102);
        }
        if (A_Index102 == 39) {
            keyWordCodeInTheTranspiledLangEndTS = Trim(A_LoopField102);
        }
        if (A_Index102 == 40) {
            keyWordCodeInTheTranspiledLangStartGROOVY = Trim(A_LoopField102);
        }
        if (A_Index102 == 41) {
            keyWordCodeInTheTranspiledLangEndGROOVY = Trim(A_LoopField102);
        }
        if (A_Index102 == 42) {
            keyWordCodeInTheTranspiledLangStartHTVM = Trim(A_LoopField102);
        }
        if (A_Index102 == 43) {
            keyWordCodeInTheTranspiledLangEndHTVM = Trim(A_LoopField102);
        }
        if (A_Index102 == 44) {
            keyWordCodeInHTVMstart = Trim(A_LoopField102);
        }
        if (A_Index102 == 45) {
            keyWordCodeInHTVMend = Trim(A_LoopField102);
        }
        if (A_Index102 == 46) {
            keyWordCurlyBraceOpen = Trim(A_LoopField102);
        }
        if (A_Index102 == 47) {
            keyWordCurlyBraceClose = Trim(A_LoopField102);
        }
        if (A_Index102 == 48) {
            keyWordNull = Trim(A_LoopField102);
        }
        if (A_Index102 == 49) {
            keyWordTrue = Trim(A_LoopField102);
        }
        if (A_Index102 == 50) {
            keyWordFalse = Trim(A_LoopField102);
        }
        if (A_Index102 == 51) {
            keyWordVoid = Trim(A_LoopField102);
        }
        if (A_Index102 == 52) {
            keyWordDouble = Trim(A_LoopField102);
        }
        if (A_Index102 == 53) {
            keyWordChar = Trim(A_LoopField102);
        }
        if (A_Index102 == 54) {
            keyWordUint8 = Trim(A_LoopField102);
        }
        if (A_Index102 == 55) {
            keyWordUint16 = Trim(A_LoopField102);
        }
        if (A_Index102 == 56) {
            keyWordUint32 = Trim(A_LoopField102);
        }
        if (A_Index102 == 57) {
            keyWordUint64 = Trim(A_LoopField102);
        }
        if (A_Index102 == 58) {
            keyWordINT = Trim(A_LoopField102);
        }
        if (A_Index102 == 59) {
            keyWordSTR = Trim(A_LoopField102);
        }
        if (A_Index102 == 60) {
            keyWordBOOL = Trim(A_LoopField102);
        }
        if (A_Index102 == 61) {
            keyWordFLOAT = Trim(A_LoopField102);
        }
        if (A_Index102 == 62) {
            keyWordINT8 = Trim(A_LoopField102);
        }
        if (A_Index102 == 63) {
            keyWordINT16 = Trim(A_LoopField102);
        }
        if (A_Index102 == 64) {
            keyWordINT32 = Trim(A_LoopField102);
        }
        if (A_Index102 == 65) {
            keyWordINT64 = Trim(A_LoopField102);
        }
        if (A_Index102 == 66) {
            keyWordIF = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 67) {
            keyWordElseIf = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 68) {
            keyWordElse = Trim(A_LoopField102);
        }
        if (A_Index102 == 69) {
            keyWordWhileLoop = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 70) {
            keyWordLoopInfinite = Trim(A_LoopField102);
        }
        if (A_Index102 == 71) {
            keyWordLoop = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 72) {
            keyWordLoopParse = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 73) {
            keyWordContinue = Trim(A_LoopField102);
        }
        if (A_Index102 == 74) {
            keyWordBreak = Trim(A_LoopField102);
        }
        if (A_Index102 == 75) {
            keyWordFunc = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 76) {
            keyWordAwait = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 77) {
            keyWordAsync = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 78) {
            keyWordThrow = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 79) {
            keyWordErrorMsg = Trim(A_LoopField102);
        }
        if (A_Index102 == 80) {
            keyWordTry = Trim(A_LoopField102);
        }
        if (A_Index102 == 81) {
            keyWordCatch = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 82) {
            keyWordFinally = Trim(A_LoopField102);
        }
        if (A_Index102 == 83) {
            keyWordReturnStatement = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 84) {
            keyWordArrayAppend = Trim(A_LoopField102);
        }
        if (A_Index102 == 85) {
            keyWordArrayPop = Trim(A_LoopField102);
        }
        if (A_Index102 == 86) {
            keyWordArraySize = Trim(A_LoopField102);
        }
        if (A_Index102 == 87) {
            keyWordArrayInsert = Trim(A_LoopField102);
        }
        if (A_Index102 == 88) {
            keyWordArrayRemove = Trim(A_LoopField102);
        }
        if (A_Index102 == 89) {
            keyWordArrayIndexOf = Trim(A_LoopField102);
        }
        if (A_Index102 == 90) {
            keyWordArrayDefinition = Trim(A_LoopField102);
        }
        if (A_Index102 == 91) {
            keyWordArrayOfIntegersDefinition = Trim(A_LoopField102);
        }
        if (A_Index102 == 92) {
            keyWordArrayOfStringsDefinition = Trim(A_LoopField102);
        }
        if (A_Index102 == 93) {
            keyWordArrayOfFloatingPointNumbersDefinition = Trim(A_LoopField102);
        }
        if (A_Index102 == 94) {
            keyWordArrayOfBooleansDefinition = Trim(A_LoopField102);
        }
        if (A_Index102 == 95) {
            keyWordVar = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 96) {
            keyWordLet = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 97) {
            keyWordConst = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 98) {
            keyWordEnd = Trim(A_LoopField102);
        }
        if (A_Index102 == 99) {
            keyWordGlobal = Trim(A_LoopField102) + " ";
        }
        if (A_Index102 == 100) {
            keyWordComment = Trim(A_LoopField102);
        }
        if (A_Index102 == 101) {
            keyWordCommentOpenMultiLine = Trim(A_LoopField102);
        }
        if (A_Index102 == 102) {
            keyWordCommentCloseMultiLine = Trim(A_LoopField102);
        }
        if (A_Index102 == 103) {
            keyWordEscpaeChar = Trim(A_LoopField102);
        }
        if (A_Index102 == 104) {
            keyWordMainLabel = Trim(A_LoopField102);
        }
        if (A_Index102 == 105) {
            keyWordConcat = Trim(A_LoopField102);
        }
        if (A_Index102 == 106) {
            keyWordAdd = Trim(A_LoopField102);
        }
        if (A_Index102 == 107) {
            keyWordSub = Trim(A_LoopField102);
        }
        if (A_Index102 == 108) {
            keyWordMul = Trim(A_LoopField102);
        }
        if (A_Index102 == 109) {
            keyWordDiv = Trim(A_LoopField102);
        }
        if (A_Index102 == 110) {
            keyWordMod = Trim(A_LoopField102);
        }
        if (A_Index102 == 111) {
            keyWordExp = Trim(A_LoopField102);
        }
        if (A_Index102 == 112) {
            keyWordEqual = Trim(A_LoopField102);
        }
        if (A_Index102 == 113) {
            keyWordStrictEqual = Trim(A_LoopField102);
        }
        if (A_Index102 == 114) {
            keyWordNotEqual = Trim(A_LoopField102);
        }
        if (A_Index102 == 115) {
            keyWordGreater = Trim(A_LoopField102);
        }
        if (A_Index102 == 116) {
            keyWordLess = Trim(A_LoopField102);
        }
        if (A_Index102 == 117) {
            keyWordGreaterEqual = Trim(A_LoopField102);
        }
        if (A_Index102 == 118) {
            keyWordLessEqual = Trim(A_LoopField102);
        }
        if (A_Index102 == 119) {
            keyWordAnd = Trim(A_LoopField102);
        }
        if (A_Index102 == 120) {
            keyWordOr = Trim(A_LoopField102);
        }
        if (A_Index102 == 121) {
            keyWordNot = Trim(A_LoopField102);
        }
        if (A_Index102 == 122) {
            keyWordBitAnd = Trim(A_LoopField102);
        }
        if (A_Index102 == 123) {
            keyWordBitOr = Trim(A_LoopField102);
        }
        if (A_Index102 == 124) {
            keyWordBitXor = Trim(A_LoopField102);
        }
        if (A_Index102 == 125) {
            keyWordBitNot = Trim(A_LoopField102);
        }
        if (A_Index102 == 126) {
            keyWordShiftLeft = Trim(A_LoopField102);
        }
        if (A_Index102 == 127) {
            keyWordShiftRight = Trim(A_LoopField102);
        }
        if (A_Index102 == 128) {
            keyWordShiftUnsignedRight = Trim(A_LoopField102);
        }
        if (A_Index102 == 129) {
            keyWordAssign = Trim(A_LoopField102);
        }
        if (A_Index102 == 130) {
            keyWordAssignAdd = Trim(A_LoopField102);
        }
        if (A_Index102 == 131) {
            keyWordAssignConcat = Trim(A_LoopField102);
        }
        if (A_Index102 == 132) {
            keyWordAssignSub = Trim(A_LoopField102);
        }
        if (A_Index102 == 133) {
            keyWordAssignMul = Trim(A_LoopField102);
        }
        if (A_Index102 == 134) {
            keyWordAssignDiv = Trim(A_LoopField102);
        }
        if (A_Index102 == 135) {
            keyWordAssignMod = Trim(A_LoopField102);
        }
        if (A_Index102 == 136) {
            keyWordAssignShiftLeft = Trim(A_LoopField102);
        }
        if (A_Index102 == 137) {
            keyWordAssignShiftRight = Trim(A_LoopField102);
        }
        if (A_Index102 == 138) {
            keyWordLogicalAssignShiftRight = Trim(A_LoopField102);
        }
        if (A_Index102 == 139) {
            keyWordAssignBitAnd = Trim(A_LoopField102);
        }
        if (A_Index102 == 140) {
            keyWordAssignBitOr = Trim(A_LoopField102);
        }
        if (A_Index102 == 141) {
            keyWordAssignBitXor = Trim(A_LoopField102);
        }
        if (A_Index102 == 142) {
            keyWordTernary1 = Trim(A_LoopField102);
        }
        if (A_Index102 == 143) {
            keyWordTernary2 = Trim(A_LoopField102);
        }
        if (A_Index102 == 144) {
            keyWordInc = Trim(A_LoopField102);
        }
        if (A_Index102 == 145) {
            keyWordDec = Trim(A_LoopField102);
        }
        if (A_Index102 == 146) {
            AHKlikeLoopsIndexedAt = Trim(A_LoopField102);
        }
        if (A_Index102 == 147) {
            keyWordAIndex = Trim(A_LoopField102);
        }
        if (A_Index102 == 148) {
            keyWordALoopField = Trim(A_LoopField102);
        }
        if (A_Index102 == 149) {
            useCurlyBraces = Trim(A_LoopField102);
        }
        if (A_Index102 == 150) {
            useEnd = Trim(A_LoopField102);
        }
        if (A_Index102 == 151) {
            useSemicolon = Trim(A_LoopField102);
        }
        if (A_Index102 == 152) {
            useParentheses = Trim(A_LoopField102);
        }
        if (A_Index102 == 153) {
            usePrefixTypeForTypeDefinition = Trim(A_LoopField102);
        }
        if (A_Index102 == 154) {
            usePostfixTypeForTypeDefinition = Trim(A_LoopField102);
        }
        if (A_Index102 == 155) {
            usePythonicColonSyntax = Trim(A_LoopField102);
        }
        if (A_Index102 == 156) {
            useCurlyBracesSyntaxForArrayDef = Trim(A_LoopField102);
        }
        if (A_Index102 == 157) {
            useInJavaScriptAlwaysUseVar = Trim(A_LoopField102);
        }
        if (A_Index102 == 158) {
            useJavaScriptInAfullHTMLfile = Trim(A_LoopField102);
        }
        if (A_Index102 == 159) {
            useJavaScriptAmainFuncDef = Trim(A_LoopField102);
        }
        if (A_Index102 == 160) {
            useJavaScriptAllFuncsAreAsync = Trim(A_LoopField102);
        }
        if (A_Index102 == 161) {
            useJavaScriptAlwaysTripleEqual = Trim(A_LoopField102);
        }
    }
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        std::vector<std::string> items103 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
        for (size_t A_Index103 = 0; A_Index103 < items103.size() + 0; A_Index103++) {
            std::string A_LoopField103 = items103[A_Index103 - 0];
            if (A_Index103 == 0) {
                langToConvertTo_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 1) {
                langFileExtension_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 2) {
                commands_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 3) {
                keyWordAlliance_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 4) {
                keyWordCrew_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 5) {
                keyWordMethod_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 6) {
                keyWordDefObj_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 7) {
                keyWordProp_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 8) {
                keyWordThis_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 9) {
                keyWordInclude_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 10) {
                keyWordCodeInTheTranspiledLangStart_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 11) {
                keyWordCodeInTheTranspiledLangEnd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 12) {
                keyWordCodeInTheTranspiledLangStartCPP_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 13) {
                keyWordCodeInTheTranspiledLangEndCPP_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 14) {
                keyWordCodeInTheTranspiledLangStartPY_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 15) {
                keyWordCodeInTheTranspiledLangEndPY_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 16) {
                keyWordCodeInTheTranspiledLangStartJS_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 17) {
                keyWordCodeInTheTranspiledLangEndJS_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 18) {
                keyWordCodeInTheTranspiledLangStartGO_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 19) {
                keyWordCodeInTheTranspiledLangEndGO_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 20) {
                keyWordCodeInTheTranspiledLangStartLUA_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 21) {
                keyWordCodeInTheTranspiledLangEndLUA_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 22) {
                keyWordCodeInTheTranspiledLangStartCS_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 23) {
                keyWordCodeInTheTranspiledLangEndCS_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 24) {
                keyWordCodeInTheTranspiledLangStartJAVA_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 25) {
                keyWordCodeInTheTranspiledLangEndJAVA_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 26) {
                keyWordCodeInTheTranspiledLangStartKT_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 27) {
                keyWordCodeInTheTranspiledLangEndKT_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 28) {
                keyWordCodeInTheTranspiledLangStartRB_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 29) {
                keyWordCodeInTheTranspiledLangEndRB_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 30) {
                keyWordCodeInTheTranspiledLangStartNIM_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 31) {
                keyWordCodeInTheTranspiledLangEndNIM_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 32) {
                keyWordCodeInTheTranspiledLangStartAHK_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 33) {
                keyWordCodeInTheTranspiledLangEndAHK_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 34) {
                keyWordCodeInTheTranspiledLangStartSWIFT_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 35) {
                keyWordCodeInTheTranspiledLangEndSWIFT_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 36) {
                keyWordCodeInTheTranspiledLangStartDART_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 37) {
                keyWordCodeInTheTranspiledLangEndDART_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 38) {
                keyWordCodeInTheTranspiledLangStartTS_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 39) {
                keyWordCodeInTheTranspiledLangEndTS_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 40) {
                keyWordCodeInTheTranspiledLangStartGROOVY_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 41) {
                keyWordCodeInTheTranspiledLangEndGROOVY_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 42) {
                keyWordCodeInTheTranspiledLangStartHTVM_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 43) {
                keyWordCodeInTheTranspiledLangEndHTVM_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 44) {
                keyWordCodeInHTVMstart_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 45) {
                keyWordCodeInHTVMend_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 46) {
                keyWordCurlyBraceOpen_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 47) {
                keyWordCurlyBraceClose_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 48) {
                keyWordNull_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 49) {
                keyWordTrue_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 50) {
                keyWordFalse_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 51) {
                keyWordVoid_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 52) {
                keyWordDouble_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 53) {
                keyWordChar_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 54) {
                keyWordUint8_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 55) {
                keyWordUint16_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 56) {
                keyWordUint32_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 57) {
                keyWordUint64_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 58) {
                keyWordINT_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 59) {
                keyWordSTR_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 60) {
                keyWordBOOL_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 61) {
                keyWordFLOAT_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 62) {
                keyWordINT8_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 63) {
                keyWordINT16_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 64) {
                keyWordINT32_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 65) {
                keyWordINT64_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 66) {
                keyWordIF_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 67) {
                keyWordElseIf_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 68) {
                keyWordElse_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 69) {
                keyWordWhileLoop_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 70) {
                keyWordLoopInfinite_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 71) {
                keyWordLoop_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 72) {
                keyWordLoopParse_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 73) {
                keyWordContinue_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 74) {
                keyWordBreak_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 75) {
                keyWordFunc_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 76) {
                keyWordAwait_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 77) {
                keyWordAsync_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 78) {
                keyWordThrow_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 79) {
                keyWordErrorMsg_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 80) {
                keyWordTry_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 81) {
                keyWordCatch_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 82) {
                keyWordFinally_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 83) {
                keyWordReturnStatement_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 84) {
                keyWordArrayAppend_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 85) {
                keyWordArrayPop_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 86) {
                keyWordArraySize_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 87) {
                keyWordArrayInsert_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 88) {
                keyWordArrayRemove_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 89) {
                keyWordArrayIndexOf_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 90) {
                keyWordArrayDefinition_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 91) {
                keyWordArrayOfIntegersDefinition_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 92) {
                keyWordArrayOfStringsDefinition_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 93) {
                keyWordArrayOfFloatingPointNumbersDefinition_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 94) {
                keyWordArrayOfBooleansDefinition_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 95) {
                keyWordVar_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 96) {
                keyWordLet_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 97) {
                keyWordConst_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 98) {
                keyWordEnd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 99) {
                keyWordGlobal_2 = Trim(A_LoopField103) + " ";
            }
            if (A_Index103 == 100) {
                keyWordComment_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 101) {
                keyWordCommentOpenMultiLine_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 102) {
                keyWordCommentCloseMultiLine_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 103) {
                keyWordEscpaeChar_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 104) {
                keyWordMainLabel_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 105) {
                keyWordConcat_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 106) {
                keyWordAdd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 107) {
                keyWordSub_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 108) {
                keyWordMul_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 109) {
                keyWordDiv_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 110) {
                keyWordMod_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 111) {
                keyWordExp_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 112) {
                keyWordEqual_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 113) {
                keyWordStrictEqual_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 114) {
                keyWordNotEqual_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 115) {
                keyWordGreater_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 116) {
                keyWordLess_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 117) {
                keyWordGreaterEqual_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 118) {
                keyWordLessEqual_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 119) {
                keyWordAnd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 120) {
                keyWordOr_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 121) {
                keyWordNot_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 122) {
                keyWordBitAnd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 123) {
                keyWordBitOr_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 124) {
                keyWordBitXor_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 125) {
                keyWordBitNot_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 126) {
                keyWordShiftLeft_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 127) {
                keyWordShiftRight_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 128) {
                keyWordShiftUnsignedRight_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 129) {
                keyWordAssign_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 130) {
                keyWordAssignAdd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 131) {
                keyWordAssignConcat_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 132) {
                keyWordAssignSub_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 133) {
                keyWordAssignMul_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 134) {
                keyWordAssignDiv_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 135) {
                keyWordAssignMod_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 136) {
                keyWordAssignShiftLeft_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 137) {
                keyWordAssignShiftRight_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 138) {
                keyWordLogicalAssignShiftRight_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 139) {
                keyWordAssignBitAnd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 140) {
                keyWordAssignBitOr_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 141) {
                keyWordAssignBitXor_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 142) {
                keyWordTernary1_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 143) {
                keyWordTernary2_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 144) {
                keyWordInc_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 145) {
                keyWordDec_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 146) {
                AHKlikeLoopsIndexedAt_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 147) {
                keyWordAIndex_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 148) {
                keyWordALoopField_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 149) {
                useCurlyBraces_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 150) {
                useEnd_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 151) {
                useSemicolon_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 152) {
                useParentheses_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 153) {
                usePrefixTypeForTypeDefinition_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 154) {
                usePostfixTypeForTypeDefinition_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 155) {
                usePythonicColonSyntax_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 156) {
                useCurlyBracesSyntaxForArrayDef_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 157) {
                useInJavaScriptAlwaysUseVar_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 158) {
                useJavaScriptInAfullHTMLfile_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 159) {
                useJavaScriptAmainFuncDef_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 160) {
                useJavaScriptAllFuncsAreAsync_2 = Trim(A_LoopField103);
            }
            if (A_Index103 == 161) {
                useJavaScriptAlwaysTripleEqual_2 = Trim(A_LoopField103);
            }
        }
    }
    ...
    */
    ...
    std::vector<std::string> items104 = LoopParseFunc(allInstructionFile, "\n", "\r");
    for (size_t A_Index104 = 0; A_Index104 < items104.size() + 0; A_Index104++) {
        std::string A_LoopField104 = items104[A_Index104 - 0];
        if (RegExMatch(Trim(A_LoopField104), "^name: [A-Za-z0-9_]+")) {
            availableFuncsInHTVMInHTVM += Trim(StrSplit(Trim(A_LoopField104), "name: ", 2)) + Chr(10);
        }
    }
    ...
    for (size_t A_Index105 = 0; A_Index105 < items105.size() + 0; A_Index105++) {
        ...
        if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEnd)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndCPP)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndPY)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndJS)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndGO)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndLUA)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndCS)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndJAVA)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndKT)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndRB)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndNIM)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndAHK)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndSWIFT)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndDART)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndTS)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndGROOVY)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangEndHTVM)) {
        ...
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInHTVMend)) {
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            ...
            holdTempDataProgrammingBlockThenPutInArr += A_LoopField105 + Chr(10);
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStart)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartCPP)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartPY)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartJS)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartGO)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartLUA)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartCS)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartJAVA)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartKT)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartRB)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartNIM)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartAHK)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartSWIFT)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartDART)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartTS)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartGROOVY)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInTheTranspiledLangStartHTVM)) {
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
        }
        else if (Trim(StrLower(A_LoopField105)) == StrLower(keyWordCodeInHTVMstart)) {
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            holdTempDataProgrammingBlockThenPutInArr = "";
            inProgarmmingBlock = 1;
            ...
            programmingBlocksTemp += A_LoopField105 + Chr(10);
        }
    }
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            if (InStr(StrLower(code), StrLower(keyWordInclude + " "))) {
                for (int A_Index106 = 0; A_Index106 < 10000 + 0; A_Index106++) {
                    doseCodeHaveLibs = 0;
                    allLibCODE = "";
                    if (A_Index106 == 0) {
                        ...
                        for (size_t A_Index107 = 0; A_Index107 < items107.size() + 0; A_Index107++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField107)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                HTVM_Append(allLibsWeSee, StrReplace(StringTrimLeft(Trim(A_LoopField107), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                HTVM_Append(allLibsWeSeeSEE, StrReplace(StringTrimLeft(Trim(A_LoopField107), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                doseCodeHaveLibs = 1;
                            }
                        }
                    } else {
                        ...
                        for (size_t A_Index108 = 0; A_Index108 < items108.size() + 0; A_Index108++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField108)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                ...
                                for (int A_Index109 = 0; A_Index109 < HTVM_Size(allLibsWeSee) + 0; A_Index109++) {
                                    if (StrReplace(StringTrimLeft(Trim(ALoopField), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), "") == allLibsWeSee[A_Index109]) {
                                        doseCodeHaveLibs_HAS_SEEN = 1;
                                    }
                                }
                                if (doseCodeHaveLibs_HAS_SEEN == 0) {
                                    HTVM_Append(allLibsWeSee, StrReplace(StringTrimLeft(Trim(A_LoopField108), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                    HTVM_Append(allLibsWeSeeSEE, StrReplace(StringTrimLeft(Trim(A_LoopField108), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                    doseCodeHaveLibs = 1;
                                }
                            }
                        }
                    }
                    for (int A_Index110 = 0; A_Index110 < HTVM_Size(allLibsWeSee) + 0; A_Index110++) {
                        allLibsWeSeeHOLD = allLibsWeSee[A_Index110];
                        doseCodeHaveLibs_HAS_SEEN2 = 0;
                        for (int A_Index111 = 0; A_Index111 < HTVM_Size(allLibsWeSeeSEE) - HTVM_Size(allLibsWeSee) + 0; A_Index111++) {
                            if (allLibsWeSeeHOLD == allLibsWeSeeSEE[A_Index111]) {
                                doseCodeHaveLibs_HAS_SEEN2 = 1;
                            }
                        }
                        if (doseCodeHaveLibs_HAS_SEEN2 == 0) {
                            allLibCODE += FileRead(Trim(allLibsWeSee[HTVM_Size(allLibsWeSee) - A_Index110 - 1])) + Chr(10);
                        }
                    ...
                    for (size_t A_Index112 = 0; A_Index112 < items112.size() + 0; A_Index112++) {
                        ...
                        if (SubStr(StrLower(Trim(A_LoopField112)), 1, StrLen(StrLower(keyWordInclude + " "))) != StrLower(keyWordInclude + " ")) {
                            allLibCODEfix += A_LoopField112 + Chr(10);
                        }
                    }
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (size_t A_Index114 = 0; A_Index114 < items114.size() + 0; A_Index114++) {
            ...
            HTVM_Append(getAllCharForTheFurtureSoIcanAddEscapeChar, A_LoopField114);
        }
        ...
        for (size_t A_Index115 = 0; A_Index115 < items115.size() + 0; A_Index115++) {
            ...
            if (A_LoopField115 == keyWordEscpaeChar && getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index115 + 1] == Chr(34)) {
                ...
                if (fixOutFixDoubleQuotesInsideDoubleQuotesFIXok != 1) {
                    OutFixDoubleQuotesInsideDoubleQuotes += A_LoopField115;
                } else {
        ...
        if (keyWordEscpaeChar == Chr(92) && langToConvertTo != langFileExtension_2) {
            ...
            for (size_t A_Index116 = 0; A_Index116 < items116.size() + 0; A_Index116++) {
                ...
                if (A_LoopField116 == Chr(34)) {
                    areWEinSome34sNum++;
                }
                if (areWEinSome34sNum == 1) {
                    if (A_LoopField116 != Chr(34)) {
                        if (A_LoopField116 == keyWordEscpaeChar && langToConvertTo != langFileExtension_2) {
                            theIdNumOfThe34theVar[theIdNumOfThe34] = theIdNumOfThe34theVar[theIdNumOfThe34] + Chr(92);
                        } else {
                            theIdNumOfThe34theVar[theIdNumOfThe34] = theIdNumOfThe34theVar[theIdNumOfThe34] + A_LoopField116;
                        }
                    } else {
                        theIdNumOfThe34++;
                ...
                if (areWEinSome34sNum == 2 || areWEinSome34sNum == 0) {
                    if (A_LoopField116 != Chr(34)) {
                        htCodeOUT754754 += A_LoopField116;
                    }
                    areWEinSome34sNum = 0;
                }
            }
            ...
            for (size_t A_Index117 = 0; A_Index117 < items117.size() + 0; A_Index117++) {
                ...
                if (A_LoopField117 == Chr(34)) {
                    areWEinSome34sNum++;
                }
                if (areWEinSome34sNum == 1) {
                    if (A_LoopField117 != Chr(34)) {
                        if (A_LoopField117 == keyWordEscpaeChar && keyWordEscpaeChar == getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index117 + 1] && langToConvertTo != langFileExtension_2) {
                        ...
                        else if (A_LoopField117 == keyWordEscpaeChar && langToConvertTo != langFileExtension_2) {
                            ...
                            theIdNumOfThe34theVar[theIdNumOfThe34] = theIdNumOfThe34theVar[theIdNumOfThe34] + A_LoopField117;
                        }
                    } else {
                        theIdNumOfThe34++;
                        htCodeOUT754754 += "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(theIdNumOfThe34) + Chr(65) + Chr(65);
                ...
                if (areWEinSome34sNum == 2 || areWEinSome34sNum == 0) {
                    if (A_LoopField117 != Chr(34)) {
                        htCodeOUT754754 += A_LoopField117;
                    }
                    areWEinSome34sNum = 0;
                }
            }
        ...
        for (int A_Index118 = 0; A_Index118 < theIdNumOfThe34 + 0; A_Index118++) {
            theIdNumOfThe34theVar[A_Index118] = theIdNumOfThe34theVar[A_Index118] + Chr(34);
        }
        ...
        for (size_t A_Index119 = 0; A_Index119 < items119.size() + 0; A_Index119++) {
            ...
            if (InStr(A_LoopField119, " " + keyWordComment) != false && SubStr(Trim(A_LoopField119), 1, StrLen(keyWordComment)) != keyWordComment) {
                posForRemoveCommentsOnTheEndOfTheLine = 0;
                slidingWinFixCommentsRmI = 0;
                slidingWinFixCommentsRm = slidingWinFixCommentsRmFUNC(A_LoopField119);
                for (int A_Index120 = 0; A_Index120 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index120++) {
                    slidingWinFixCommentsRmI = A_Index120;
                    slidingWinFixCommentsRmHold = "";
                    for (int A_Index121 = 0; A_Index121 < StrLen(" " + keyWordComment) + 0; A_Index121++) {
                        slidingWinFixCommentsRmHold += slidingWinFixCommentsRm[slidingWinFixCommentsRmI + A_Index121];
                    }
                    if (Trim(slidingWinFixCommentsRmHold) == keyWordComment) {
                        posForRemoveCommentsOnTheEndOfTheLine = A_Index120;
                        break;
                    }
                }
                if (posForRemoveCommentsOnTheEndOfTheLine > 0) {
                    newStringOutCode += SubStr(A_LoopField119, 1, posForRemoveCommentsOnTheEndOfTheLine) + Chr(10);
                } else {
                    newStringOutCode += A_LoopField119 + Chr(10);
                }
            } else {
                newStringOutCode += A_LoopField119 + Chr(10);
            }
        ...
        if (useCurlyBraces == "on") {
            ...
            for (size_t A_Index122 = 0; A_Index122 < items122.size() + 0; A_Index122++) {
                ...
                str1 = "";
                if (InStr(A_LoopField122, keyWordCurlyBraceOpen) || InStr(A_LoopField122, keyWordCurlyBraceClose)) {
                    str1 = StrReplace(A_LoopField122, keyWordCurlyBraceOpen, "{");
                    ...
                    fixSomeCurlyBraceForExratFlexability += A_LoopField122 + Chr(10);
                }
            }
            ...
            for (size_t A_Index123 = 0; A_Index123 < items123.size() + 0; A_Index123++) {
                ...
                fixSomeCurlyBraceForExratFlexabilityTriHELP += Trim(A_LoopField123) + Chr(10);
            }
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (size_t A_Index124 = 0; A_Index124 < items124.size() + 0; A_Index124++) {
                    ...
                    htCodeOutFixINT2 = 0;
                    if (isLineAconstruct(Trim(A_LoopField124)) == true || Trim(A_LoopField124) == keyWordCurlyBraceOpen) {
                        htCodeOutFixINT2 = 1;
                    }
                    htCodeOutFixINT = 0;
                    std::vector<std::string> items125 = LoopParseFunc(A_LoopField124, " ");
                    for (size_t A_Index125 = 0; A_Index125 < items125.size() + 0; A_Index125++) {
                        std::string A_LoopField125 = items125[A_Index125 - 0];
                        htCodeOutFixINT++;
                    }
                    htCodeOutFixINT--;
                    std::vector<std::string> items126 = LoopParseFunc(A_LoopField124, " ");
                    for (size_t A_Index126 = 0; A_Index126 < items126.size() + 0; A_Index126++) {
                        std::string A_LoopField126 = items126[A_Index126 - 0];
                        if (htCodeOutFixINT == A_Index126 && htCodeOutFixINT2 == 1) {
                            htCodeOutFixINT2 = 0;
                            htCodeOutFixEnd += HTVMmatchStrRrplace(A_LoopField126, keyWordCurlyBraceOpen, "{") + " ";
                        } else {
                            htCodeOutFixEnd += A_LoopField126 + " ";
                        }
                    }
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (size_t A_Index127 = 0; A_Index127 < items127.size() + 0; A_Index127++) {
                    ...
                    htCodeOutFixINT2 = 0;
                    if (isLineAconstruct(Trim(A_LoopField127)) == true || Trim(A_LoopField127) == keyWordCurlyBraceClose) {
                        htCodeOutFixINT2 = 1;
                    }
                    std::vector<std::string> items128 = LoopParseFunc(A_LoopField127, " ");
                    for (size_t A_Index128 = 0; A_Index128 < items128.size() + 0; A_Index128++) {
                        std::string A_LoopField128 = items128[A_Index128 - 0];
                        if (htCodeOutFixINT2 == 1 || Trim(A_LoopField128) == keyWordCurlyBraceClose) {
                            htCodeOutFixINT2 = 0;
                            htCodeOutFixEnd += HTVMmatchStrRrplace(A_LoopField128, keyWordCurlyBraceClose, "}") + " ";
                        } else {
                            htCodeOutFixEnd += A_LoopField128 + " ";
                        }
                    }
                    htCodeOutFixEnd = StringTrimRight(htCodeOutFixEnd, 1);
                    htCodeOutFixEnd += Chr(10);
        ...
        if (useEnd == "on") {
            ...
            for (size_t A_Index129 = 0; A_Index129 < items129.size() + 0; A_Index129++) {
                ...
                if (StrLower(Trim(A_LoopField129)) == StrLower(keyWordEnd)) {
                    htCodeOutFixEnd += "}\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField129)), 1, StrLen(StrLower(keyWordIF))) == StrLower(keyWordIF) && isLineAconstruct(Trim(A_LoopField129)) == true) {
                    htCodeOutFixEnd += A_LoopField129 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField129)), 1, StrLen(StrLower(keyWordWhileLoop))) == StrLower(keyWordWhileLoop) && isLineAconstruct(Trim(A_LoopField129)) == true) {
                    htCodeOutFixEnd += A_LoopField129 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField129)), 1, StrLen(StrLower(keyWordElseIf))) == StrLower(keyWordElseIf) && isLineAconstruct(Trim(A_LoopField129)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField129 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField129)), 1, StrLen(StrLower(keyWordElse))) == StrLower(keyWordElse) && isLineAconstruct(Trim(A_LoopField129)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField129 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField129)), 1, StrLen(StrLower(keyWordCatch))) == StrLower(keyWordCatch) && isLineAconstruct(Trim(A_LoopField129)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField129 + "\n{\n";
                }
                else if (SubStr(StrLower(Trim(A_LoopField129)), 1, StrLen(StrLower(keyWordFinally))) == StrLower(keyWordFinally) && isLineAconstruct(Trim(A_LoopField129)) == true) {
                    htCodeOutFixEnd += "\n}\n" + A_LoopField129 + "\n{\n";
                }
                else if (isLineAconstruct(Trim(A_LoopField129)) == true) {
                    htCodeOutFixEnd += A_LoopField129 + "\n{\n";
                } else {
                    htCodeOutFixEnd += A_LoopField129 + Chr(10);
                }
            }
            code = StringTrimRight(htCodeOutFixEnd, 1);
        }
        if (usePythonicColonSyntax == "off") {
            if (useEnd == "off" && useCurlyBraces == "off") {
                ...
                for (size_t A_Index130 = 0; A_Index130 < items130.size() + 0; A_Index130++) {
                    ...
                    if (isLineAconstruct(Trim(A_LoopField130)) == true) {
                        htCodeOutFixEnd += A_LoopField130 + ":\n";
                    } else {
                        htCodeOutFixEnd += A_LoopField130 + Chr(10);
                    }
                }
                code = StringTrimRight(htCodeOutFixEnd, 1);
            }
        ...
        for (size_t A_Index131 = 0; A_Index131 < items131.size() + 0; A_Index131++) {
            ...
            outTrimCode += Trim(A_LoopField131) + Chr(10);
        }
        code = StringTrimRight(outTrimCode, 1);
        // for converting c++ to js and py
        //code := StrReplace(code, "{}", "[]")
        std::string outCodeFixBraces = "";
        for (int A_Index132 = 0; A_Index132 < 2 + 0; A_Index132++) {
            outCodeFixBraces = "";
            std::vector<std::string> items133 = LoopParseFunc(code, "\n", "\r");
            for (size_t A_Index133 = 0; A_Index133 < items133.size() + 0; A_Index133++) {
                std::string A_LoopField133 = items133[A_Index133 - 0];
                if (InStr(A_LoopField133, " " + keyWordAssign + " ") || InStr(A_LoopField133, " " + keyWordAssignAdd + " ") || InStr(A_LoopField133, " " + keyWordAssignConcat + " ") || InStr(A_LoopField133, " " + keyWordAssignSub + " ") || InStr(A_LoopField133, " " + keyWordAssignMul + " ") || InStr(A_LoopField133, " " + keyWordAssignDiv + " ") || InStr(A_LoopField133, " " + keyWordAssignMod + " ") || InStr(A_LoopField133, " " + keyWordAssignShiftLeft + " ") || InStr(A_LoopField133, " " + keyWordAssignShiftRight + " ") || InStr(A_LoopField133, " " + keyWordLogicalAssignShiftRight + " ") || InStr(A_LoopField133, " " + keyWordAssignBitAnd + " ") || InStr(A_LoopField133, " " + keyWordAssignBitOr + " ") || InStr(A_LoopField133, " " + keyWordAssignBitXor + " ") && useCurlyBracesSyntaxForArrayDef == "on") {
                    if (SubStr(StrLower(A_LoopField133), 1, StrLen(StrLower(keyWordFunc))) == StrLower(keyWordFunc) || SubStr(StrLower(A_LoopField133), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc)) {
                        if (InStr(Trim(A_LoopField133), "{") && Trim(A_LoopField133) != "{") {
                            outCodeFixBraces += Trim(StrReplace(Trim(A_LoopField133), "{", "")) + "\n{\n";
                        }
                        else if (InStr(Trim(A_LoopField133), "}") && Trim(A_LoopField133) != "}") {
                            outCodeFixBraces += "}\n" + Trim(StrReplace(Trim(A_LoopField133), "}", "")) + Chr(10);
                        } else {
                            outCodeFixBraces += Trim(A_LoopField133) + Chr(10);
                        }
                    } else {
                        outCodeFixBraces += Trim(A_LoopField133) + Chr(10);
                    }
        ...
        if (usePythonicColonSyntax == "on" || useCurlyBraces == "off" && useEnd == "off") {
            ...
            for (size_t A_Index134 = 0; A_Index134 < items134.size() + 0; A_Index134++) {
                ...
                if (isLineAconstruct(Trim(A_LoopField134)) == true) {
                    htCodeOutFixEnd += StringTrimRight(A_LoopField134, 1) + Chr(10);
                } else {
        ...
        if (isNotHTVMfile2 == 0) {
            ...
            for (size_t A_Index135 = 0; A_Index135 < items135.size() + 0; A_Index135++) {
                ...
                if (StrLower(Trim(A_LoopField135)) == StrLower(keyWordMainLabel)) {
                    didWeUseMainLabel = 1;
                    if (langToConvertTo == langFileExtension_2) {
                    ...
                    codeOutFixAndAddMainFunc += A_LoopField135 + Chr(10);
                }
            }
        ...
        for (size_t A_Index136 = 0; A_Index136 < items136.size() + 0; A_Index136++) {
            ...
            HTVM_Append(lookIntoTheNextLineForFuncWhitNoKeyWord, A_LoopField136);
        }
        ...
        for (size_t A_Index137 = 0; A_Index137 < items137.size() + 0; A_Index137++) {
            ...
            lineDone = 0;
            if (SubStr(A_LoopField137, 1, StrLen(keyWordComment)) == keyWordComment) {
                lineDone = 1;
                str1 = StringTrimLeft(A_LoopField137, StrLen(keyWordComment));
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (Trim(A_LoopField137) == keyWordCommentOpenMultiLine) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (Trim(A_LoopField137) == keyWordCommentCloseMultiLine) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (InStr(A_LoopField137, "[][][][][] ")) {
                lineDone = 1;
                str1 = StrSplit(A_LoopField137, " ", 2);
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordDefObj))) == StrLower(keyWordDefObj)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordDefObj)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordDefObj_2) + " " + str0 + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordAlliance))) == StrLower(keyWordAlliance)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordAlliance)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordAlliance_2) + " " + str0 + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordCrew))) == StrLower(keyWordCrew)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordCrew)));
                if (langToConvertTo == langFileExtension_2) {
                    htCode += Trim(keyWordCrew_2) + " " + str0 + Chr(10);
                }
            }
            else if (InStr(A_LoopField137, "[end][end][end][end][end] ")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += "}" + Chr(10);
                }
            }
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordProp))) == StrLower(keyWordProp)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordProp)));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordMethod))) == StrLower(keyWordMethod)) {
                lineDone = 1;
                str0 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordMethod)));
                str1 = Trim(StrSplit(str0, "-----------------------HTVM-OSP-HTVM-OBJ--------------", 1));
                str20 = Trim(StrSplit(str0, "-----------------------HTVM-OSP-HTVM-OBJ--------------", 2));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordIF))) == StrLower(keyWordIF) && SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordElseIf))) != StrLower(keyWordElseIf)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordIF)));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordElseIf))) == StrLower(keyWordElseIf) && SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordIF))) != StrLower(keyWordIF)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordElseIf)));
                str1 = Trim(expressionParserTranspiler("(" + str1 + ")"));
                str1 = StringTrimRight(str1, 1);
                str1 = StringTrimLeft(str1, 1);
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(Trim(A_LoopField137)) == StrLower(keyWordElse) || StrLower(Trim(A_LoopField137)) == StrLower(keyWordElse + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordWhileLoop))) == StrLower(keyWordWhileLoop)) {
                lineDone = 1;
                str1 = Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordWhileLoop)));
                str1 = Trim(expressionParserTranspiler("(" + str1 + ")"));
                str1 = StringTrimRight(str1, 1);
                str1 = StringTrimLeft(str1, 1);
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(Trim(A_LoopField137)) == StrLower(keyWordTry) || StrLower(Trim(A_LoopField137)) == StrLower(keyWordTry + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
                        htCode += keyWordTry_2 + ":\n";
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordCatch))) == StrLower(keyWordCatch)) {
                lineDone = 1;
                str1 = Trim(StrReplace(StrReplace(StringTrimLeft(A_LoopField137, StrLen(keyWordCatch)), "(", ""), ")", ""));
            ...
            else if (StrLower(Trim(A_LoopField137)) == StrLower(keyWordFinally) || StrLower(Trim(A_LoopField137)) == StrLower(keyWordFinally + ":")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (usePythonicColonSyntax_2 == "on") {
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordThrow))) == StrLower(keyWordThrow)) {
                lineDone = 1;
                str1 = Trim(A_LoopField137);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
                }
            ...
            else if (StrLower(A_LoopField137) == StrLower(keyWordBreak) || StrLower(A_LoopField137) == StrLower(keyWordBreak + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (StrLower(A_LoopField137) == StrLower(Trim(keyWordReturnStatement)) || StrLower(A_LoopField137) == StrLower(Trim(keyWordReturnStatement) + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (SubStr(Trim(StrLower(A_LoopField137)), 1, StrLen(StrLower(keyWordReturnStatement))) == StrLower(keyWordReturnStatement)) {
                lineDone = 1;
                str1 = Trim(expressionParserTranspiler(Trim(StringTrimLeft(A_LoopField137, StrLen(keyWordReturnStatement)))));
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
                }
                if (langToConvertTo == langFileExtension_2) {
            ...
            else if (StrLower(A_LoopField137) == StrLower(keyWordContinue) || StrLower(A_LoopField137) == StrLower(keyWordContinue + ";")) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    if (useSemicolon_2 == "on") {
            ...
            else if (StrLower(A_LoopField137) == "::" + keyWordContinue || StrLower(A_LoopField137) == "::" + keyWordContinue + ";") {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += "::" + keyWordContinue_2 + Chr(10);
                }
            ...
            else if (StrLower(A_LoopField137) == StrLower(keyWordLoopInfinite) || StrLower(A_LoopField137) == StrLower(keyWordLoopInfinite + ":")) {
                // infinity loops
            ...
            else if (SubStr(Trim(StrLower(A_LoopField137)), 1, StrLen(StrLower(keyWordLoop))) == StrLower(keyWordLoop) && SubStr(Trim(StrLower(A_LoopField137)), 1, StrLen(StrLower(keyWordLoop)) + 2) != StrLower(keyWordLoop) + "% " && SubStr(Trim(StrLower(A_LoopField137)), 1, StrLen(StrLower(keyWordLoopParse))) != StrLower(keyWordLoopParse)) {
                out2 = StringTrimLeft(A_LoopField137, StrLen(keyWordLoop));
            ...
            else if (SubStr(Trim(StrLower(A_LoopField137)), 1, StrLen(StrLower(keyWordLoop)) + 2) == StrLower(keyWordLoop) + "% ") {
                howMany_fixAindexInGoUnused++;
                out2 = StringTrimLeft(A_LoopField137, StrLen(keyWordLoop) + 2);
                out2 = StrReplace(out2, ":", "");
                //MsgBox % out2
                //MsgBox, % out2
                out2 = Trim(out2);
            ...
            else if (SubStr(StrLower(A_LoopField137), 1, StrLen(StrLower(keyWordLoopParse))) == StrLower(keyWordLoopParse)) {
                howMany_fixAindexInGoUnused++;
                var1 = StringTrimLeft(A_LoopField137, StrLen(keyWordLoopParse));
                out2 = StrReplace(out2, ":", "");
                lineDone = 1;
            ...
            else if (SubStrLastChars(Trim(A_LoopField137), StrLen(keyWordInc)) == keyWordInc || SubStrLastChars(Trim(A_LoopField137), StrLen(keyWordInc + ";")) == keyWordInc + ";" && lineDone == 0) {
                if (useSemicolon == "on") {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField137), StrLen(keyWordInc + ";")));
                } else {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField137), StrLen(keyWordInc)));
                }
                str1 = Trim(expressionParserTranspiler(str1));
            ...
            else if (SubStrLastChars(Trim(A_LoopField137), StrLen(keyWordDec)) == keyWordDec || SubStrLastChars(Trim(A_LoopField137), StrLen(keyWordDec + ";")) == keyWordDec + ";" && lineDone == 0) {
                if (useSemicolon == "on") {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField137), StrLen(keyWordDec + ";")));
                } else {
                    str1 = Trim(StringTrimRight(Trim(A_LoopField137), StrLen(keyWordDec)));
                }
                str1 = Trim(expressionParserTranspiler(str1));
            ...
            else if (SubStr(StrLower(Trim(A_LoopField137)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ") && langToConvertTo == langFileExtension_2) {
                htCode += keyWordInclude_2 + " " + Trim(StringTrimLeft(Trim(A_LoopField137), StrLen(StrLower(keyWordInclude) + " "))) + Chr(10);
            }
            else if (StrLower(A_LoopField137) == StrLower(keyWordGlobal) || StrLower(A_LoopField137) == StrLower(keyWordGlobal + ";")) {
                if (langToConvertTo == "ahk") {
                    htCode += "global\n";
                }
            }
            else if (SubStr(StrLower(A_LoopField137), 1, StrLen(StrLower(keyWordAwait))) == StrLower(keyWordAwait)) {
                str1 = StringTrimLeft(A_LoopField137, StrLen(keyWordAwait));
                //MsgBox, % A_LoopField137
                lineDone = 1;
            ...
            else if (SubStr(StrLower(A_LoopField137), 1, StrLen(StrLower(keyWordGlobal))) == StrLower(keyWordGlobal)) {
                str1 = StringTrimLeft(A_LoopField137, StrLen(keyWordGlobal));
                //MsgBox, % A_LoopField137
            ...
            else if (SubStr(StrLower(A_LoopField137), 1, StrLen(keyWordFunc)) == StrLower(keyWordFunc) || SubStr(StrLower(A_LoopField137), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc) && InStr(StrLower(A_LoopField137), " main(") == false && lineDone == 0) {
                lineDone = 1;
                if (SubStr(StrLower(A_LoopField137), 1, StrLen(StrLower(keyWordAsync) + StrLower(keyWordFunc))) == StrLower(keyWordAsync) + StrLower(keyWordFunc)) {
                    // is async
                    int1 = 1;
                    str1 = Trim(StringTrimLeft(A_LoopField137, StrLen(StrLower(keyWordAsync + keyWordFunc))));
                } else {
                    // is async
                    int1 = 0;
                    str1 = Trim(StringTrimLeft(A_LoopField137, StrLen(StrLower(keyWordFunc))));
                }
                if (langToConvertTo != langFileExtension_2 && langToConvertTo != "cpp" && langToConvertTo != "go" && langToConvertTo != "cs" && langToConvertTo != "java" && langToConvertTo != "kt" && langToConvertTo != "nim" && langToConvertTo != "swift" && langToConvertTo != "dart" && langToConvertTo != "ts") {
                    if (str1 != "") {
                        ...
                        for (size_t A_Index139 = 0; A_Index139 < items139.size() + 0; A_Index139++) {
                            ...
                            if (InStr(A_LoopField139, " := ")) {
                                if (InStr(Trim(StrSplit(A_LoopField139, " := ", 1)), " ") != true) {
                                    str4 += "optanal-HTVM-opt-parmsNOtWorking-theirewIs-a-bug-Iusfbudfbuoeshfuisbav=-fwaegs-awedsf-dd-sfgc " + A_LoopField139 + ", ";
                                } else {
                                    str4 += A_LoopField139 + ", ";
                                }
                            }
                            else if (InStr(A_LoopField139, " = ")) {
                                if (InStr(Trim(StrSplit(A_LoopField139, " = ", 1)), " ") != true) {
                                    str4 += "optanal-HTVM-opt-parmsNOtWorking-theirewIs-a-bug-Iusfbudfbuoeshfuisbav=-fwaegs-awedsf-dd-sfgc " + A_LoopField139 + ", ";
                                } else {
                                    str4 += A_LoopField139 + ", ";
                            ...
                            else if (InStr(A_LoopField139, " " + Trim(keyWordAssign) + " ")) {
                                if (InStr(Trim(StrSplit(A_LoopField139, " " + Trim(keyWordAssign) + " ", 1)), " ") != true) {
                                    str4 += "optanal-HTVM-opt-parmsNOtWorking-theirewIs-a-bug-Iusfbudfbuoeshfuisbav=-fwaegs-awedsf-dd-sfgc " + A_LoopField139 + ", ";
                                } else {
                                    str4 += A_LoopField139 + ", ";
                                }
                ...
                if (Trim(str1) == "") {
                    ...
                    for (size_t A_Index140 = 0; A_Index140 < items140.size() + 0; A_Index140++) {
                        ...
                        //print("|" . Trim(A_LoopField140) . "|")
                        if (InStr(Trim(A_LoopField140), " ")) {
                            // there is space aka there is a type
                            if (InStr(A_LoopField140, " " + Trim(keyWordAssign) + " ") == false) {
                                if (usePrefixTypeForTypeDefinition == "on") {
                                    // normal
                                    str6 = Trim(A_LoopField140);
                                ...
                                // optanal param
                                if (InStr(Trim(StrSplit(Trim(A_LoopField140), " " + Trim(keyWordAssign) + " ", 1)), " ")) {
                                    // there is a type
                                    if (usePrefixTypeForTypeDefinition == "on") {
                                        // normal
                                        str6 = Trim(StrSplit(Trim(A_LoopField140), " " + Trim(keyWordAssign) + " ", 1));
                                        str9 = Trim(expressionParserTranspiler(Trim(StrSplit(Trim(A_LoopField140), " " + Trim(keyWordAssign) + " ", 2))));
                                        str7 = getTheLastWord(str6);
                                        str8 = getFuncTypeConvert(Trim(StringTrimRight(str6, StrLen(Trim(str7)) + 1)));
                                        //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                        //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    ...
                                    // there is no type
                                    str8 = Trim(StrSplit(Trim(A_LoopField140), " " + Trim(keyWordAssign) + " ", 1));
                                    str9 = Trim(expressionParserTranspiler(Trim(StrSplit(Trim(A_LoopField140), " " + Trim(keyWordAssign) + " ", 2))));
                                    // str10
                                    // skipLeftCuleyForFuncPLS := 1
                                    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            str5 += Trim(A_LoopField140) + Chr(10);
                        }
                    }
                    //print(str5)
                    //print(str10)
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        std::vector<std::string> items141 = LoopParseFunc(str5, "\n", "\r");
                        ...
                        if (langToConvertTo == "lua") {
                            ...
                            for (size_t A_Index143 = 0; A_Index143 < items143.size() + 0; A_Index143++) {
                                ...
                                str14 += Trim(StrSplit(Trim(A_LoopField143), " = ", 1)) + ", ";
                            }
                            str14 = StringTrimRight(str14, 2);
                            str13 += "{" + Chr(10);
                            std::vector<std::string> items144 = LoopParseFunc(str12, ",");
                            for (size_t A_Index144 = 0; A_Index144 < items144.size() + 0; A_Index144++) {
                                std::string A_LoopField144 = items144[A_Index144 - 0];
                                str13 += Trim(StrSplit(Trim(A_LoopField144), " = ", 1)) + " = " + Trim(StrSplit(Trim(A_LoopField144), " = ", 1)) + " or " + Trim(StrSplit(Trim(A_LoopField144), " = ", 2)) + Chr(10);
                            }
                            str12 = str14;
                        }
                        if (langToConvertTo == "go") {
                            ...
                            str13 += "{" + Chr(10) + " ";
                            std::vector<std::string> items145 = LoopParseFunc(str12, ",");
                            for (size_t A_Index145 = 0; A_Index145 < items145.size() + 0; A_Index145++) {
                                ...
                                str17 = Trim(StrSplit(Trim(A_LoopField145), " = ", 2));
                                str13 += str16 + " := " + str17 + Chr(10);
                            }
                            std::vector<std::string> items146 = LoopParseFunc(str12, ",");
                            for (size_t A_Index146 = 0; A_Index146 < items146.size() + 0; A_Index146++) {
                                std::string A_LoopField146 = items146[A_Index146 - 0];
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField146), " = ", 1)), " ", 1));
                                str18 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField146), " = ", 1)), " ", 2));
                                // str16 = var name
                                // str18 = var type
                                str13 += "if len(__HTVM_V2_TO_GO_optionalParams__) " + Chr(62) + " " + STR(A_Index146) + Chr(10) + "{" + Chr(10) + str16 + " = __HTVM_V2_TO_GO_optionalParams__[" + STR(A_Index146) + "].(" + str18 + ")" + Chr(10) + "}" + Chr(10);
                            }
                            str12 = str14;
                        }
                        if (langToConvertTo == "java") {
                            ...
                            for (size_t A_Index149 = 0; A_Index149 < items149.size() + 0; A_Index149++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField149), " = ", 1)), " ", 2));
                                str17 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField149), " = ", 1)), " ", 1));
                                // str16 = var name
                                // str17 = type name
                                str13 += "if (__HTVM_V2_TO_JAVA_optionalParams__.length " + Chr(62) + " " + STR(A_Index149) + ") " + str16 + " = (" + str17 + ") __HTVM_V2_TO_JAVA_optionalParams__[" + STR(A_Index149) + "];" + Chr(10);
                            }
                            str12 = str14;
                        }
                        str11 += str12;
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        ...
                        if (langToConvertTo == "lua") {
                            ...
                            for (size_t A_Index152 = 0; A_Index152 < items152.size() + 0; A_Index152++) {
                                ...
                                str14 += Trim(StrSplit(Trim(A_LoopField152), " = ", 1)) + ", ";
                            }
                            str14 = StringTrimRight(str14, 2);
                            str13 += "{" + Chr(10);
                            std::vector<std::string> items153 = LoopParseFunc(str11, ",");
                            for (size_t A_Index153 = 0; A_Index153 < items153.size() + 0; A_Index153++) {
                                std::string A_LoopField153 = items153[A_Index153 - 0];
                                str13 += Trim(StrSplit(Trim(A_LoopField153), " = ", 1)) + " = " + Trim(StrSplit(Trim(A_LoopField153), " = ", 1)) + " or " + Trim(StrSplit(Trim(A_LoopField153), " = ", 2)) + Chr(10);
                            }
                            str11 = str14;
                        }
                        if (langToConvertTo == "go") {
                            str14 = "__HTVM_V2_TO_GO_optionalParams__ ...interface{}";
                            str13 += "{" + Chr(10) + " ";
                            std::vector<std::string> items154 = LoopParseFunc(str11, ",");
                            for (size_t A_Index154 = 0; A_Index154 < items154.size() + 0; A_Index154++) {
                                ...
                                str17 = Trim(StrSplit(Trim(A_LoopField154), " = ", 2));
                                str13 += str16 + " := " + str17 + Chr(10);
                            }
                            std::vector<std::string> items155 = LoopParseFunc(str11, ",");
                            for (size_t A_Index155 = 0; A_Index155 < items155.size() + 0; A_Index155++) {
                                std::string A_LoopField155 = items155[A_Index155 - 0];
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField155), " = ", 1)), " ", 1));
                                str18 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField155), " = ", 1)), " ", 2));
                                // str16 = var name
                                // str18 = var type
                                str13 += "if len(__HTVM_V2_TO_GO_optionalParams__) " + Chr(62) + " " + STR(A_Index155) + Chr(10) + "{" + Chr(10) + str16 + " = __HTVM_V2_TO_GO_optionalParams__[" + STR(A_Index155) + "].(" + str18 + ")" + Chr(10) + "}" + Chr(10);
                            }
                            str11 = str14;
                        }
                        if (langToConvertTo == "java") {
                            ...
                            for (size_t A_Index158 = 0; A_Index158 < items158.size() + 0; A_Index158++) {
                                ...
                                str16 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField158), " = ", 1)), " ", 2));
                                str17 = Trim(StrSplit(Trim(StrSplit(Trim(A_LoopField158), " = ", 1)), " ", 1));
                                // str16 = var name
                                // str17 = type name
                                str13 += "if (__HTVM_V2_TO_JAVA_optionalParams__.length " + Chr(62) + " " + STR(A_Index158) + ") " + str16 + " = (" + str17 + ") __HTVM_V2_TO_JAVA_optionalParams__[" + STR(A_Index158) + "];" + Chr(10);
                            }
                            str11 = str14;
                        }
                    }
            ...
            else if (InStr(StrLower(A_LoopField137), " main(") && lineDone == 0) {
                lineDone = 1;
                javaMainFuncSeen = 1;
                csMainFuncSeen = 1;
                htCode += A_LoopField137 + Chr(10);
            }
            else if (InStr(A_LoopField137, " " + keyWordAssign + " ") || InStr(A_LoopField137, " " + keyWordAssignAdd + " ") || InStr(A_LoopField137, " " + keyWordAssignConcat + " ") || InStr(A_LoopField137, " " + keyWordAssignSub + " ") || InStr(A_LoopField137, " " + keyWordAssignMul + " ") || InStr(A_LoopField137, " " + keyWordAssignDiv + " ") || InStr(A_LoopField137, " " + keyWordAssignMod + " ") || InStr(A_LoopField137, " " + keyWordAssignShiftLeft + " ") || InStr(A_LoopField137, " " + keyWordAssignShiftRight + " ") || InStr(A_LoopField137, " " + keyWordLogicalAssignShiftRight + " ") || InStr(A_LoopField137, " " + keyWordAssignBitAnd + " ") || InStr(A_LoopField137, " " + keyWordAssignBitOr + " ") || InStr(A_LoopField137, " " + keyWordAssignBitXor + " ") && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                //keyWordAssign
                //keyWordAssignAdd
                //keyWordAssignConcat
                ...
                //allVarsSoWeDontReDecVars_FIX_int64
                //allVarsSoWeDontReDecVars_FIX_float
                if (InStr(A_LoopField137, " " + keyWordAssign + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssign + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssign + " ", 2);
                    str10 = keyWordAssign;
                    str11 = keyWordAssign_2;
                    if (langToConvertTo == "ahk") {
                        str12 = ":=";
                ...
                else if (InStr(A_LoopField137, " " + keyWordAssignAdd + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignAdd + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignAdd + " ", 2);
                    str10 = keyWordAssignAdd;
                    str11 = keyWordAssignAdd_2;
                    str12 = "+=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignConcat + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignConcat + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignConcat + " ", 2);
                    str10 = keyWordAssignConcat;
                    str11 = keyWordAssignConcat_2;
                    if (langToConvertTo == "ahk") {
                        str12 = ".=";
                ...
                else if (InStr(A_LoopField137, " " + keyWordAssignSub + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignSub + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignSub + " ", 2);
                    str10 = keyWordAssignSub;
                    str11 = keyWordAssignSub_2;
                    str12 = "-=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignMul + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignMul + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignMul + " ", 2);
                    str10 = keyWordAssignMul;
                    str11 = keyWordAssignMul_2;
                    str12 = "*=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignDiv + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignDiv + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignDiv + " ", 2);
                    str10 = keyWordAssignDiv;
                    str11 = keyWordAssignDiv_2;
                    str12 = "/=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignMod + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignMod + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignMod + " ", 2);
                    str10 = keyWordAssignMod;
                    str11 = keyWordAssignMod_2;
                    str12 = "%=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignShiftLeft + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignShiftLeft + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignShiftLeft + " ", 2);
                    str10 = keyWordAssignShiftLeft;
                    str11 = keyWordAssignShiftLeft_2;
                    str12 = "<<=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignShiftRight + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignShiftRight + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignShiftRight + " ", 2);
                    str10 = keyWordAssignShiftRight;
                    str11 = keyWordAssignShiftRight_2;
                    str12 = ">>=";
                }
                else if (InStr(A_LoopField137, " " + keyWordLogicalAssignShiftRight + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordLogicalAssignShiftRight + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordLogicalAssignShiftRight + " ", 2);
                    str10 = keyWordLogicalAssignShiftRight;
                    str11 = keyWordLogicalAssignShiftRight_2;
                    str12 = ">>>=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignBitAnd + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignBitAnd + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignBitAnd + " ", 2);
                    str10 = keyWordAssignBitAnd;
                    str11 = keyWordAssignBitAnd_2;
                    str12 = "&=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignBitOr + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignBitOr + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignBitOr + " ", 2);
                    str10 = keyWordAssignBitOr;
                    str11 = keyWordAssignBitOr_2;
                    str12 = "|=";
                }
                else if (InStr(A_LoopField137, " " + keyWordAssignBitXor + " ")) {
                    str1 = StrSplit(A_LoopField137, " " + keyWordAssignBitXor + " ", 1);
                    str6 = StrSplit(A_LoopField137, " " + keyWordAssignBitXor + " ", 2);
                    str10 = keyWordAssignBitXor;
                    str11 = keyWordAssignBitXor_2;
                    str12 = "^=";
                }
                ...
                if (InStr(ALoopField, " ") == false) {
                    ...
                    if (usePostfixTypeForTypeDefinition == "off") {
                        str1 = Trim(StringTrimLeft(Trim(str1), StrLen(keyWordVar)));
                        std::vector<std::string> items160 = LoopParseFunc(str1, " ");
                    ...
                    if (usePostfixTypeForTypeDefinition == "off") {
                        str1 = Trim(StringTrimLeft(Trim(str1), StrLen(keyWordLet)));
                        std::vector<std::string> items161 = LoopParseFunc(str1, " ");
                    ...
                    lineDone = 1;
                    std::vector<std::string> items162 = LoopParseFunc(str1, " ");
            ...
            else if (SubStr(Trim(A_LoopField137), 1, StrLen(keyWordVar)) == keyWordVar && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                if (usePostfixTypeForTypeDefinition == "off") {
                    lineDone = 1;
                    str1 = Trim(StringTrimLeft(Trim(A_LoopField137), StrLen(keyWordVar)));
                    if (SubStrLastChars(str1, 1) == ";") {
                        str1 = StringTrimRight(str1, 1);
                    }
                    std::vector<std::string> items163 = LoopParseFunc(str1, " ");
            ...
            else if (SubStr(Trim(A_LoopField137), 1, StrLen(keyWordLet)) == keyWordLet && lineDone == 0) {
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                if (usePostfixTypeForTypeDefinition == "off") {
                    lineDone = 1;
                    str1 = Trim(StringTrimLeft(Trim(A_LoopField137), StrLen(keyWordLet)));
                    if (SubStrLastChars(str1, 1) == ";") {
                        str1 = StringTrimRight(str1, 1);
                    }
            ...
            else if (SubStr(Trim(A_LoopField137), 1, StrLen(keyWordDouble + " ")) == keyWordDouble + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordChar + " ")) == keyWordChar + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordUint8 + " ")) == keyWordUint8 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordUint16 + " ")) == keyWordUint16 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordUint32 + " ")) == keyWordUint32 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordUint64 + " ")) == keyWordUint64 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordINT + " ")) == keyWordINT + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordSTR + " ")) == keyWordSTR + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordBOOL + " ")) == keyWordBOOL + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordFLOAT + " ")) == keyWordFLOAT + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordINT8 + " ")) == keyWordINT8 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordINT16 + " ")) == keyWordINT16 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordINT32 + " ")) == keyWordINT32 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordINT64 + " ")) == keyWordINT64 + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordArrayDefinition + " ")) == keyWordArrayDefinition + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordArrayOfIntegersDefinition + " ")) == keyWordArrayOfIntegersDefinition + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordArrayOfStringsDefinition + " ")) == keyWordArrayOfStringsDefinition + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordArrayOfFloatingPointNumbersDefinition + " ")) == keyWordArrayOfFloatingPointNumbersDefinition + " " || SubStr(Trim(A_LoopField137), 1, StrLen(keyWordArrayOfBooleansDefinition + " ")) == keyWordArrayOfBooleansDefinition + " " && usePrefixTypeForTypeDefinition == "on" && lineDone == 0) {
                lineDone = 1;
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                str1 = Trim(A_LoopField137);
                if (SubStrLastChars(str1, 1) == ";") {
            ...
            else if (RegExMatch(Trim(A_LoopField137), "^[a-zA-Z_][a-zA-Z0-9_]*: [^:]*;?$") && usePostfixTypeForTypeDefinition == "on" && lineDone == 0) {
                lineDone = 1;
                allVarsSoWeDontReDecVars_FIX_TOGGLE = 1;
                str1 = Trim(A_LoopField137);
                if (SubStrLastChars(str1, 1) == ";") {
            ...
            else if (RegExMatch(Trim(A_LoopField137), "^[a-zA-Z0-9_\\.]+\\(") && !(InStr(StrLower(A_LoopField137), " main(")) && lineDone == 0) {
                lineDone = 1;
                str1 = Trim(A_LoopField137);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
            ...
            else if (RegExMatch(A_LoopField137, "\\.[a-zA-Z_][a-zA-Z0-9_]*") && lineDone == 0) {
                lineDone = 1;
                str1 = Trim(A_LoopField137);
                if (SubStrLastChars(str1, 1) == ";") {
                    str1 = StringTrimRight(str1, 1);
            ...
            else if (KeyWordsCommands(A_LoopField137, "check", commands, langToConvertTo) == "true" && lineDone == 0) {
                lineDone = 1;
                if (langToConvertTo == langFileExtension_2) {
                    htCode += A_LoopField137 + Chr(10);
                } else {
                    out_KeyWordsCommands = KeyWordsCommands(A_LoopField137, "transpile", commands, langToConvertTo);
                    htCode += out_KeyWordsCommands + Chr(10);
                }
            } else {
                //print("else else else " . A_LoopField137)
                // this is THE else
                //;;;;;;;;;;;;;;;;;;
                if (lineDone != 1) {
                    if (skipLeftCuleyForFuncPLS != 1) {
                        if (SubStr(Trim(StrLower(A_LoopField137)), 1, 1) == Chr(125)) {
                            htCode += Chr(125) + Chr(10);
                        } else {
                            if (htCodeAcurlyBraceAddSomeVrasFixLP == 1 && SubStr(Trim(StrLower(A_LoopField137)), 1, 1) == Chr(123)) {
                                htCodeAcurlyBraceAddSomeVrasFixLP = 0;
                                htCode += A_LoopField137 + Chr(10) + theFixTextLoopLP + Chr(10);
                            } else {
                                if (htCodeAcurlyBraceAddSomeVrasFixNL == 1 && SubStr(Trim(StrLower(A_LoopField137)), 1, 1) == Chr(123)) {
                                    htCodeAcurlyBraceAddSomeVrasFixNL = 0;
                                    htCode += A_LoopField137 + Chr(10) + theFixTextLoopNL + Chr(10);
                                } else {
                                    htCode += A_LoopField137 + Chr(10);
                                }
                            }
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                std::vector<std::string> items166 = LoopParseFunc(htCodeLoopfixa, "\n", "\r");
                for (size_t A_Index166 = 0; A_Index166 < items166.size() + 0; A_Index166++) {
                    std::string A_LoopField166 = items166[A_Index166 - 0];
                    sstr123 = A_LoopField166;
                    fixLoopLokingFor = A_LoopField166;
                    ...
                    if (out1 == "nl") {
                        ...
                        for (size_t A_Index167 = 0; A_Index167 < items167.size() + 0; A_Index167++) {
                            ...
                            //MsgBox, |%A_LoopField167%|`n|%fixLoopLokingFor%|
                            if (InStr(A_LoopField167, fixLoopLokingFor) && insdeAnestedLoopBAD != 1) {
                                fixLoopLokingForNum = 1;
                                //MsgBox, do we came here 1
                            }
                            if (SubStr(Trim(A_LoopField167), 1, 4) == "for " && weAreDoneHereCurly != 1 && insdeAnestedLoopBAD != 1 && fixLoopLokingForNum == 1) {
                                s = StrSplit(A_LoopField167 ,"" + keyWordAIndex + "", 2);
                                out1z = s;
                                s = StrSplit(out1z, " ", 1);
                                out1z = Trim(s);
                                //MsgBox, % out1z
                                ...
                                foundTheTopLoop++;
                                inTarget = 1;
                                //MsgBox, % A_LoopField167
                                dontSaveStr = 1;
                                ALoopField = A_LoopField167;
                                DeleayOneCuzOfLoopParse = 1;
                                out4758686d86d86d86578991a += ALoopField + Chr(10);
                            }
                            if (inTarget == 1 && InStr(A_LoopField167, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                insideBracket = 1;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField167, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly++;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField167, Chr(125)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly--;
                                readyToEnd = 1;
                            }
                            if (SubStr(Trim(A_LoopField167), 1, 4) == "for " && insdeAnestedLoopBAD != 1 && foundTheTopLoop >= 2) {
                            ...
                            if (insdeAnestedLoopBAD == 1) {
                                if (InStr(A_LoopField167, Chr(123))) {
                                    insideBracket1 = 1;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField167, Chr(123))) {
                                    netsedCurly1++;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField167, Chr(125))) {
                                    netsedCurly1--;
                                    readyToEnd1 = 1;
                                }
                                if (InStr(A_LoopField167, Chr(125)) && readyToEnd1 == 1 && netsedCurly1 == 0 && insideBracket == 1) {
                                    //MsgBox, % A_LoopField167
                                    eldLoopNestedBADlol = 1;
                                }
                                out4758686d86d86d86578991a += A_LoopField167 + Chr(10);
                            }
                            ...
                            if (inTarget == 1 && InStr(A_LoopField167, Chr(125)) && readyToEnd == 1 && netsedCurly == 0 && weAreDoneHereCurly == 0 && dontSaveStr != 1 && insdeAnestedLoopBAD != 1) {
                                //MsgBox, % A_LoopField167
                        ...
                        for (size_t A_Index168 = 0; A_Index168 < items168.size() + 0; A_Index168++) {
                            ...
                            if (InStr(A_LoopField168 , fixLoopLokingFor) && insdeAnestedLoopBAD != 1) {
                                fixLoopLokingForNum = 1;
                                //MsgBox, do we came here 3
                            }
                            if (SubStr(Trim(A_LoopField168), 1, 4) == "for " && weAreDoneHereCurly != 1 && insdeAnestedLoopBAD != 1 && fixLoopLokingForNum == 1) {
                                s = StrSplit(A_LoopField168 ,"" + keyWordAIndex + "", 2);
                                out1z = s;
                                s = StrSplit(out1z, " ", 1);
                                ...
                                foundTheTopLoop++;
                                inTarget = 1;
                                //MsgBox, % A_LoopField168
                                dontSaveStr = 1;
                                ALoopField = A_LoopField168;
                                DeleayOneCuzOfLoopParse = 1;
                                out4758686d86d86d86578991a += ALoopField + Chr(10);
                            }
                            if (inTarget == 1 && InStr(A_LoopField168, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                insideBracket = 1;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField168, Chr(123)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly++;
                            }
                            if (insideBracket == 1 && InStr(A_LoopField168, Chr(125)) && insdeAnestedLoopBAD != 1) {
                                netsedCurly--;
                                readyToEnd = 1;
                            }
                            if (SubStr(Trim(A_LoopField168), 1, 4) == "for " && insdeAnestedLoopBAD != 1 && foundTheTopLoop >= 2) {
                                insdeAnestedLoopBAD = 1;
                                insideBracket1 = 0;
                                netsedCurly1 = 0;
                            }
                            ...
                            if (insdeAnestedLoopBAD == 1) {
                                if (InStr(A_LoopField168, Chr(123))) {
                                    insideBracket1 = 1;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField168, Chr(123))) {
                                    netsedCurly1++;
                                }
                                if (insideBracket1 == 1 && InStr(A_LoopField168, Chr(125))) {
                                    netsedCurly1--;
                                    readyToEnd1 = 1;
                                }
                                if (InStr(A_LoopField168, Chr(125)) && readyToEnd1 == 1 && netsedCurly1 == 0 && insideBracket == 1) {
                                    //MsgBox, % A_LoopField168
                                    eldLoopNestedBADlol = 1;
                                }
                                out4758686d86d86d86578991a += A_LoopField168 + Chr(10);
                            }
                            if (inTarget == 1 && dontSaveStr != 1 && fixLoopLokingForNum != 1 && insdeAnestedLoopBAD != 1) {
                                ALoopField = A_LoopField168;
                                // Replace "A_Index" with or without a following digit with "A_Index" + out1z
                            ...
                            if ((inTarget == 1 && InStr(A_LoopField168, Chr(125)) && readyToEnd == 1 && netsedCurly == 0 && weAreDoneHereCurly == 0 && dontSaveStr != 1 && insdeAnestedLoopBAD != 1)) {
                                //MsgBox, % A_LoopField168
                                weAreDoneHereCurly = 1;
                                inTarget = 0;
                                endBracketDOntPutThere = 1;
                ...
                for (size_t A_Index169 = 0; A_Index169 < items169.size() + 0; A_Index169++) {
                    ...
                    ignore = 0;
                    if (SubStr(Trim(A_LoopField169), 1, 4) == "for ") {
                        if (hold == 1 && holdText == A_LoopField169) {
                            ignore = 1;
                        } else {
                            holdText = A_LoopField169;
                            hold = 1;
                        }
                    }
                    if (!ignore) {
                        out4758686d86dgt8r754444444 += A_LoopField169 + Chr(10);
                    }
                }
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (int A_Index171 = 0; A_Index171 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index171++) {
            ADD_ALL_programmingBlock_HTVMsyntax += programmingBlock_HTVMsyntax[A_Index171] + Chr(10);
        }
        ...
        isNotHTVMfile2 = 1;
        for (int A_Index172 = 0; A_Index172 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index172++) {
            htCode = StrReplace(htCode, "programmingBlock_HTVMsyntax-programmingBlock_HTVMsyntax-AA" + STR(A_Index172 + 1) + "AA", compiler(programmingBlock_HTVMsyntax[A_Index172], allInstructionFile, "full", langToConvertToParam));
        }
        isNotHTVMfile2 = 0;
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (langToConvertTo == langFileExtension_2) {
        ...
        if (useEnd_2 == "on") {
            ...
            for (size_t A_Index173 = 0; A_Index173 < items173.size() + 0; A_Index173++) {
                ...
                if (Trim(A_LoopField173) == keyWordCurlyBraceClose_2) {
                    fixLuaAndRuby += StrReplace(A_LoopField173, keyWordCurlyBraceClose_2, Trim(keyWordEnd_2)) + Chr(10);
                }
                else if (SubStrLastChars(A_LoopField173, 2) == " " + keyWordCurlyBraceOpen_2) {
                    fixLuaAndRuby += StringTrimRight(A_LoopField173, 2) + Chr(10);
                } else {
                    fixLuaAndRuby += A_LoopField173 + Chr(10);
                }
            }
        ...
        if (langToConvertTo == "lua" || langToConvertTo == "rb" || langToConvertTo == langFileExtension_2) {
            if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
                ...
                for (size_t A_Index174 = 0; A_Index174 < items174.size() + 0; A_Index174++) {
                    ...
                    if (Trim(A_LoopField174) == "}") {
                        fixLuaAndRuby += StrReplace(A_LoopField174, "}", fixLuaAndRubyHELP) + Chr(10);
                    }
                    else if (SubStrLastChars(A_LoopField174, 2) == " {") {
                        fixLuaAndRuby += StringTrimRight(A_LoopField174, 2) + Chr(10);
                    } else {
                        fixLuaAndRuby += A_LoopField174 + Chr(10);
                    }
                }
                htCode = StringTrimRight(fixLuaAndRuby, 1);
            } else {
                ...
                for (size_t A_Index175 = 0; A_Index175 < items175.size() + 0; A_Index175++) {
                    ...
                    if (Trim(A_LoopField175) == "}") {
                        fixLuaAndRuby += StrReplace(A_LoopField175, "}", fixLuaAndRubyHELP) + Chr(10);
                    }
                    else if (SubStrLastChars(A_LoopField175, 2) == " {") {
                        fixLuaAndRuby += StringTrimRight(A_LoopField175, 2) + Chr(10);
                    } else {
                        fixLuaAndRuby += A_LoopField175 + Chr(10);
                    }
                }
                htCode = StringTrimRight(fixLuaAndRuby, 1);
            }
    ...
    if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
        ...
        for (size_t A_Index176 = 0; A_Index176 < items176.size() + 0; A_Index176++) {
            ...
            HTVM_Append(nextWordEndFix, A_LoopField176);
        }
        ...
        for (size_t A_Index177 = 0; A_Index177 < items177.size() + 0; A_Index177++) {
            ...
            if (Trim(A_LoopField177) == Trim(keyWordEnd_2) && SubStr(Trim(nextWordEndFix[A_Index177 + 1]), 1, StrLen(Trim(keyWordElseIf_2) + " ")) == Trim(keyWordElseIf_2) + " " || Trim(A_LoopField177) == Trim(keyWordEnd_2) && (Trim(nextWordEndFix[A_Index177 + 1]) == Trim(keyWordElse_2) || Trim(nextWordEndFix[A_Index177 + 1]) == Trim(keyWordElse_2 + ":"))) {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "lua") {
        ...
        for (size_t A_Index178 = 0; A_Index178 < items178.size() + 0; A_Index178++) {
            ...
            HTVM_Append(nextWordEndFix, A_LoopField178);
        }
        HTVM_Append(nextWordEndFix, " ");
        ...
        for (size_t A_Index179 = 0; A_Index179 < items179.size() + 0; A_Index179++) {
            ...
            if (Trim(A_LoopField179) == "end" && SubStr(Trim(nextWordEndFix[A_Index179 + 1]), 1, StrLen("elseif ")) == "elseif " || Trim(A_LoopField179) == "end" && Trim(nextWordEndFix[A_Index179 + 1]) == "else") {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "rb") {
        ...
        for (size_t A_Index180 = 0; A_Index180 < items180.size() + 0; A_Index180++) {
            ...
            HTVM_Append(nextWordEndFix, A_LoopField180);
        }
        HTVM_Append(nextWordEndFix, " ");
        ...
        for (size_t A_Index181 = 0; A_Index181 < items181.size() + 0; A_Index181++) {
            ...
            if (Trim(A_LoopField181) == "end" && SubStr(Trim(nextWordEndFix[A_Index181 + 1]), 1, StrLen("elsif ")) == "elsif " || Trim(A_LoopField181) == "end" && Trim(nextWordEndFix[A_Index181 + 1]) == "else") {
                nextWordEndFixOut += "";
            } else {
                nextWordEndFixOut += A_LoopField181 + Chr(10);
            }
        }
        htCode = StringTrimRight(nextWordEndFixOut, 1);
    }
    ...
    if (langToConvertTo == "rb") {
        ...
        for (size_t A_Index182 = 0; A_Index182 < items182.size() + 0; A_Index182++) {
            ...
            HTVM_Append(nextWordEndFixRB, A_LoopField182);
        }
        ...
        for (size_t A_Index183 = 0; A_Index183 < items183.size() + 0; A_Index183++) {
            ...
            if (Trim(A_LoopField183) == "end" && SubStr(Trim(nextWordEndFixRB[A_Index183 + 1]), 1, StrLen("rescue ")) == "rescue " || Trim(A_LoopField183) == "end" && Trim(nextWordEndFixRB[A_Index183 + 1]) == "ensure") {
                nextWordEndFixOut += "";
            } else {
                nextWordEndFixOut += A_LoopField183 + Chr(10);
            }
        }
        htCode = StringTrimRight(nextWordEndFixOut, 1);
    }
    if (langToConvertTo == langFileExtension_2 && useEnd_2 == "on") {
        ...
        for (size_t A_Index184 = 0; A_Index184 < items184.size() + 0; A_Index184++) {
            ...
            HTVM_Append(nextWordEndFixRB, A_LoopField184);
        }
        HTVM_Append(nextWordEndFixRB, " ");
        ...
        for (size_t A_Index185 = 0; A_Index185 < items185.size() + 0; A_Index185++) {
            ...
            if (Trim(A_LoopField185) == Trim(keyWordEnd_2) && SubStr(Trim(nextWordEndFixRB[A_Index185 + 1]), 1, StrLen(Trim(keyWordCatch_2) + " ")) == Trim(keyWordCatch_2) + " " || Trim(A_LoopField185) == Trim(keyWordEnd_2) && Trim(nextWordEndFixRB[A_Index185 + 1]) == Trim(keyWordFinally_2) || Trim(nextWordEndFixRB[A_Index185 + 1]) == Trim(keyWordFinally_2 + ":")) {
                nextWordEndFixOut += "";
            } else {
    ...
    if (langToConvertTo == "ahk") {
        ...
        for (size_t A_Index186 = 0; A_Index186 < items186.size() + 0; A_Index186++) {
            ...
            if (SubStr(Trim(A_LoopField186), 1, StrLen("Loop, Parse, ")) == "Loop, Parse, ") {
                nextWordEndFixOut += StrReplace(A_LoopField186, "{", Chr(10) + "{" + Chr(10)) + Chr(10);
            } else {
    ...
    if (langToConvertTo == "go") {
        ...
        for (size_t A_Index187 = 0; A_Index187 < items187.size() + 0; A_Index187++) {
            ...
            HTVM_Append(fixGoManGoIsSoAnnoyingBroooFurure, A_LoopField187);
        }
        ...
        for (size_t A_Index188 = 0; A_Index188 < items188.size() + 0; A_Index188++) {
            ...
            if (Trim(A_LoopField188) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index188 + 1]), 1, StrLen("else if ")) == "else if ") {
                fixGoManGoIsSoAnnoyingBroooSkip = 1;
                fixGoManGoIsSoAnnoyingBroooCount = 0;
                std::vector<std::string> items189 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index188 + 1]);
                ...
                for (int A_Index190 = 0; A_Index190 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index190++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
                fixGoManGoIsSoAnnoyingBrooo += fixGoManGoIsSoAnnoyingBroooCountSpaceses + "} " + Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index188 + 1]) + Chr(10);
            } else {
                if (fixGoManGoIsSoAnnoyingBroooSkip == 0) {
                    fixGoManGoIsSoAnnoyingBrooo += A_LoopField188 + Chr(10);
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (int A_Index191 = 0; A_Index191 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index191++) {
            htCode = StrReplace(htCode, "programmingBlock_InTheTranspiledLang-programmingBlock_InTheTranspiledLang-AA" + STR(A_Index191 + 1) + "AA", programmingBlock_InTheTranspiledLang[A_Index191]);
        }
    }
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (int A_Index192 = 0; A_Index192 < COUNT_programmingBlock_CPP + 0; A_Index192++) {
                htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index192 + 1) + "AA", programmingBlock_CPP[A_Index192]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CPP != 0) {
            for (int A_Index193 = 0; A_Index193 < COUNT_programmingBlock_CPP + 0; A_Index193++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index193 + 1) + "AA", keyWordCodeInTheTranspiledLangStartCPP_2 + Chr(10) + programmingBlock_CPP[A_Index193] + Chr(10) + keyWordCodeInTheTranspiledLangEndCPP_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_CPP-programmingBlock_CPP-AA" + STR(A_Index193 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (int A_Index194 = 0; A_Index194 < COUNT_programmingBlock_PY + 0; A_Index194++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index194 + 1) + "AA", programmingBlock_PY[A_Index194]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (int A_Index195 = 0; A_Index195 < COUNT_programmingBlock_PY + 0; A_Index195++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index195 + 1) + "AA", keyWordCodeInTheTranspiledLangStartPY_2 + Chr(10) + programmingBlock_PY[A_Index195] + Chr(10) + keyWordCodeInTheTranspiledLangEndPY_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index195 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (int A_Index196 = 0; A_Index196 < COUNT_programmingBlock_JS + 0; A_Index196++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index196 + 1) + "AA", programmingBlock_JS[A_Index196]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (int A_Index197 = 0; A_Index197 < COUNT_programmingBlock_JS + 0; A_Index197++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index197 + 1) + "AA", keyWordCodeInTheTranspiledLangStartJS_2 + Chr(10) + programmingBlock_JS[A_Index197] + Chr(10) + keyWordCodeInTheTranspiledLangEndJS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index197 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (int A_Index198 = 0; A_Index198 < COUNT_programmingBlock_GO + 0; A_Index198++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index198 + 1) + "AA", programmingBlock_GO[A_Index198]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (int A_Index199 = 0; A_Index199 < COUNT_programmingBlock_GO + 0; A_Index199++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index199 + 1) + "AA", keyWordCodeInTheTranspiledLangStartGO_2 + Chr(10) + programmingBlock_GO[A_Index199] + Chr(10) + keyWordCodeInTheTranspiledLangEndGO_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index199 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (int A_Index200 = 0; A_Index200 < COUNT_programmingBlock_LUA + 0; A_Index200++) {
                htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index200 + 1) + "AA", programmingBlock_LUA[A_Index200]);
            }
        }
    } else {
        if (COUNT_programmingBlock_LUA != 0) {
            for (int A_Index201 = 0; A_Index201 < COUNT_programmingBlock_LUA + 0; A_Index201++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index201 + 1) + "AA", keyWordCodeInTheTranspiledLangStartLUA_2 + Chr(10) + programmingBlock_LUA[A_Index201] + Chr(10) + keyWordCodeInTheTranspiledLangEndLUA_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_LUA-programmingBlock_LUA-AA" + STR(A_Index201 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (int A_Index202 = 0; A_Index202 < COUNT_programmingBlock_CS + 0; A_Index202++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index202 + 1) + "AA", programmingBlock_CS[A_Index202]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (int A_Index203 = 0; A_Index203 < COUNT_programmingBlock_CS + 0; A_Index203++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index203 + 1) + "AA", keyWordCodeInTheTranspiledLangStartCS_2 + Chr(10) + programmingBlock_CS[A_Index203] + Chr(10) + keyWordCodeInTheTranspiledLangEndCS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index203 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (int A_Index204 = 0; A_Index204 < COUNT_programmingBlock_JAVA + 0; A_Index204++) {
                htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index204 + 1) + "AA", programmingBlock_JAVA[A_Index204]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (int A_Index205 = 0; A_Index205 < COUNT_programmingBlock_JAVA + 0; A_Index205++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index205 + 1) + "AA", keyWordCodeInTheTranspiledLangStartJAVA_2 + Chr(10) + programmingBlock_JAVA[A_Index205] + Chr(10) + keyWordCodeInTheTranspiledLangEndJAVA_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_JAVA-programmingBlock_JAVA-AA" + STR(A_Index205 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (int A_Index206 = 0; A_Index206 < COUNT_programmingBlock_KT + 0; A_Index206++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index206 + 1) + "AA", programmingBlock_KT[A_Index206]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (int A_Index207 = 0; A_Index207 < COUNT_programmingBlock_KT + 0; A_Index207++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index207 + 1) + "AA", keyWordCodeInTheTranspiledLangStartKT_2 + Chr(10) + programmingBlock_KT[A_Index207] + Chr(10) + keyWordCodeInTheTranspiledLangEndKT_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index207 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (int A_Index208 = 0; A_Index208 < COUNT_programmingBlock_RB + 0; A_Index208++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index208 + 1) + "AA", programmingBlock_RB[A_Index208]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (int A_Index209 = 0; A_Index209 < COUNT_programmingBlock_RB + 0; A_Index209++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index209 + 1) + "AA", keyWordCodeInTheTranspiledLangStartRB_2 + Chr(10) + programmingBlock_RB[A_Index209] + Chr(10) + keyWordCodeInTheTranspiledLangEndRB_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index209 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (int A_Index210 = 0; A_Index210 < COUNT_programmingBlock_NIM + 0; A_Index210++) {
                htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index210 + 1) + "AA", programmingBlock_NIM[A_Index210]);
            }
        }
    } else {
        if (COUNT_programmingBlock_NIM != 0) {
            for (int A_Index211 = 0; A_Index211 < COUNT_programmingBlock_NIM + 0; A_Index211++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index211 + 1) + "AA", keyWordCodeInTheTranspiledLangStartNIM_2 + Chr(10) + programmingBlock_NIM[A_Index211] + Chr(10) + keyWordCodeInTheTranspiledLangEndNIM_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_NIM-programmingBlock_NIM-AA" + STR(A_Index211 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (int A_Index212 = 0; A_Index212 < COUNT_programmingBlock_AHK + 0; A_Index212++) {
                htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index212 + 1) + "AA", programmingBlock_AHK[A_Index212]);
            }
        }
    } else {
        if (COUNT_programmingBlock_AHK != 0) {
            for (int A_Index213 = 0; A_Index213 < COUNT_programmingBlock_AHK + 0; A_Index213++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index213 + 1) + "AA", keyWordCodeInTheTranspiledLangStartAHK_2 + Chr(10) + programmingBlock_AHK[A_Index213] + Chr(10) + keyWordCodeInTheTranspiledLangEndAHK_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_AHK-programmingBlock_AHK-AA" + STR(A_Index213 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (int A_Index214 = 0; A_Index214 < COUNT_programmingBlock_SWIFT + 0; A_Index214++) {
                htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index214 + 1) + "AA", programmingBlock_SWIFT[A_Index214]);
            }
        }
    } else {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (int A_Index215 = 0; A_Index215 < COUNT_programmingBlock_SWIFT + 0; A_Index215++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index215 + 1) + "AA", keyWordCodeInTheTranspiledLangStartSWIFT_2 + Chr(10) + programmingBlock_SWIFT[A_Index215] + Chr(10) + keyWordCodeInTheTranspiledLangEndSWIFT_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_SWIFT-programmingBlock_SWIFT-AA" + STR(A_Index215 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (int A_Index216 = 0; A_Index216 < COUNT_programmingBlock_DART + 0; A_Index216++) {
                htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index216 + 1) + "AA", programmingBlock_DART[A_Index216]);
            }
        }
    } else {
        if (COUNT_programmingBlock_DART != 0) {
            for (int A_Index217 = 0; A_Index217 < COUNT_programmingBlock_DART + 0; A_Index217++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index217 + 1) + "AA", keyWordCodeInTheTranspiledLangStartDART_2 + Chr(10) + programmingBlock_DART[A_Index217] + Chr(10) + keyWordCodeInTheTranspiledLangEndDART_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_DART-programmingBlock_DART-AA" + STR(A_Index217 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (int A_Index218 = 0; A_Index218 < COUNT_programmingBlock_TS + 0; A_Index218++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index218 + 1) + "AA", programmingBlock_TS[A_Index218]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (int A_Index219 = 0; A_Index219 < COUNT_programmingBlock_TS + 0; A_Index219++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index219 + 1) + "AA", keyWordCodeInTheTranspiledLangStartTS_2 + Chr(10) + programmingBlock_TS[A_Index219] + Chr(10) + keyWordCodeInTheTranspiledLangEndTS_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index219 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (int A_Index220 = 0; A_Index220 < COUNT_programmingBlock_GROOVY + 0; A_Index220++) {
                htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index220 + 1) + "AA", programmingBlock_GROOVY[A_Index220]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (int A_Index221 = 0; A_Index221 < COUNT_programmingBlock_GROOVY + 0; A_Index221++) {
                if (langToConvertTo == langFileExtension_2) {
                    htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index221 + 1) + "AA", keyWordCodeInTheTranspiledLangStartGROOVY_2 + Chr(10) + programmingBlock_GROOVY[A_Index221] + Chr(10) + keyWordCodeInTheTranspiledLangEndGROOVY_2);
                } else {
                    htCode = StrReplace(htCode, "programmingBlock_GROOVY-programmingBlock_GROOVY-AA" + STR(A_Index221 + 1) + "AA", Chr(10));
                }
            }
        }
    }
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (int A_Index222 = 0; A_Index222 < COUNT_programmingBlock_HTVM + 0; A_Index222++) {
                htCode = StrReplace(htCode, "programmingBlock_HTVM-programmingBlock_HTVM-AA" + STR(A_Index222 + 1) + "AA", programmingBlock_HTVM[A_Index222]);
            }
        }
    } else {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (int A_Index223 = 0; A_Index223 < COUNT_programmingBlock_HTVM + 0; A_Index223++) {
                htCode = StrReplace(htCode, "programmingBlock_HTVM-programmingBlock_HTVM-AA" + STR(A_Index223 + 1) + "AA", Chr(10));
            }
        }
    }
    ...
    for (size_t A_Index224 = 0; A_Index224 < items224.size() + 0; A_Index224++) {
        ...
        if (areWeInAFuncFromInstructions == 1) {
            if (areWeInAFuncFromInstructionsLineNum == 1) {
                // name of the func
                funcLangHolder = StringTrimLeft(A_LoopField224, 5);
            ...
            if (areWeInAFuncFromInstructionsLineNum == 2) {
                // name of the func
                funcNameHolder = StringTrimLeft(A_LoopField224, 5);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
            ...
            if (areWeInAFuncFromInstructionsLineNum == 3) {
                // all libs
                funcLibsHolder = StringTrimLeft(A_LoopField224, 5);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
            ...
            if (areWeInAFuncFromInstructionsLineNum == 4) {
                // func description
                funcDescriptionHolder = StringTrimLeft(A_LoopField224, 12);
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
            ...
            if (areWeInAFuncFromInstructionsLineNum >= 5) {
                // the full func
                if (correctLang == 1 && InStr(htCode, Trim(funcNameHolder))) {
                    funcFuncHolder += A_LoopField224 + Chr(10);
                }
            }
            //MsgBox, % A_LoopField224
            areWeInAFuncFromInstructionsLineNum++;
        }
        if (Trim(A_LoopField224) == "func======================func==============") {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (int A_Index225 = 0; A_Index225 < HTVM_Size(allFuncNames) + 0; A_Index225++) {
            if (InStr(htCode, allFuncNames[A_Index225]) + "(") {
                //MsgBox, % allFuncNames[A_Index225]
                allFuncsToPutAtTop += allFuncs[A_Index225] + Chr(10);
                if (Trim(allFuncLibs[A_Index225]) != "null") {
                    allLibsToPutAtTop += allFuncLibs[A_Index225] + "|";
                }
            }
        }
        allLibsToPutAtTop = StringTrimRight(allLibsToPutAtTop, 1);
        std::string allLibsToPutAtTopTEMP = "";
        std::vector<std::string> items226 = LoopParseFunc(allLibsToPutAtTop, "|");
        for (size_t A_Index226 = 0; A_Index226 < items226.size() + 0; A_Index226++) {
            std::string A_LoopField226 = items226[A_Index226 - 0];
            allLibsToPutAtTopTEMP += A_LoopField226 + Chr(10);
        }
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (int A_Index227 = 0; A_Index227 < HTVM_Size(ospDic1) + 0; A_Index227++) {
            str00 = ospDic1[A_Index227];
            if (langToConvertTo == "rb") {
    ...
    if (size_ospDic != 0) {
        for (int A_Index228 = 0; A_Index228 < size_ospDic + 0; A_Index228++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (int A_Index229 = 0; A_Index229 < size_ospDic1 + 0; A_Index229++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (int A_Index230 = 0; A_Index230 < size_ospDic2 + 0; A_Index230++) {
            HTVM_Pop(ospDic2);
        }
    }
    availableFuncsInHTVMInHTVM = "";
    ...
    for (int A_Index231 = 0; A_Index231 < theIdNumOfThe34 + 0; A_Index231++) {
        if (theIdNumOfThe34 == A_Index231 + 1) {
            if (langToConvertTo == langFileExtension_2) {
                if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index231 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(theIdNumOfThe34theVar[A_Index231 + 1], "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                } else {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index231 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index231 + 1], keyWordEscpaeChar, keyWordEscpaeChar_2) + Chr(34));
                }
            } else {
                htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index231 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index231 + 1], keyWordEscpaeChar, "\\") + Chr(34));
            }
        } else {
            if (langToConvertTo == langFileExtension_2) {
                if (keyWordEscpaeChar_2 == "\\" && keyWordEscpaeChar != "\\") {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index231 + 1) + Chr(65) + Chr(65), StrReplace(StrReplace(theIdNumOfThe34theVar[A_Index231 + 1], "\\", "\\\\"), keyWordEscpaeChar, keyWordEscpaeChar_2));
                } else {
                    htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index231 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index231 + 1], keyWordEscpaeChar, keyWordEscpaeChar_2));
                }
            } else {
                htCode = StrReplace(htCode, "ihuiuuhuuhtheidFor--asds" + str21 + "as--" + str21 + "theuhturtyphoutr--" + Chr(65) + Chr(65) + STR(A_Index231 + 1) + Chr(65) + Chr(65), StrReplace(theIdNumOfThe34theVar[A_Index231 + 1], keyWordEscpaeChar, "\\"));
            }
        }
    }
    if (langToConvertTo == langFileExtension_2) {
...
void HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        std::vector<std::string> items233 = LoopParseFunc(allArgs, "\n", "\r");
        for (size_t A_Index233 = 0; A_Index233 < items233.size() + 0; A_Index233++) {
            std::string A_LoopField233 = items233[A_Index233 - 0];
            if (A_Index233 == 0) {
                numOfParams++;
                argCODE = FileRead(Trim(A_LoopField233));
                argCODEfile = Trim(A_LoopField233);
            }
            else if (A_Index233 == 1) {
                numOfParams++;
                argHTVMinstr = Trim(A_LoopField233);
            }
            else if (A_Index233 == 2) {
                numOfParams++;
                argLangTo = Trim(A_LoopField233);
            } else {
                numOfParams++;
                HTVM_Append(argHTVMinstrMORE, Trim(A_LoopField233));
            }
        }
        //print("===============123431234===========start=====")
        for (int A_Index234 = 0; A_Index234 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index234++) {
            //print(argHTVMinstrMORE[A_Index234])
        }
        //print("===============123431234==========end======")
