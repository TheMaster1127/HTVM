...
for A_Index1 = 0 + 1 , 5 + 0 do
    if (A_Index1 == 0) then
        print(A_Index1)
    elseif (A_Index1 == 1) then
        print(A_Index1)
    elseif (A_Index1 == 2) then
        print(A_Index1)
    elseif (A_Index1 == 3) then
        print(A_Index1)
    elseif (A_Index1 == 4) then
        print(A_Index1)
    elseif (A_Index1 == 5) then
        print(A_Index1)
    else
        print("HOW????")
        print(A_Index1)
...
print(idx1)
HTVM_Pop(arr1)
for A_Index5 = 0 + 1 , HTVM_Size(arr1) + 0 do
    print(arr1[A_Index5])
end
...
print(idx2)
HTVM_Pop(arr2)
for A_Index6 = 0 + 1 , HTVM_Size(arr2) + 0 do
    print(arr2[A_Index6])
end
...
print(idx3)
HTVM_Pop(arr3)
for A_Index7 = 0 + 1 , HTVM_Size(arr3) + 0 do
    print(arr3[A_Index7])
end
HTVM_Append(arr4, 69)
...
print(idx4)
HTVM_Pop(arr4)
for A_Index8 = 0 + 1 , HTVM_Size(arr4) + 0 do
    print(arr4[A_Index8])
end
...
print(idx5)
HTVM_Pop(arr5)
for A_Index9 = 0 + 1 , HTVM_Size(arr5) + 0 do
    print(arr5[A_Index9])
end
--[[
keyWordThrow
