...
int allVarsSoWeDontReDecVars_FIX_TOGGLE = ;
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
std::string KeyWordsCommands(std::string theCodeCommands, std::string mode, std::string keyWordsCommands, std::string langToConvertTo) {
    ...
    if (mode == "transpile") {
        ...
        int theCodeCommandNum = ;
        int outConstuctTheOutFromTheCommandsLineTranspile = ;
        ...
        for (size_t A_Index11 = 0; A_Index11 < items11.size() + 0; A_Index11++) {
            ...
            theCodeCommand.add(Trim(A_LoopField11));
                ...
                for (size_t A_Index13 = 0; A_Index13 < items13.size() + 0; A_Index13++) {
                    ...
                    if (A_Index13 == 0) {
                        ...
                        if (A_LoopField13 == "lineTranspile") {
                            outConstuctTheOutFromTheCommandsLineTranspile = ;
                        }
...
std::string arrayParserTranspiler1(std::string line, std::string arrayMethodStr, int mode) {
    ...
    //;;;;;;;;;;;;;;;;;;
    int foundFirstParenthesis = ;
    int ParenthesisStackOPEN = ;
    int ParenthesisStackCLOSE = ;
...
std::string expressionParserTranspiler(std::string expression) {
    ...
    int fixExpertionLineFuncOnlyTEXT_numDelete = ;
    ...
    for (int A_Index68 = 0; A_Index68 < 29 + 0; A_Index68++) {
        if (InStr(expression, fullLangAllOperators_HELP[A_Index68])) {
            if (A_Index68 == 0 || A_Index68 == 1 || A_Index68 == 2)  ; Changed 'and' to 'or' to check for any of these indexes {
...
std::string compiler(std::string htCode, std::string allInstructionFile, std::string mode, std::string langToConvertToParam = "") {
    ...
    */
    ...
    int haveWeEverUsedAloop = ;
    int lineDone = ;
    str var1 = "";
    str nothing = "";
    int AindexcharLength = ;
    str AindexcharLengthStr = "";
    str theFixTextLoopNL = "";
    int htCodeAcurlyBraceAddSomeVrasFixNL = ;
    str htCodeLoopfixa = "";
    str htCodeLoopfixa1 = "";
    str str123 = "";
    str out2 = "";
    ...
    int htCodeAcurlyBraceAddSomeVrasFixLP = ;
    int AIndexLoopCurlyFix = ;
    str sstr123 = "";
    str fixLoopLokingFor = "";
    int fixLoopLokingForfound = ;
    str out1 = "";
    int wasAtanyIfsElseAddAIndexLoopCurlyFix = ;
    int inTarget = ;
    int insideBracket = ;
    int netsedCurly = ;
    int eldLoopNestedBADlol = ;
    int readyToEnd = ;
    int endBracketDOntPutThere = ;
    int dontSaveStr = ;
    int weAreDoneHereCurly = ;
    int DeleayOneCuzOfLoopParse = ;
    int fixLoopLokingForNum = ;
    int insdeAnestedLoopBAD = ;
    int foundTheTopLoop = ;
    ...
    int doseCodeHaveLibs = ;
    int doseCodeHaveLibs_HAS_SEEN = ;
    int doseCodeHaveLibs_HAS_SEEN2 = ;
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
                ...
                for (int A_Index71 = 0; A_Index71 < 10000 + 0; A_Index71++) {
                    ...
                    if (A_Index71 == 0) {
                        ...
                        for (size_t A_Index72 = 0; A_Index72 < items72.size() + 0; A_Index72++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField72)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                allLibsWeSee.add(StrReplace(StringTrimLeft(Trim(A_LoopField72), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                allLibsWeSeeSEE.add(StrReplace(StringTrimLeft(Trim(A_LoopField72), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                doseCodeHaveLibs = ;
                            }
                        }
                    } else {
                        ...
                        for (size_t A_Index73 = 0; A_Index73 < items73.size() + 0; A_Index73++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField73)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                ...
                                if (doseCodeHaveLibs_HAS_SEEN == 0) {
                                    allLibsWeSee.add(StrReplace(StringTrimLeft(Trim(A_LoopField73), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                    allLibsWeSeeSEE.add(StrReplace(StringTrimLeft(Trim(A_LoopField73), StrLen(StrLower(keyWordInclude) + " ")), Chr(34), ""));
                                    doseCodeHaveLibs = ;
                                }
                            }
                        }
                    ...
                    for (int A_Index75 = 0; A_Index75 < HTVM_Size(allLibsWeSee) + 0; A_Index75++) {
                        ...
                        if (doseCodeHaveLibs_HAS_SEEN2 == 0) {
                            allLibCODE += FileRead(Trim(allLibsWeSee[HTVM_Size(allLibsWeSee) - A_Index75 - 1])) + "\n";
                        }
                        allLibsWeSee.pop();
                    }
                    allLibCODEfix = "";
    ...
    // PROGRAMMING BLOCK
    // PROGRAMMING BLOCK
    int COUNT_programmingBlock_InTheTranspiledLang = ;
    int COUNT_programmingBlock_CPP = ;
    int COUNT_programmingBlock_PY = ;
    int COUNT_programmingBlock_JS = ;
    int COUNT_programmingBlock_GO = ;
    int COUNT_programmingBlock_LUA = ;
    int COUNT_programmingBlock_CS = ;
    int COUNT_programmingBlock_JAVA = ;
    int COUNT_programmingBlock_KT = ;
    int COUNT_programmingBlock_RB = ;
    int COUNT_programmingBlock_NIM = ;
    int COUNT_programmingBlock_AHK = ;
    int COUNT_programmingBlock_SWIFT = ;
    int COUNT_programmingBlock_DART = ;
    int COUNT_programmingBlock_TS = ;
    int COUNT_programmingBlock_GROOVY = ;
    int COUNT_programmingBlock_HTVM = ;
    int COUNT_programmingBlock_HTVMsyntax = ;
    str programmingBlocksTemp = "";
    int inProgarmmingBlock = ;
    ...
    int didWeUseMainLabel = ;
    str codeOutFixAndAddMainFunc = "";
    str htCodeOutFixEnd = "";
    int htCodeOutFixINT = ;
    int htCodeOutFixINT2 = ;
    ...
    int fixOutFixDoubleQuotesInsideDoubleQuotesFIXok = ;
    str htCodeOUT754754 = "";
    int areWEinSome34sNum = ;
    int theIdNumOfThe34 = ;
    ...
    int removeNexFixkeyWordEscpaeChar = ;
    if (isNotHTVMfile == 0) {
        ...
        for (size_t A_Index81 = 0; A_Index81 < items81.size() + 0; A_Index81++) {
            ...
            getAllCharForTheFurtureSoIcanAddEscapeChar.add(A_LoopField81);
        }
        getAllCharForTheFurtureSoIcanAddEscapeChar.add(" ");
        ReplaceFixWhitOutFixDoubleQuotesInsideDoubleQuotes = Chr(34) + \" + Chr(34);
        ...
        for (size_t A_Index82 = 0; A_Index82 < items82.size() + 0; A_Index82++) {
            ...
            if (A_LoopField82 == keyWordEscpaeChar && getAllCharForTheFurtureSoIcanAddEscapeChar[A_Index82 + 1] == Chr(34)) {
                fixOutFixDoubleQuotesInsideDoubleQuotesFIXok = ;
        ...
        for (size_t A_Index99 = 0; A_Index99 < items99.size() + 0; A_Index99++) {
            ...
            lookIntoTheNextLineForFuncWhitNoKeyWord.add(A_LoopField99);
        }
        ...
        for (size_t A_Index100 = 0; A_Index100 < items100.size() + 0; A_Index100++) {
            ...
            if (SubStr(A_LoopField100, 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                htCodeAcurlyBraceAddSomeVrasFixNL = ;
                lineDone = ;
                ...
                htCodeAcurlyBraceAddSomeVrasFixLP = ;
                haveWeEverUsedAloop = ;
                if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
                ...
                lineDone = ;
                allVarsSoWeDontReDecVars_FIX_TOGGLE = ;
                //keyWordAssign
                //keyWordAssignAdd
                //keyWordAssignConcat
                //keyWordAssignSub
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                for (size_t A_Index125 = 0; A_Index125 < items125.size() + 0; A_Index125++) {
                    ...
                    fixLoopLokingForfound = ;
                    out1 = StrSplit(sstr123 ,"|" , 1);
                    out2 = StrSplit(sstr123 ,"|" , 3);
                    //OutputDebug, |%out1%|
                    //OutputDebug, |%out2%|
                    wasAtanyIfsElseAddAIndexLoopCurlyFix = ;
                    if (out1 == "nl") {
                        inTarget = ;
                        insideBracket = ;
                        netsedCurly = ;
                        eldLoopNestedBADlol = ;
                        readyToEnd = ;
                        endBracketDOntPutThere = ;
                        dontSaveStr = ;
                        weAreDoneHereCurly = ;
                        DeleayOneCuzOfLoopParse = ;
                        fixLoopLokingForNum = ;
                        insdeAnestedLoopBAD = ;
                        foundTheTopLoop = ;
    ...
    if (langToConvertTo == "lua" || langToConvertTo == "rb") {
        ...
        for (size_t A_Index134 = 0; A_Index134 < items134.size() + 0; A_Index134++) {
            ...
            nextWordEndFix.add(A_LoopField134);
        }
        nextWordEndFix.add(" ");
    ...
    if (langToConvertTo == "rb") {
        ...
        for (size_t A_Index136 = 0; A_Index136 < items136.size() + 0; A_Index136++) {
            ...
            nextWordEndFixRB.add(A_LoopField136);
        }
    ...
    if (langToConvertTo == "go") {
        ...
        for (size_t A_Index140 = 0; A_Index140 < items140.size() + 0; A_Index140++) {
            ...
            fixGoManGoIsSoAnnoyingBroooFurure.add(A_LoopField140);
        }
        fixGoManGoIsSoAnnoyingBroooFurure.add(" ");
        int fixGoManGoIsSoAnnoyingBroooSkip = ;
        int fixGoManGoIsSoAnnoyingBroooCount = ;
        ...
        for (size_t A_Index141 = 0; A_Index141 < items141.size() + 0; A_Index141++) {
            ...
            if (Trim(A_LoopField141) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index141 + 1]), 1, StrLen("else if ")) == "else if ") {
                fixGoManGoIsSoAnnoyingBroooSkip = ;
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        for (size_t A_Index182 = 0; A_Index182 < items182.size() + 0; A_Index182++) {
            ...
            if (A_Index182 == 0) {
                ...
                numOfParams++;
                argHTVMinstrMORE.add(Trim(A_LoopField182));
            }
        }
