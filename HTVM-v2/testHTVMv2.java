...
public static void main(String[] args) {
    ...
    for (int A_IndexA4 = 0; A_IndexA4 < items4.length + 0; A_IndexA4++) {
    ...
    for (int A_IndexA5 = 0; A_IndexA5 < items5.length + 0; A_IndexA5++) {
    ...
    for (int A_IndexA6 = 0; A_IndexA6 < items6.length + 0; A_IndexA6++) {
