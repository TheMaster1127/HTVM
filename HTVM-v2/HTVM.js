...
async function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    */
    ...
    for (let A_Index60 = 0; A_Index60 < 2 + 0; A_Index60++) {
        outCodeFixBraces = "";
    ...
    for (let A_Index64 = 0; A_Index64 < items64.length + 0; A_Index64++) {
        ...
        lookIntoTheNextLineForFuncWhitNoKeyWord.push(A_LoopField64);
    }
    ...
    if (langToConvertTo != "ahk") {
        ...
        if (haveWeEverUsedAloop == 1) {
            ...
            items66 = LoopParseFunc(htCodeLoopfixa, "\n", "\r")
    ...
    var correctLang = 0;
    items72 = LoopParseFunc(instructions, "\n", "\r")
    ...
    if (!(allFuncNames.length <= 0)) {
        for (let A_Index73 = 0; A_Index73 < allFuncNames.length + 0; A_Index73++) {
        ...
        items74 = LoopParseFunc(allLibsToPutAtTop, "|")
    ...
    for (let A_Index75 = 0; A_Index75 < theIdNumOfThe34 + 0; A_Index75++) {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        for (let A_Index77 = 0; A_Index77 < items77.length + 0; A_Index77++) {
            ...
            if (A_Index77 == 0) {
                ...
                argHTVMinstrMOVE.push(Trim(A_LoopField77));
            }
        }
