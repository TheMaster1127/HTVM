...
function expressionParserTranspiler(expression) {
    ...
    // osp
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index84 = 0; A_Index84 < HTVM_Size(ospDic1) + 0; A_Index84++) {
            str00 = ospDic1[A_Index84];
            expression = StrReplace(expression, StrReplace(str00, "_", ".") + ".", str00 + "_");
        }
        for (let A_Index85 = 0; A_Index85 < HTVM_Size(ospDic2) + 0; A_Index85++) {
    ...
    for (let A_Index86 = 0; A_Index86 < 29 + 0; A_Index86++) {
...
function FixRubyGlobalVars(line) {
    ...
    for (let A_Index88 = 0; A_Index88 < HTVM_Size(htCodeFixRubyGlobalVars) + 0; A_Index88++) {
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    */
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index221 = 0; A_Index221 < HTVM_Size(ospDic1) + 0; A_Index221++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index222 = 0; A_Index222 < size_ospDic + 0; A_Index222++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index223 = 0; A_Index223 < size_ospDic1 + 0; A_Index223++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index224 = 0; A_Index224 < size_ospDic2 + 0; A_Index224++) {
            HTVM_Pop(ospDic2);
        }
    }
    if (langToConvertTo == "rb") {
    ...
    for (let A_Index225 = 0; A_Index225 < theIdNumOfThe34 + 0; A_Index225++) {
...
function HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        items227 = LoopParseFunc(allArgs, "\n", "\r")
        ...
        for (let A_Index228 = 0; A_Index228 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index228++) {
