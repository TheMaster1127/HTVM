...
function fixIfElseIfMultiLineStatement(someHTVMcode) {
    ...
    for (let A_Index106 = 0; A_Index106 < 2147483000 + 0; A_Index106++) {
        out2 = out;
        out = "";
        doWeExit = false;
        items107 = LoopParseFunc(out2, "\n", "\r")
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    items108 = LoopParseFunc(allInstructionFile, "\n", "\r")
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        items109 = LoopParseFunc(allInstructionFile_2, "\n", "\r")
    ...
    */
    ...
    items110 = LoopParseFunc(allInstructionFile, "\n", "\r")
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            if (InStr(StrLower(code), StrLower(keyWordInclude + " "))) {
                for (let A_Index112 = 0; A_Index112 < 10000 + 0; A_Index112++) {
                    doseCodeHaveLibs = 0;
                    allLibCODE = "";
                    if (A_Index112 == 0) {
                    ...
                    for (let A_Index116 = 0; A_Index116 < HTVM_Size(allLibsWeSee) + 0; A_Index116++) {
                        ...
                        for (let A_Index117 = 0; A_Index117 < HTVM_Size(allLibsWeSeeSEE) - HTVM_Size(allLibsWeSee) + 0; A_Index117++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index124 = 0; A_Index124 < theIdNumOfThe34 + 0; A_Index124++) {
        ...
        for (let A_Index125 = 0; A_Index125 < items125.length + 0; A_Index125++) {
            ...
            if (InStr(A_LoopField125, " " + keyWordComment) != false && SubStr(Trim(A_LoopField125), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index126 = 0; A_Index126 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index126++) {
                    slidingWinFixCommentsRmI = A_Index126;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index127 = 0; A_Index127 < StrLen(" " + keyWordComment) + 0; A_Index127++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (let A_Index130 = 0; A_Index130 < items130.length + 0; A_Index130++) {
                    ...
                    htCodeOutFixINT--;
                    items132 = LoopParseFunc(A_LoopField130, " ")
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index133 = 0; A_Index133 < items133.length + 0; A_Index133++) {
                    ...
                    items134 = LoopParseFunc(A_LoopField133, " ")
        ...
        for (let A_Index138 = 0; A_Index138 < 2 + 0; A_Index138++) {
            outCodeFixBraces = "";
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                items172 = LoopParseFunc(htCodeLoopfixa, "\n", "\r")
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index194 = 0; A_Index194 < items194.length + 0; A_Index194++) {
            ...
            if (Trim(A_LoopField194) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index194 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                items195 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index194 + 1])
                ...
                for (let A_Index196 = 0; A_Index196 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index196++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index197 = 0; A_Index197 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index197++) {
