...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    */
    ...
    var correctLang = 0;
    items232 = LoopParseFunc(instructions, "\n", "\r")
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index233 = 0; A_Index233 < HTVM_Size(allFuncNames) + 0; A_Index233++) {
        ...
        items234 = LoopParseFunc(allLibsToPutAtTop, "|")
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index235 = 0; A_Index235 < HTVM_Size(ospDic1) + 0; A_Index235++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index236 = 0; A_Index236 < size_ospDic + 0; A_Index236++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index237 = 0; A_Index237 < size_ospDic1 + 0; A_Index237++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index238 = 0; A_Index238 < size_ospDic2 + 0; A_Index238++) {
            HTVM_Pop(ospDic2);
        }
    }
    availableFuncsInHTVMInHTVM = "";
    ...
    for (let A_Index239 = 0; A_Index239 < theIdNumOfThe34 + 0; A_Index239++) {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == langFileExtension_2) {
            for (let A_Index240 = 0; A_Index240 < HTVM_Size(weAreInMLSarr) + 0; A_Index240++) {
    ...
    if (size_weAreInMLSarr != 0) {
        for (let A_Index241 = 0; A_Index241 < size_weAreInMLSarr + 0; A_Index241++) {
...
function HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        items243 = LoopParseFunc(allArgs, "\n", "\r")
        ...
        for (let A_Index244 = 0; A_Index244 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index244++) {
