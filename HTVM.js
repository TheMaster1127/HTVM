...
function splitFunctionCalls(line) {
    ...
    var arrToStrSTR = "";
    for (let A_Index77 = 0; A_Index77 < HTVM_Size(funcCalls) + 0; A_Index77++) {
    ...
    if (doWeAddParentisiesLater != 0) {
        for (let A_Index78 = 0; A_Index78 < doWeAddParentisiesLater + 0; A_Index78++) {
            arrToStrSTR = "(" + arrToStrSTR + ")";
        }
    }
    if (doseBracketsExist == 1) {
        for (let A_Index79 = 0; A_Index79 < HTVM_Size(saveDoseBracketsExist) + 0; A_Index79++) {
...
function extraFlexableFuncCalls(line) {
    var out = line;
...
function expressionParserTranspiler(expression) {
    ...
    // osp
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index80 = 0; A_Index80 < HTVM_Size(ospDic1) + 0; A_Index80++) {
            str00 = ospDic1[A_Index80];
            expression = StrReplace(expression, StrReplace(str00, "_", ".") + ".", str00 + "_");
        }
        for (let A_Index81 = 0; A_Index81 < HTVM_Size(ospDic2) + 0; A_Index81++) {
    ...
    for (let A_Index82 = 0; A_Index82 < 29 + 0; A_Index82++) {
...
function FixRubyGlobalVars(line) {
    ...
    for (let A_Index84 = 0; A_Index84 < HTVM_Size(htCodeFixRubyGlobalVars) + 0; A_Index84++) {
...
function slidingWinFixCommentsRmFUNC(line) {
    ...
    for (let A_Index94 = 0; A_Index94 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index94++) {
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    items95 = LoopParseFunc(allInstructionFile, "\n", "\r")
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        items96 = LoopParseFunc(allInstructionFile_2, "\n", "\r")
    ...
    */
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            if (InStr(StrLower(code), StrLower(keyWordInclude + " "))) {
                for (let A_Index98 = 0; A_Index98 < 10000 + 0; A_Index98++) {
                    doseCodeHaveLibs = 0;
                    allLibCODE = "";
                    if (A_Index98 == 0) {
                        ...
                        for (let A_Index100 = 0; A_Index100 < items100.length + 0; A_Index100++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField100)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                ...
                                for (let A_Index101 = 0; A_Index101 < HTVM_Size(allLibsWeSee) + 0; A_Index101++) {
                    ...
                    for (let A_Index102 = 0; A_Index102 < HTVM_Size(allLibsWeSee) + 0; A_Index102++) {
                        allLibsWeSeeHOLD = allLibsWeSee[A_Index102];
                        doseCodeHaveLibs_HAS_SEEN2 = 0;
                        for (let A_Index103 = 0; A_Index103 < HTVM_Size(allLibsWeSeeSEE) - HTVM_Size(allLibsWeSee) + 0; A_Index103++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index110 = 0; A_Index110 < theIdNumOfThe34 + 0; A_Index110++) {
        ...
        for (let A_Index111 = 0; A_Index111 < items111.length + 0; A_Index111++) {
            ...
            if (InStr(A_LoopField111, " " + keyWordComment) != false && SubStr(Trim(A_LoopField111), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index112 = 0; A_Index112 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index112++) {
                    slidingWinFixCommentsRmI = A_Index112;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index113 = 0; A_Index113 < StrLen(" " + keyWordComment) + 0; A_Index113++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index117 = 0; A_Index117 < items117.length + 0; A_Index117++) {
                    ...
                    items118 = LoopParseFunc(A_LoopField117, " ")
        ...
        for (let A_Index122 = 0; A_Index122 < 2 + 0; A_Index122++) {
            outCodeFixBraces = "";
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                items156 = LoopParseFunc(htCodeLoopfixa, "\n", "\r")
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (let A_Index161 = 0; A_Index161 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index161++) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index162 = 0; A_Index162 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index162++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index178 = 0; A_Index178 < items178.length + 0; A_Index178++) {
            ...
            if (Trim(A_LoopField178) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index178 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                items179 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index178 + 1])
                ...
                for (let A_Index180 = 0; A_Index180 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index180++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index181 = 0; A_Index181 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index181++) {
    ...
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index182 = 0; A_Index182 < COUNT_programmingBlock_CPP + 0; A_Index182++) {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index183 = 0; A_Index183 < COUNT_programmingBlock_CPP + 0; A_Index183++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index184 = 0; A_Index184 < COUNT_programmingBlock_PY + 0; A_Index184++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index184 + 1) + "AA", programmingBlock_PY[A_Index184]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index185 = 0; A_Index185 < COUNT_programmingBlock_PY + 0; A_Index185++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index186 = 0; A_Index186 < COUNT_programmingBlock_JS + 0; A_Index186++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index186 + 1) + "AA", programmingBlock_JS[A_Index186]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index187 = 0; A_Index187 < COUNT_programmingBlock_JS + 0; A_Index187++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index188 = 0; A_Index188 < COUNT_programmingBlock_GO + 0; A_Index188++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index188 + 1) + "AA", programmingBlock_GO[A_Index188]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index189 = 0; A_Index189 < COUNT_programmingBlock_GO + 0; A_Index189++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index190 = 0; A_Index190 < COUNT_programmingBlock_LUA + 0; A_Index190++) {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index191 = 0; A_Index191 < COUNT_programmingBlock_LUA + 0; A_Index191++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index192 = 0; A_Index192 < COUNT_programmingBlock_CS + 0; A_Index192++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index192 + 1) + "AA", programmingBlock_CS[A_Index192]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index193 = 0; A_Index193 < COUNT_programmingBlock_CS + 0; A_Index193++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index194 = 0; A_Index194 < COUNT_programmingBlock_JAVA + 0; A_Index194++) {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index195 = 0; A_Index195 < COUNT_programmingBlock_JAVA + 0; A_Index195++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index196 = 0; A_Index196 < COUNT_programmingBlock_KT + 0; A_Index196++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index196 + 1) + "AA", programmingBlock_KT[A_Index196]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index197 = 0; A_Index197 < COUNT_programmingBlock_KT + 0; A_Index197++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index198 = 0; A_Index198 < COUNT_programmingBlock_RB + 0; A_Index198++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index198 + 1) + "AA", programmingBlock_RB[A_Index198]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index199 = 0; A_Index199 < COUNT_programmingBlock_RB + 0; A_Index199++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index200 = 0; A_Index200 < COUNT_programmingBlock_NIM + 0; A_Index200++) {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index201 = 0; A_Index201 < COUNT_programmingBlock_NIM + 0; A_Index201++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index202 = 0; A_Index202 < COUNT_programmingBlock_AHK + 0; A_Index202++) {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index203 = 0; A_Index203 < COUNT_programmingBlock_AHK + 0; A_Index203++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index204 = 0; A_Index204 < COUNT_programmingBlock_SWIFT + 0; A_Index204++) {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index205 = 0; A_Index205 < COUNT_programmingBlock_SWIFT + 0; A_Index205++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index206 = 0; A_Index206 < COUNT_programmingBlock_DART + 0; A_Index206++) {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index207 = 0; A_Index207 < COUNT_programmingBlock_DART + 0; A_Index207++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index208 = 0; A_Index208 < COUNT_programmingBlock_TS + 0; A_Index208++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index208 + 1) + "AA", programmingBlock_TS[A_Index208]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index209 = 0; A_Index209 < COUNT_programmingBlock_TS + 0; A_Index209++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index210 = 0; A_Index210 < COUNT_programmingBlock_GROOVY + 0; A_Index210++) {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index211 = 0; A_Index211 < COUNT_programmingBlock_GROOVY + 0; A_Index211++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index212 = 0; A_Index212 < COUNT_programmingBlock_HTVM + 0; A_Index212++) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index213 = 0; A_Index213 < COUNT_programmingBlock_HTVM + 0; A_Index213++) {
    ...
    var correctLang = 0;
    items214 = LoopParseFunc(instructions, "\n", "\r")
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index215 = 0; A_Index215 < HTVM_Size(allFuncNames) + 0; A_Index215++) {
        ...
        items216 = LoopParseFunc(allLibsToPutAtTop, "|")
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index217 = 0; A_Index217 < HTVM_Size(ospDic1) + 0; A_Index217++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index218 = 0; A_Index218 < size_ospDic + 0; A_Index218++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index219 = 0; A_Index219 < size_ospDic1 + 0; A_Index219++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index220 = 0; A_Index220 < size_ospDic2 + 0; A_Index220++) {
            HTVM_Pop(ospDic2);
        }
    }
    if (langToConvertTo == "rb") {
    ...
    for (let A_Index221 = 0; A_Index221 < theIdNumOfThe34 + 0; A_Index221++) {
...
function HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        items223 = LoopParseFunc(allArgs, "\n", "\r")
        ...
        for (let A_Index224 = 0; A_Index224 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index224++) {
