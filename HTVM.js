...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    items97 = LoopParseFunc(allInstructionFile, "\n", "\r")
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        items98 = LoopParseFunc(allInstructionFile_2, "\n", "\r")
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            if (InStr(StrLower(code), StrLower(keyWordInclude + " "))) {
                for (let A_Index100 = 0; A_Index100 < 10000 + 0; A_Index100++) {
                    doseCodeHaveLibs = 0;
                    allLibCODE = "";
                    if (A_Index100 == 0) {
                        ...
                        for (let A_Index102 = 0; A_Index102 < items102.length + 0; A_Index102++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField102)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                ...
                                for (let A_Index103 = 0; A_Index103 < HTVM_Size(allLibsWeSee) + 0; A_Index103++) {
                    ...
                    for (let A_Index104 = 0; A_Index104 < HTVM_Size(allLibsWeSee) + 0; A_Index104++) {
                        allLibsWeSeeHOLD = allLibsWeSee[A_Index104];
                        doseCodeHaveLibs_HAS_SEEN2 = 0;
                        for (let A_Index105 = 0; A_Index105 < HTVM_Size(allLibsWeSeeSEE) - HTVM_Size(allLibsWeSee) + 0; A_Index105++) {
