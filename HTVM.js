...
function splitFunctionCalls(line) {
    ...
    var arrToStrSTR = "";
    for (let A_Index76 = 0; A_Index76 < HTVM_Size(funcCalls) + 0; A_Index76++) {
    ...
    if (doWeAddParentisiesLater != 0) {
        for (let A_Index77 = 0; A_Index77 < doWeAddParentisiesLater + 0; A_Index77++) {
...
function expressionParserTranspiler(expression) {
    ...
    // osp
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index78 = 0; A_Index78 < HTVM_Size(ospDic1) + 0; A_Index78++) {
            str00 = ospDic1[A_Index78];
            expression = StrReplace(expression, StrReplace(str00, "_", ".") + ".", str00 + "_");
        }
        for (let A_Index79 = 0; A_Index79 < HTVM_Size(ospDic2) + 0; A_Index79++) {
    ...
    for (let A_Index80 = 0; A_Index80 < 29 + 0; A_Index80++) {
...
function FixRubyGlobalVars(line) {
    ...
    for (let A_Index82 = 0; A_Index82 < HTVM_Size(htCodeFixRubyGlobalVars) + 0; A_Index82++) {
...
function slidingWinFixCommentsRmFUNC(line) {
    ...
    for (let A_Index92 = 0; A_Index92 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index92++) {
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    items93 = LoopParseFunc(allInstructionFile, "\n", "\r")
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        items94 = LoopParseFunc(allInstructionFile_2, "\n", "\r")
    ...
    */
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            if (InStr(StrLower(code), StrLower(keyWordInclude + " "))) {
                for (let A_Index96 = 0; A_Index96 < 10000 + 0; A_Index96++) {
                    doseCodeHaveLibs = 0;
                    allLibCODE = "";
                    if (A_Index96 == 0) {
                    ...
                    for (let A_Index100 = 0; A_Index100 < HTVM_Size(allLibsWeSee) + 0; A_Index100++) {
                        allLibsWeSeeHOLD = allLibsWeSee[A_Index100];
                        doseCodeHaveLibs_HAS_SEEN2 = 0;
                        for (let A_Index101 = 0; A_Index101 < HTVM_Size(allLibsWeSeeSEE) - HTVM_Size(allLibsWeSee) + 0; A_Index101++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index108 = 0; A_Index108 < theIdNumOfThe34 + 0; A_Index108++) {
        ...
        for (let A_Index109 = 0; A_Index109 < items109.length + 0; A_Index109++) {
            ...
            if (InStr(A_LoopField109, " " + keyWordComment) != false && SubStr(Trim(A_LoopField109), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index110 = 0; A_Index110 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index110++) {
                    slidingWinFixCommentsRmI = A_Index110;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index111 = 0; A_Index111 < StrLen(" " + keyWordComment) + 0; A_Index111++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index115 = 0; A_Index115 < items115.length + 0; A_Index115++) {
                    ...
                    items116 = LoopParseFunc(A_LoopField115, " ")
        ...
        for (let A_Index120 = 0; A_Index120 < 2 + 0; A_Index120++) {
            outCodeFixBraces = "";
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                items154 = LoopParseFunc(htCodeLoopfixa, "\n", "\r")
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index160 = 0; A_Index160 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index160++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index176 = 0; A_Index176 < items176.length + 0; A_Index176++) {
            ...
            if (Trim(A_LoopField176) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index176 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                items177 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index176 + 1])
                ...
                for (let A_Index178 = 0; A_Index178 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index178++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index179 = 0; A_Index179 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index179++) {
    ...
    if (langToConvertTo == "cpp") {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index181 = 0; A_Index181 < COUNT_programmingBlock_CPP + 0; A_Index181++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        ...
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index183 = 0; A_Index183 < COUNT_programmingBlock_PY + 0; A_Index183++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        ...
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index185 = 0; A_Index185 < COUNT_programmingBlock_JS + 0; A_Index185++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        ...
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index187 = 0; A_Index187 < COUNT_programmingBlock_GO + 0; A_Index187++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index189 = 0; A_Index189 < COUNT_programmingBlock_LUA + 0; A_Index189++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        ...
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index191 = 0; A_Index191 < COUNT_programmingBlock_CS + 0; A_Index191++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index193 = 0; A_Index193 < COUNT_programmingBlock_JAVA + 0; A_Index193++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        ...
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index195 = 0; A_Index195 < COUNT_programmingBlock_KT + 0; A_Index195++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        ...
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index197 = 0; A_Index197 < COUNT_programmingBlock_RB + 0; A_Index197++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index199 = 0; A_Index199 < COUNT_programmingBlock_NIM + 0; A_Index199++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index201 = 0; A_Index201 < COUNT_programmingBlock_AHK + 0; A_Index201++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index203 = 0; A_Index203 < COUNT_programmingBlock_SWIFT + 0; A_Index203++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index205 = 0; A_Index205 < COUNT_programmingBlock_DART + 0; A_Index205++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        ...
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index207 = 0; A_Index207 < COUNT_programmingBlock_TS + 0; A_Index207++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index209 = 0; A_Index209 < COUNT_programmingBlock_GROOVY + 0; A_Index209++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index211 = 0; A_Index211 < COUNT_programmingBlock_HTVM + 0; A_Index211++) {
    ...
    var correctLang = 0;
    items212 = LoopParseFunc(instructions, "\n", "\r")
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index213 = 0; A_Index213 < HTVM_Size(allFuncNames) + 0; A_Index213++) {
        ...
        items214 = LoopParseFunc(allLibsToPutAtTop, "|")
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index215 = 0; A_Index215 < HTVM_Size(ospDic1) + 0; A_Index215++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index216 = 0; A_Index216 < size_ospDic + 0; A_Index216++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index217 = 0; A_Index217 < size_ospDic1 + 0; A_Index217++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index218 = 0; A_Index218 < size_ospDic2 + 0; A_Index218++) {
            HTVM_Pop(ospDic2);
        }
    }
    if (langToConvertTo == "rb") {
    ...
    for (let A_Index219 = 0; A_Index219 < theIdNumOfThe34 + 0; A_Index219++) {
...
function HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        items221 = LoopParseFunc(allArgs, "\n", "\r")
        ...
        for (let A_Index222 = 0; A_Index222 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index222++) {
