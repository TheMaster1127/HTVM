...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    let items201 = LoopParseFunc(instructions);
    ...
    let items202 = LoopParseFunc(instructions);
    ...
    let items204 = LoopParseFunc(allInstructionFile, "\n", "\r");
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        let items205 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
    ...
    */
    ...
    let items206 = LoopParseFunc(allInstructionFile, "\n", "\r");
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            ...
            if (doseHaveInclude(code)) {
                ...
                for (let A_Index208 = 0; A_Index208 < 10000; A_Index208++) {
                    ...
                    for (let A_Index209 = 0; A_Index209 < items209.length; A_Index209++) {
                        ...
                        if (SubStr(StrLower(Trim(currentLine)), 1, StrLen(keyWordInclude + " ")) == StrLower(keyWordInclude + " ")) {
                            ...
                            for (let A_Index210 = 0; A_Index210 < HTVM_Size(includedFilePaths); A_Index210++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index212 = 0; A_Index212 < items212.length; A_Index212++) {
            ...
            if (SubStr(Trim(A_LoopField212), 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                let items213 = LoopParseFunc(A_LoopField212);
        ...
        for (let A_Index219 = 0; A_Index219 < theIdNumOfThe34; A_Index219++) {
        ...
        if (langToConvertTo == "dart" || langToConvertTo == "groovy") {
            for (let A_Index220 = 0; A_Index220 < HTVM_Size(theIdNumOfThe34theVar); A_Index220++) {
        ...
        for (let A_Index221 = 0; A_Index221 < items221.length; A_Index221++) {
            ...
            if (InStr(A_LoopField221, " " + keyWordComment) != false && SubStr(Trim(A_LoopField221), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index222 = 0; A_Index222 < HTVM_Size(slidingWinFixCommentsRm); A_Index222++) {
                    slidingWinFixCommentsRmI = A_Index222;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index223 = 0; A_Index223 < StrLen(" " + keyWordComment); A_Index223++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (let A_Index227 = 0; A_Index227 < items227.length; A_Index227++) {
                    ...
                    htCodeOutFixINT--;
                    let items229 = LoopParseFunc(A_LoopField227, " ");
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index230 = 0; A_Index230 < items230.length; A_Index230++) {
                    ...
                    let items231 = LoopParseFunc(A_LoopField230, " ");
        ...
        for (let A_Index237 = 0; A_Index237 < 2; A_Index237++) {
            outCodeFixBraces = "";
        ...
        for (let A_Index243 = 0; A_Index243 < items243.length; A_Index243++) {
            ...
            if (SubStr(A_LoopField243, 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                int1 = 0;
                str17 = "";
                let items244 = LoopParseFunc(str16, " ");
                ...
                if (Trim(str1) == "") {
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            str13 += "{" + Chr(10);
                            let items253 = LoopParseFunc(str12, ",");
                    ...
                    if (Trim(str5) != "" && Trim(str10) == "") {
                        let items256 = LoopParseFunc(str5, "\n", "\r");
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        let items257 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "java") {
                            str14 = "Object... __HTVM_V2_TO_JAVA_optionalParams__";
                            str13 += "{" + Chr(10);
                            let items262 = LoopParseFunc(str11, ",");
                            for (let A_Index262 = 0; A_Index262 < items262.length; A_Index262++) {
                                ...
                                str20 = "";
                                let items263 = LoopParseFunc(str19, " ");
                ...
                if (usePostfixTypeForTypeDefinition == "off") {
                    ...
                    let items269 = LoopParseFunc(str1, " ");
                ...
                if (usePostfixTypeForTypeDefinition == "off") {
                    ...
                    let items270 = LoopParseFunc(str1, " ");
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                let items272 = LoopParseFunc(htCodeLoopfixa, "\n", "\r");
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (let A_Index277 = 0; A_Index277 < COUNT_programmingBlock_HTVMsyntax; A_Index277++) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index278 = 0; A_Index278 < COUNT_programmingBlock_HTVMsyntax; A_Index278++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index294 = 0; A_Index294 < items294.length; A_Index294++) {
            ...
            if (Trim(A_LoopField294) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index294 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                let items295 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index294 + 1]);
                ...
                for (let A_Index296 = 0; A_Index296 < fixGoManGoIsSoAnnoyingBroooCount; A_Index296++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index297 = 0; A_Index297 < COUNT_programmingBlock_InTheTranspiledLang; A_Index297++) {
    ...
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index298 = 0; A_Index298 < COUNT_programmingBlock_CPP; A_Index298++) {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index299 = 0; A_Index299 < COUNT_programmingBlock_CPP; A_Index299++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index300 = 0; A_Index300 < COUNT_programmingBlock_PY; A_Index300++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index300 + 1) + "AA", programmingBlock_PY[A_Index300]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index301 = 0; A_Index301 < COUNT_programmingBlock_PY; A_Index301++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index302 = 0; A_Index302 < COUNT_programmingBlock_JS; A_Index302++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index302 + 1) + "AA", programmingBlock_JS[A_Index302]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index303 = 0; A_Index303 < COUNT_programmingBlock_JS; A_Index303++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index304 = 0; A_Index304 < COUNT_programmingBlock_GO; A_Index304++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index304 + 1) + "AA", programmingBlock_GO[A_Index304]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index305 = 0; A_Index305 < COUNT_programmingBlock_GO; A_Index305++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index306 = 0; A_Index306 < COUNT_programmingBlock_LUA; A_Index306++) {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index307 = 0; A_Index307 < COUNT_programmingBlock_LUA; A_Index307++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index308 = 0; A_Index308 < COUNT_programmingBlock_CS; A_Index308++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index308 + 1) + "AA", programmingBlock_CS[A_Index308]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index309 = 0; A_Index309 < COUNT_programmingBlock_CS; A_Index309++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index310 = 0; A_Index310 < COUNT_programmingBlock_JAVA; A_Index310++) {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index311 = 0; A_Index311 < COUNT_programmingBlock_JAVA; A_Index311++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index312 = 0; A_Index312 < COUNT_programmingBlock_KT; A_Index312++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index312 + 1) + "AA", programmingBlock_KT[A_Index312]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index313 = 0; A_Index313 < COUNT_programmingBlock_KT; A_Index313++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index314 = 0; A_Index314 < COUNT_programmingBlock_RB; A_Index314++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index314 + 1) + "AA", programmingBlock_RB[A_Index314]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index315 = 0; A_Index315 < COUNT_programmingBlock_RB; A_Index315++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index316 = 0; A_Index316 < COUNT_programmingBlock_NIM; A_Index316++) {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index317 = 0; A_Index317 < COUNT_programmingBlock_NIM; A_Index317++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index318 = 0; A_Index318 < COUNT_programmingBlock_AHK; A_Index318++) {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index319 = 0; A_Index319 < COUNT_programmingBlock_AHK; A_Index319++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index320 = 0; A_Index320 < COUNT_programmingBlock_SWIFT; A_Index320++) {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index321 = 0; A_Index321 < COUNT_programmingBlock_SWIFT; A_Index321++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index322 = 0; A_Index322 < COUNT_programmingBlock_DART; A_Index322++) {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index323 = 0; A_Index323 < COUNT_programmingBlock_DART; A_Index323++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index324 = 0; A_Index324 < COUNT_programmingBlock_TS; A_Index324++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index324 + 1) + "AA", programmingBlock_TS[A_Index324]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index325 = 0; A_Index325 < COUNT_programmingBlock_TS; A_Index325++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index326 = 0; A_Index326 < COUNT_programmingBlock_GROOVY; A_Index326++) {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index327 = 0; A_Index327 < COUNT_programmingBlock_GROOVY; A_Index327++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index328 = 0; A_Index328 < COUNT_programmingBlock_HTVM; A_Index328++) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index329 = 0; A_Index329 < COUNT_programmingBlock_HTVM; A_Index329++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        ...
        ALoopField = "";
        str23 = "";
        let items330 = LoopParseFunc(htCode, "\n", "\r");
        for (let A_Index330 = 0; A_Index330 < items330.length; A_Index330++) {
            const A_LoopField330 = items330[A_Index330 - 0];
            ...
            if (InStr(A_LoopField330, "fihuiuuhuuhtheidFor--asds")) {
                ...
                for (let A_Index331 = 0; A_Index331 < theIdNumOfThe34; A_Index331++) {
    ...
    var correctLang = 0;
    let items332 = LoopParseFunc(instructions, "\n", "\r");
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        for (let A_Index333 = 0; A_Index333 < HTVM_Size(commentsBugFix); A_Index333++) {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index334 = 0; A_Index334 < HTVM_Size(allFuncNames); A_Index334++) {
        ...
        let items335 = LoopParseFunc(allLibsToPutAtTop, "|");
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index336 = 0; A_Index336 < HTVM_Size(ospDic1); A_Index336++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index337 = 0; A_Index337 < size_ospDic; A_Index337++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index338 = 0; A_Index338 < size_ospDic1; A_Index338++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index339 = 0; A_Index339 < size_ospDic2; A_Index339++) {
            HTVM_Pop(ospDic2);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_htCodeFixRubyGlobalVars_EXPOSED != 0) {
        for (let A_Index340 = 0; A_Index340 < size_htCodeFixRubyGlobalVars_EXPOSED; A_Index340++) {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == langFileExtension_2) {
            for (let A_Index342 = 0; A_Index342 < HTVM_Size(weAreInMLSarr); A_Index342++) {
    ...
    if (size_weAreInMLSarr != 0) {
        for (let A_Index343 = 0; A_Index343 < size_weAreInMLSarr; A_Index343++) {
...
function HTVMv2() {
    ...
    let items344 = LoopParseFunc(str0);
    for (let A_Index344 = 0; A_Index344 < items344.length; A_Index344++) {
        const A_LoopField344 = items344[A_Index344 - 0];
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        let items345 = LoopParseFunc(allArgs, "\n", "\r");
        ...
        for (let A_Index346 = 0; A_Index346 < HTVM_Size(argHTVMinstrMORE); A_Index346++) {
