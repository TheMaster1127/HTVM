...
function fixHTVMToHTVMMissingAfterAssignmentOperator(line) {
    var out = "";
    let items154 = LoopParseFunc(line, "\n", "\r");
...
function FixDoubleInThe4langs(line) {
    ...
    let items155 = LoopParseFunc(line, "\n", "\r");
...
function handleMultiLineStrings(code) {
    ...
    let items156 = LoopParseFunc(code, "\n", "\r");
    ...
    let lookAhead = [];
    let items157 = LoopParseFunc(code, "\n", "\r");
...
function slidingWinFixCommentsRmFUNC(line) {
    ...
    for (let A_Index160 = 0; A_Index160 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index160++) {
...
function fixIfElseIfMultiLineStatementHELP(aloopfield) {
    var out = "";
    var count = 0;
    let items161 = LoopParseFunc(aloopfield);
...
function fixIfElseIfMultiLineStatement(someHTVMcode) {
    var doWeExitInsta = 1;
    let items162 = LoopParseFunc(someHTVMcode, "\n", "\r");
    ...
    for (let A_Index163 = 0; A_Index163 < 10000 + 0; A_Index163++) {
        out2 = out;
        out = "";
        doWeExit = false;
        let items164 = LoopParseFunc(out2, "\n", "\r");
...
function doseHaveInclude(TheCodeThatMightHaveInclude) {
    let items165 = LoopParseFunc(TheCodeThatMightHaveInclude, "\n", "\r");
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    let items166 = LoopParseFunc(allInstructionFile, "\n", "\r");
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        let items167 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
    ...
    */
    ...
    let items169 = LoopParseFunc(code, "\n", "\r");
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            ...
            if (doseHaveInclude(code)) {
                ...
                for (let A_Index170 = 0; A_Index170 < 10000 + 0; A_Index170++) {
                    ...
                    for (let A_Index171 = 0; A_Index171 < items171.length + 0; A_Index171++) {
                        ...
                        if (SubStr(StrLower(Trim(currentLine)), 1, StrLen(keyWordInclude + " ")) == StrLower(keyWordInclude + " ")) {
                            ...
                            for (let A_Index172 = 0; A_Index172 < HTVM_Size(includedFilePaths) + 0; A_Index172++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index174 = 0; A_Index174 < items174.length + 0; A_Index174++) {
            ...
            if (SubStr(Trim(A_LoopField174), 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                let items175 = LoopParseFunc(A_LoopField174);
        ...
        for (let A_Index181 = 0; A_Index181 < theIdNumOfThe34 + 0; A_Index181++) {
        ...
        for (let A_Index182 = 0; A_Index182 < items182.length + 0; A_Index182++) {
            ...
            if (InStr(A_LoopField182, " " + keyWordComment) != false && SubStr(Trim(A_LoopField182), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index183 = 0; A_Index183 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index183++) {
                    slidingWinFixCommentsRmI = A_Index183;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index184 = 0; A_Index184 < StrLen(" " + keyWordComment) + 0; A_Index184++) {
        ...
        for (let A_Index198 = 0; A_Index198 < 2 + 0; A_Index198++) {
            outCodeFixBraces = "";
        ...
        for (let A_Index203 = 0; A_Index203 < items203.length + 0; A_Index203++) {
            ...
            if (SubStr(A_LoopField203, 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                int1 = 0;
                str17 = "";
                let items204 = LoopParseFunc(str16, " ");
                ...
                if (langToConvertTo != langFileExtension_2 && langToConvertTo != "cpp" && langToConvertTo != "go" && langToConvertTo != "cs" && langToConvertTo != "java" && langToConvertTo != "kt" && langToConvertTo != "nim" && langToConvertTo != "swift" && langToConvertTo != "dart" && langToConvertTo != "ts") {
                    if (str1 != "") {
                        str4 = "";
                        let items205 = LoopParseFunc(str1, ",");
                ...
                if (Trim(str1) == "") {
                    ...
                    str19 = "";
                    str20 = "";
                    let items206 = LoopParseFunc(str1, ",");
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        let items207 = LoopParseFunc(str5, "\n", "\r");
                        ...
                        let items208 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "go") {
                            ...
                            str13 += "{" + Chr(10) + " ";
                            let items211 = LoopParseFunc(str12, ",");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index213 = 0; A_Index213 < items213.length + 0; A_Index213++) {
                                ...
                                str20 = "";
                                let items214 = LoopParseFunc(str19, " ");
                    ...
                    if (Trim(str5) != "" && Trim(str10) == "") {
                        let items216 = LoopParseFunc(str5, "\n", "\r");
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        let items217 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "go") {
                            str14 = "__HTVM_V2_TO_GO_optionalParams__ ...interface{}";
                            str13 += "{" + Chr(10) + " ";
                            let items220 = LoopParseFunc(str11, ",");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index222 = 0; A_Index222 < items222.length + 0; A_Index222++) {
                                ...
                                str20 = "";
                                let items223 = LoopParseFunc(str19, " ");
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                let items232 = LoopParseFunc(htCodeLoopfixa, "\n", "\r");
                for (let A_Index232 = 0; A_Index232 < items232.length + 0; A_Index232++) {
                    ...
                    if (out1 == "nl") {
                        ...
                        foundTheTopLoop = 0;
                        out4758686d86d86d86578991a = "";
                        let items234 = LoopParseFunc(htCode, "\n", "\r");
                ...
                hold = 0;
                let items235 = LoopParseFunc(htCode, "\n", "\r");
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (let A_Index237 = 0; A_Index237 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index237++) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index238 = 0; A_Index238 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index238++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index254 = 0; A_Index254 < items254.length + 0; A_Index254++) {
            ...
            if (Trim(A_LoopField254) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index254 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                let items255 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index254 + 1]);
                ...
                for (let A_Index256 = 0; A_Index256 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index256++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    for (let A_Index257 = 0; A_Index257 < HTVM_Size(commentsBugFix) + 0; A_Index257++) {
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index258 = 0; A_Index258 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index258++) {
    ...
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index259 = 0; A_Index259 < COUNT_programmingBlock_CPP + 0; A_Index259++) {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index260 = 0; A_Index260 < COUNT_programmingBlock_CPP + 0; A_Index260++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index261 = 0; A_Index261 < COUNT_programmingBlock_PY + 0; A_Index261++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index261 + 1) + "AA", programmingBlock_PY[A_Index261]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index262 = 0; A_Index262 < COUNT_programmingBlock_PY + 0; A_Index262++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index263 = 0; A_Index263 < COUNT_programmingBlock_JS + 0; A_Index263++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index263 + 1) + "AA", programmingBlock_JS[A_Index263]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index264 = 0; A_Index264 < COUNT_programmingBlock_JS + 0; A_Index264++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index265 = 0; A_Index265 < COUNT_programmingBlock_GO + 0; A_Index265++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index265 + 1) + "AA", programmingBlock_GO[A_Index265]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index266 = 0; A_Index266 < COUNT_programmingBlock_GO + 0; A_Index266++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index267 = 0; A_Index267 < COUNT_programmingBlock_LUA + 0; A_Index267++) {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index268 = 0; A_Index268 < COUNT_programmingBlock_LUA + 0; A_Index268++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index269 = 0; A_Index269 < COUNT_programmingBlock_CS + 0; A_Index269++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index269 + 1) + "AA", programmingBlock_CS[A_Index269]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index270 = 0; A_Index270 < COUNT_programmingBlock_CS + 0; A_Index270++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index271 = 0; A_Index271 < COUNT_programmingBlock_JAVA + 0; A_Index271++) {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index272 = 0; A_Index272 < COUNT_programmingBlock_JAVA + 0; A_Index272++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index273 = 0; A_Index273 < COUNT_programmingBlock_KT + 0; A_Index273++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index273 + 1) + "AA", programmingBlock_KT[A_Index273]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index274 = 0; A_Index274 < COUNT_programmingBlock_KT + 0; A_Index274++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index275 = 0; A_Index275 < COUNT_programmingBlock_RB + 0; A_Index275++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index275 + 1) + "AA", programmingBlock_RB[A_Index275]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index276 = 0; A_Index276 < COUNT_programmingBlock_RB + 0; A_Index276++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index277 = 0; A_Index277 < COUNT_programmingBlock_NIM + 0; A_Index277++) {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index278 = 0; A_Index278 < COUNT_programmingBlock_NIM + 0; A_Index278++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index279 = 0; A_Index279 < COUNT_programmingBlock_AHK + 0; A_Index279++) {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index280 = 0; A_Index280 < COUNT_programmingBlock_AHK + 0; A_Index280++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index281 = 0; A_Index281 < COUNT_programmingBlock_SWIFT + 0; A_Index281++) {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index282 = 0; A_Index282 < COUNT_programmingBlock_SWIFT + 0; A_Index282++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index283 = 0; A_Index283 < COUNT_programmingBlock_DART + 0; A_Index283++) {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index284 = 0; A_Index284 < COUNT_programmingBlock_DART + 0; A_Index284++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index285 = 0; A_Index285 < COUNT_programmingBlock_TS + 0; A_Index285++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index285 + 1) + "AA", programmingBlock_TS[A_Index285]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index286 = 0; A_Index286 < COUNT_programmingBlock_TS + 0; A_Index286++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index287 = 0; A_Index287 < COUNT_programmingBlock_GROOVY + 0; A_Index287++) {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index288 = 0; A_Index288 < COUNT_programmingBlock_GROOVY + 0; A_Index288++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index289 = 0; A_Index289 < COUNT_programmingBlock_HTVM + 0; A_Index289++) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index290 = 0; A_Index290 < COUNT_programmingBlock_HTVM + 0; A_Index290++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        ...
        for (let A_Index291 = 0; A_Index291 < theIdNumOfThe34 + 0; A_Index291++) {
    ...
    var correctLang = 0;
    let items292 = LoopParseFunc(instructions, "\n", "\r");
    for (let A_Index292 = 0; A_Index292 < items292.length + 0; A_Index292++) {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index293 = 0; A_Index293 < HTVM_Size(allFuncNames) + 0; A_Index293++) {
        ...
        let items294 = LoopParseFunc(allLibsToPutAtTop, "|");
        for (let A_Index294 = 0; A_Index294 < items294.length + 0; A_Index294++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index295 = 0; A_Index295 < HTVM_Size(ospDic1) + 0; A_Index295++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index296 = 0; A_Index296 < size_ospDic + 0; A_Index296++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index297 = 0; A_Index297 < size_ospDic1 + 0; A_Index297++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index298 = 0; A_Index298 < size_ospDic2 + 0; A_Index298++) {
            HTVM_Pop(ospDic2);
        }
    }
    availableFuncsInHTVMInHTVM = "";
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == langFileExtension_2) {
            for (let A_Index300 = 0; A_Index300 < HTVM_Size(weAreInMLSarr) + 0; A_Index300++) {
    ...
    if (size_weAreInMLSarr != 0) {
        for (let A_Index301 = 0; A_Index301 < size_weAreInMLSarr + 0; A_Index301++) {
...
function HTVMv2() {
    ...
    let items302 = LoopParseFunc(str0);
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        let items303 = LoopParseFunc(allArgs, "\n", "\r");
        for (let A_Index303 = 0; A_Index303 < items303.length + 0; A_Index303++) {
        ...
        for (let A_Index304 = 0; A_Index304 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index304++) {
