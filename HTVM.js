...
function slidingWinFixCommentsRmFUNC(line) {
    ...
    for (let A_Index103 = 0; A_Index103 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index103++) {
...
function fixIfElseIfMultiLineStatementHELP(aloopfield) {
    var out = "";
    var count = 0;
    items104 = LoopParseFunc(aloopfield)
...
function fixIfElseIfMultiLineStatement(someHTVMcode) {
    ...
    for (let A_Index105 = 0; A_Index105 < 2147483000 + 0; A_Index105++) {
        out2 = out;
        out = "";
        doWeExit = false;
        items106 = LoopParseFunc(out2, "\n", "\r")
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    items107 = LoopParseFunc(allInstructionFile, "\n", "\r")
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        items108 = LoopParseFunc(allInstructionFile_2, "\n", "\r")
    ...
    */
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            if (InStr(StrLower(code), StrLower(keyWordInclude + " "))) {
                for (let A_Index111 = 0; A_Index111 < 10000 + 0; A_Index111++) {
                    doseCodeHaveLibs = 0;
                    allLibCODE = "";
                    if (A_Index111 == 0) {
                        ...
                        for (let A_Index113 = 0; A_Index113 < items113.length + 0; A_Index113++) {
                            ...
                            if (SubStr(StrLower(Trim(A_LoopField113)), 1, StrLen(StrLower(keyWordInclude + " "))) == StrLower(keyWordInclude + " ")) {
                                ...
                                for (let A_Index114 = 0; A_Index114 < HTVM_Size(allLibsWeSee) + 0; A_Index114++) {
                    ...
                    for (let A_Index115 = 0; A_Index115 < HTVM_Size(allLibsWeSee) + 0; A_Index115++) {
                        allLibsWeSeeHOLD = allLibsWeSee[A_Index115];
                        doseCodeHaveLibs_HAS_SEEN2 = 0;
                        for (let A_Index116 = 0; A_Index116 < HTVM_Size(allLibsWeSeeSEE) - HTVM_Size(allLibsWeSee) + 0; A_Index116++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index123 = 0; A_Index123 < theIdNumOfThe34 + 0; A_Index123++) {
        ...
        for (let A_Index124 = 0; A_Index124 < items124.length + 0; A_Index124++) {
            ...
            if (InStr(A_LoopField124, " " + keyWordComment) != false && SubStr(Trim(A_LoopField124), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index125 = 0; A_Index125 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index125++) {
                    slidingWinFixCommentsRmI = A_Index125;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index126 = 0; A_Index126 < StrLen(" " + keyWordComment) + 0; A_Index126++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index132 = 0; A_Index132 < items132.length + 0; A_Index132++) {
                    ...
                    items133 = LoopParseFunc(A_LoopField132, " ")
        ...
        for (let A_Index137 = 0; A_Index137 < 2 + 0; A_Index137++) {
            outCodeFixBraces = "";
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                items171 = LoopParseFunc(htCodeLoopfixa, "\n", "\r")
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (let A_Index176 = 0; A_Index176 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index176++) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index177 = 0; A_Index177 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index177++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index193 = 0; A_Index193 < items193.length + 0; A_Index193++) {
            ...
            if (Trim(A_LoopField193) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index193 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                items194 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index193 + 1])
                ...
                for (let A_Index195 = 0; A_Index195 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index195++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index196 = 0; A_Index196 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index196++) {
    ...
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index197 = 0; A_Index197 < COUNT_programmingBlock_CPP + 0; A_Index197++) {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index198 = 0; A_Index198 < COUNT_programmingBlock_CPP + 0; A_Index198++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index199 = 0; A_Index199 < COUNT_programmingBlock_PY + 0; A_Index199++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index199 + 1) + "AA", programmingBlock_PY[A_Index199]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index200 = 0; A_Index200 < COUNT_programmingBlock_PY + 0; A_Index200++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index201 = 0; A_Index201 < COUNT_programmingBlock_JS + 0; A_Index201++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index201 + 1) + "AA", programmingBlock_JS[A_Index201]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index202 = 0; A_Index202 < COUNT_programmingBlock_JS + 0; A_Index202++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index203 = 0; A_Index203 < COUNT_programmingBlock_GO + 0; A_Index203++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index203 + 1) + "AA", programmingBlock_GO[A_Index203]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index204 = 0; A_Index204 < COUNT_programmingBlock_GO + 0; A_Index204++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index205 = 0; A_Index205 < COUNT_programmingBlock_LUA + 0; A_Index205++) {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index206 = 0; A_Index206 < COUNT_programmingBlock_LUA + 0; A_Index206++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index207 = 0; A_Index207 < COUNT_programmingBlock_CS + 0; A_Index207++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index207 + 1) + "AA", programmingBlock_CS[A_Index207]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index208 = 0; A_Index208 < COUNT_programmingBlock_CS + 0; A_Index208++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index209 = 0; A_Index209 < COUNT_programmingBlock_JAVA + 0; A_Index209++) {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index210 = 0; A_Index210 < COUNT_programmingBlock_JAVA + 0; A_Index210++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index211 = 0; A_Index211 < COUNT_programmingBlock_KT + 0; A_Index211++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index211 + 1) + "AA", programmingBlock_KT[A_Index211]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index212 = 0; A_Index212 < COUNT_programmingBlock_KT + 0; A_Index212++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index213 = 0; A_Index213 < COUNT_programmingBlock_RB + 0; A_Index213++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index213 + 1) + "AA", programmingBlock_RB[A_Index213]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index214 = 0; A_Index214 < COUNT_programmingBlock_RB + 0; A_Index214++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index215 = 0; A_Index215 < COUNT_programmingBlock_NIM + 0; A_Index215++) {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index216 = 0; A_Index216 < COUNT_programmingBlock_NIM + 0; A_Index216++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index217 = 0; A_Index217 < COUNT_programmingBlock_AHK + 0; A_Index217++) {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index218 = 0; A_Index218 < COUNT_programmingBlock_AHK + 0; A_Index218++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index219 = 0; A_Index219 < COUNT_programmingBlock_SWIFT + 0; A_Index219++) {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index220 = 0; A_Index220 < COUNT_programmingBlock_SWIFT + 0; A_Index220++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index221 = 0; A_Index221 < COUNT_programmingBlock_DART + 0; A_Index221++) {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index222 = 0; A_Index222 < COUNT_programmingBlock_DART + 0; A_Index222++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index223 = 0; A_Index223 < COUNT_programmingBlock_TS + 0; A_Index223++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index223 + 1) + "AA", programmingBlock_TS[A_Index223]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index224 = 0; A_Index224 < COUNT_programmingBlock_TS + 0; A_Index224++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index225 = 0; A_Index225 < COUNT_programmingBlock_GROOVY + 0; A_Index225++) {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index226 = 0; A_Index226 < COUNT_programmingBlock_GROOVY + 0; A_Index226++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index227 = 0; A_Index227 < COUNT_programmingBlock_HTVM + 0; A_Index227++) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index228 = 0; A_Index228 < COUNT_programmingBlock_HTVM + 0; A_Index228++) {
    ...
    var correctLang = 0;
    items229 = LoopParseFunc(instructions, "\n", "\r")
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index230 = 0; A_Index230 < HTVM_Size(allFuncNames) + 0; A_Index230++) {
        ...
        items231 = LoopParseFunc(allLibsToPutAtTop, "|")
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index232 = 0; A_Index232 < HTVM_Size(ospDic1) + 0; A_Index232++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index233 = 0; A_Index233 < size_ospDic + 0; A_Index233++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index234 = 0; A_Index234 < size_ospDic1 + 0; A_Index234++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index235 = 0; A_Index235 < size_ospDic2 + 0; A_Index235++) {
            HTVM_Pop(ospDic2);
        }
    }
    availableFuncsInHTVMInHTVM = "";
    ...
    for (let A_Index236 = 0; A_Index236 < theIdNumOfThe34 + 0; A_Index236++) {
...
function HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        items238 = LoopParseFunc(allArgs, "\n", "\r")
        ...
        for (let A_Index239 = 0; A_Index239 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index239++) {
