    ...
    */
    ...
    if (isNotHTVMfile == 0) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (let A_Index185 = 0; A_Index185 < items185.length + 0; A_Index185++) {
                    ...
                    htCodeOutFixINT--;
                    items187 = LoopParseFunc(A_LoopField185, " ")
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index188 = 0; A_Index188 < items188.length + 0; A_Index188++) {
                    ...
                    items189 = LoopParseFunc(A_LoopField188, " ")
        ...
        if (usePrefixTypeForTypeDefinition == "on") {
            ...
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            for (let A_Index198 = 0; ; A_Index198++) {
                htCodeOutFixEnd = "";
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                items232 = LoopParseFunc(htCodeLoopfixa, "\n", "\r")
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index254 = 0; A_Index254 < items254.length + 0; A_Index254++) {
            ...
            if (Trim(A_LoopField254) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index254 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                items255 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index254 + 1])
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index257 = 0; A_Index257 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index257++) {
