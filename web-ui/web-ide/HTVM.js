...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    let items182 = LoopParseFunc(allInstructionFile, "\n", "\r");
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        let items183 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
    ...
    */
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            ...
            if (doseHaveInclude(code)) {
                ...
                for (let A_Index186 = 0; A_Index186 < 10000 + 0; A_Index186++) {
                    ...
                    for (let A_Index187 = 0; A_Index187 < items187.length + 0; A_Index187++) {
                        ...
                        if (SubStr(StrLower(Trim(currentLine)), 1, StrLen(keyWordInclude + " ")) == StrLower(keyWordInclude + " ")) {
                            ...
                            for (let A_Index188 = 0; A_Index188 < HTVM_Size(includedFilePaths) + 0; A_Index188++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index197 = 0; A_Index197 < theIdNumOfThe34 + 0; A_Index197++) {
        ...
        if (langToConvertTo == "dart" || langToConvertTo == "groovy") {
            for (let A_Index198 = 0; A_Index198 < HTVM_Size(theIdNumOfThe34theVar) + 0; A_Index198++) {
        ...
        for (let A_Index199 = 0; A_Index199 < items199.length + 0; A_Index199++) {
            ...
            if (InStr(A_LoopField199, " " + keyWordComment) != false && SubStr(Trim(A_LoopField199), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index200 = 0; A_Index200 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index200++) {
                    slidingWinFixCommentsRmI = A_Index200;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index201 = 0; A_Index201 < StrLen(" " + keyWordComment) + 0; A_Index201++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (let A_Index205 = 0; A_Index205 < items205.length + 0; A_Index205++) {
                    ...
                    htCodeOutFixINT--;
                    let items207 = LoopParseFunc(A_LoopField205, " ");
        ...
        for (let A_Index215 = 0; A_Index215 < 2 + 0; A_Index215++) {
            outCodeFixBraces = "";
        ...
        for (let A_Index220 = 0; A_Index220 < items220.length + 0; A_Index220++) {
            ...
            if (SubStr(A_LoopField220, 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                int1 = 0;
                str17 = "";
                let items221 = LoopParseFunc(str16, " ");
                ...
                if (Trim(str1) == "") {
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        let items224 = LoopParseFunc(str5, "\n", "\r");
                        ...
                        let items225 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index230 = 0; A_Index230 < items230.length + 0; A_Index230++) {
                                ...
                                str20 = "";
                                let items231 = LoopParseFunc(str19, " ");
                    ...
                    if (Trim(str5) != "" && Trim(str10) == "") {
                        let items233 = LoopParseFunc(str5, "\n", "\r");
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        let items234 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index239 = 0; A_Index239 < items239.length + 0; A_Index239++) {
                                ...
                                str20 = "";
                                let items240 = LoopParseFunc(str19, " ");
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                let items249 = LoopParseFunc(htCodeLoopfixa, "\n", "\r");
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index255 = 0; A_Index255 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index255++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index271 = 0; A_Index271 < items271.length + 0; A_Index271++) {
            ...
            if (Trim(A_LoopField271) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index271 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                let items272 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index271 + 1]);
                ...
                for (let A_Index273 = 0; A_Index273 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index273++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index274 = 0; A_Index274 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index274++) {
    ...
    if (langToConvertTo == "cpp") {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index276 = 0; A_Index276 < COUNT_programmingBlock_CPP + 0; A_Index276++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        ...
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index278 = 0; A_Index278 < COUNT_programmingBlock_PY + 0; A_Index278++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        ...
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index280 = 0; A_Index280 < COUNT_programmingBlock_JS + 0; A_Index280++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        ...
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index282 = 0; A_Index282 < COUNT_programmingBlock_GO + 0; A_Index282++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index284 = 0; A_Index284 < COUNT_programmingBlock_LUA + 0; A_Index284++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        ...
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index286 = 0; A_Index286 < COUNT_programmingBlock_CS + 0; A_Index286++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index288 = 0; A_Index288 < COUNT_programmingBlock_JAVA + 0; A_Index288++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        ...
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index290 = 0; A_Index290 < COUNT_programmingBlock_KT + 0; A_Index290++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        ...
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index292 = 0; A_Index292 < COUNT_programmingBlock_RB + 0; A_Index292++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index294 = 0; A_Index294 < COUNT_programmingBlock_NIM + 0; A_Index294++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index296 = 0; A_Index296 < COUNT_programmingBlock_AHK + 0; A_Index296++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index298 = 0; A_Index298 < COUNT_programmingBlock_SWIFT + 0; A_Index298++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index300 = 0; A_Index300 < COUNT_programmingBlock_DART + 0; A_Index300++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        ...
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index302 = 0; A_Index302 < COUNT_programmingBlock_TS + 0; A_Index302++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index304 = 0; A_Index304 < COUNT_programmingBlock_GROOVY + 0; A_Index304++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index306 = 0; A_Index306 < COUNT_programmingBlock_HTVM + 0; A_Index306++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        ...
        ALoopField = "";
        str23 = "";
        let items307 = LoopParseFunc(htCode, "\n", "\r");
    ...
    var correctLang = 0;
    let items309 = LoopParseFunc(instructions, "\n", "\r");
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        for (let A_Index310 = 0; A_Index310 < HTVM_Size(commentsBugFix) + 0; A_Index310++) {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index311 = 0; A_Index311 < HTVM_Size(allFuncNames) + 0; A_Index311++) {
        ...
        let items312 = LoopParseFunc(allLibsToPutAtTop, "|");
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index313 = 0; A_Index313 < HTVM_Size(ospDic1) + 0; A_Index313++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index314 = 0; A_Index314 < size_ospDic + 0; A_Index314++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index315 = 0; A_Index315 < size_ospDic1 + 0; A_Index315++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index316 = 0; A_Index316 < size_ospDic2 + 0; A_Index316++) {
            HTVM_Pop(ospDic2);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_htCodeFixRubyGlobalVars_EXPOSED != 0) {
        for (let A_Index317 = 0; A_Index317 < size_htCodeFixRubyGlobalVars_EXPOSED + 0; A_Index317++) {
    ...
    for (let A_Index318 = 0; A_Index318 < theIdNumOfThe34 + 0; A_Index318++) {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == langFileExtension_2) {
            for (let A_Index319 = 0; A_Index319 < HTVM_Size(weAreInMLSarr) + 0; A_Index319++) {
    ...
    if (size_weAreInMLSarr != 0) {
        for (let A_Index320 = 0; A_Index320 < size_weAreInMLSarr + 0; A_Index320++) {
...
function HTVMv2() {
    ...
    let items321 = LoopParseFunc(str0);
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        let items322 = LoopParseFunc(allArgs, "\n", "\r");
        for (let A_Index322 = 0; A_Index322 < items322.length + 0; A_Index322++) {
        ...
        for (let A_Index323 = 0; A_Index323 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index323++) {
