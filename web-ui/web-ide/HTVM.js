...
function fString(line) {
    ...
    if (langToConvertTo == "rb") {
        for (let A_Index157 = 0; A_Index157 < HTVM_Size(htCodeFixRubyGlobalVars_EXPOSED) + 0; A_Index157++) {
...
function handleMultiLineStrings(code) {
    ...
    let items158 = LoopParseFunc(code, "\n", "\r");
    ...
    let lookAhead = [];
    let items159 = LoopParseFunc(code, "\n", "\r");
...
function slidingWinFixCommentsRmFUNC(line) {
    ...
    for (let A_Index162 = 0; A_Index162 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index162++) {
...
function fixIfElseIfMultiLineStatementHELP(aloopfield) {
    var out = "";
    var count = 0;
    let items163 = LoopParseFunc(aloopfield);
...
function fixIfElseIfMultiLineStatement(someHTVMcode) {
    var doWeExitInsta = 1;
    let items164 = LoopParseFunc(someHTVMcode, "\n", "\r");
    ...
    for (let A_Index165 = 0; A_Index165 < 10000 + 0; A_Index165++) {
        out2 = out;
        out = "";
        doWeExit = false;
        let items166 = LoopParseFunc(out2, "\n", "\r");
...
function doseHaveInclude(TheCodeThatMightHaveInclude) {
    let items167 = LoopParseFunc(TheCodeThatMightHaveInclude, "\n", "\r");
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    let items168 = LoopParseFunc(allInstructionFile, "\n", "\r");
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        let items169 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
    ...
    */
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            ...
            if (doseHaveInclude(code)) {
                ...
                for (let A_Index172 = 0; A_Index172 < 10000 + 0; A_Index172++) {
                    ...
                    for (let A_Index173 = 0; A_Index173 < items173.length + 0; A_Index173++) {
                        ...
                        if (SubStr(StrLower(Trim(currentLine)), 1, StrLen(keyWordInclude + " ")) == StrLower(keyWordInclude + " ")) {
                            ...
                            for (let A_Index174 = 0; A_Index174 < HTVM_Size(includedFilePaths) + 0; A_Index174++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index176 = 0; A_Index176 < items176.length + 0; A_Index176++) {
            ...
            if (SubStr(Trim(A_LoopField176), 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                let items177 = LoopParseFunc(A_LoopField176);
        ...
        for (let A_Index183 = 0; A_Index183 < theIdNumOfThe34 + 0; A_Index183++) {
        ...
        if (langToConvertTo == "dart" || langToConvertTo == "groovy") {
            for (let A_Index184 = 0; A_Index184 < HTVM_Size(theIdNumOfThe34theVar) + 0; A_Index184++) {
        ...
        for (let A_Index185 = 0; A_Index185 < items185.length + 0; A_Index185++) {
            ...
            if (InStr(A_LoopField185, " " + keyWordComment) != false && SubStr(Trim(A_LoopField185), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index186 = 0; A_Index186 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index186++) {
                    slidingWinFixCommentsRmI = A_Index186;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index187 = 0; A_Index187 < StrLen(" " + keyWordComment) + 0; A_Index187++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            str1 = "";
            let items189 = LoopParseFunc(code, "\n", "\r");
            ...
            if (keyWordCurlyBraceOpen != "{") {
                ...
                for (let A_Index191 = 0; A_Index191 < items191.length + 0; A_Index191++) {
                    ...
                    htCodeOutFixINT--;
                    let items193 = LoopParseFunc(A_LoopField191, " ");
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index194 = 0; A_Index194 < items194.length + 0; A_Index194++) {
                    ...
                    let items195 = LoopParseFunc(A_LoopField194, " ");
        ...
        for (let A_Index201 = 0; A_Index201 < 2 + 0; A_Index201++) {
            outCodeFixBraces = "";
        ...
        for (let A_Index206 = 0; A_Index206 < items206.length + 0; A_Index206++) {
            ...
            if (SubStr(A_LoopField206, 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                int1 = 0;
                str17 = "";
                let items207 = LoopParseFunc(str16, " ");
                ...
                if (langToConvertTo != langFileExtension_2 && langToConvertTo != "cpp" && langToConvertTo != "go" && langToConvertTo != "cs" && langToConvertTo != "java" && langToConvertTo != "kt" && langToConvertTo != "nim" && langToConvertTo != "swift" && langToConvertTo != "dart" && langToConvertTo != "ts") {
                    if (str1 != "") {
                        str4 = "";
                        let items208 = LoopParseFunc(str1, ",");
                ...
                if (Trim(str1) == "") {
                    ...
                    str19 = "";
                    str20 = "";
                    let items209 = LoopParseFunc(str1, ",");
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        let items210 = LoopParseFunc(str5, "\n", "\r");
                        ...
                        let items211 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "lua") {
                            ...
                            str13 += "{" + Chr(10);
                            let items213 = LoopParseFunc(str12, ",");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index216 = 0; A_Index216 < items216.length + 0; A_Index216++) {
                                ...
                                str20 = "";
                                let items217 = LoopParseFunc(str19, " ");
                    ...
                    if (Trim(str5) != "" && Trim(str10) == "") {
                        let items219 = LoopParseFunc(str5, "\n", "\r");
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        let items220 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "lua") {
                            ...
                            str14 = StringTrimRight(str14, 2);
                            str13 += "{" + Chr(10);
                            let items222 = LoopParseFunc(str11, ",");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index225 = 0; A_Index225 < items225.length + 0; A_Index225++) {
                                ...
                                str20 = "";
                                let items226 = LoopParseFunc(str19, " ");
                ...
                if (InStr(ALoopField, " ") == false || SubStrLastChars(ALoopField, 1) == "]") {
                    ...
                    if (usePostfixTypeForTypeDefinition == "off") {
                        str1 = Trim(StringTrimLeft(Trim(str1), StrLen(keyWordVar)));
                        let items229 = LoopParseFunc(str1, " ");
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                let items235 = LoopParseFunc(htCodeLoopfixa, "\n", "\r");
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (let A_Index240 = 0; A_Index240 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index240++) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index241 = 0; A_Index241 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index241++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index257 = 0; A_Index257 < items257.length + 0; A_Index257++) {
            ...
            if (Trim(A_LoopField257) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index257 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                let items258 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index257 + 1]);
                ...
                for (let A_Index259 = 0; A_Index259 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index259++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    for (let A_Index260 = 0; A_Index260 < HTVM_Size(commentsBugFix) + 0; A_Index260++) {
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index261 = 0; A_Index261 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index261++) {
    ...
    if (langToConvertTo == "cpp") {
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index262 = 0; A_Index262 < COUNT_programmingBlock_CPP + 0; A_Index262++) {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index263 = 0; A_Index263 < COUNT_programmingBlock_CPP + 0; A_Index263++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index264 = 0; A_Index264 < COUNT_programmingBlock_PY + 0; A_Index264++) {
                htCode = StrReplace(htCode, "programmingBlock_PY-programmingBlock_PY-AA" + STR(A_Index264 + 1) + "AA", programmingBlock_PY[A_Index264]);
            }
        }
    } else {
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index265 = 0; A_Index265 < COUNT_programmingBlock_PY + 0; A_Index265++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index266 = 0; A_Index266 < COUNT_programmingBlock_JS + 0; A_Index266++) {
                htCode = StrReplace(htCode, "programmingBlock_JS-programmingBlock_JS-AA" + STR(A_Index266 + 1) + "AA", programmingBlock_JS[A_Index266]);
            }
        }
    } else {
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index267 = 0; A_Index267 < COUNT_programmingBlock_JS + 0; A_Index267++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index268 = 0; A_Index268 < COUNT_programmingBlock_GO + 0; A_Index268++) {
                htCode = StrReplace(htCode, "programmingBlock_GO-programmingBlock_GO-AA" + STR(A_Index268 + 1) + "AA", programmingBlock_GO[A_Index268]);
            }
        }
    } else {
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index269 = 0; A_Index269 < COUNT_programmingBlock_GO + 0; A_Index269++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index270 = 0; A_Index270 < COUNT_programmingBlock_LUA + 0; A_Index270++) {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index271 = 0; A_Index271 < COUNT_programmingBlock_LUA + 0; A_Index271++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index272 = 0; A_Index272 < COUNT_programmingBlock_CS + 0; A_Index272++) {
                htCode = StrReplace(htCode, "programmingBlock_CS-programmingBlock_CS-AA" + STR(A_Index272 + 1) + "AA", programmingBlock_CS[A_Index272]);
            }
        }
    } else {
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index273 = 0; A_Index273 < COUNT_programmingBlock_CS + 0; A_Index273++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index274 = 0; A_Index274 < COUNT_programmingBlock_JAVA + 0; A_Index274++) {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index275 = 0; A_Index275 < COUNT_programmingBlock_JAVA + 0; A_Index275++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index276 = 0; A_Index276 < COUNT_programmingBlock_KT + 0; A_Index276++) {
                htCode = StrReplace(htCode, "programmingBlock_KT-programmingBlock_KT-AA" + STR(A_Index276 + 1) + "AA", programmingBlock_KT[A_Index276]);
            }
        }
    } else {
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index277 = 0; A_Index277 < COUNT_programmingBlock_KT + 0; A_Index277++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index278 = 0; A_Index278 < COUNT_programmingBlock_RB + 0; A_Index278++) {
                htCode = StrReplace(htCode, "programmingBlock_RB-programmingBlock_RB-AA" + STR(A_Index278 + 1) + "AA", programmingBlock_RB[A_Index278]);
            }
        }
    } else {
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index279 = 0; A_Index279 < COUNT_programmingBlock_RB + 0; A_Index279++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index280 = 0; A_Index280 < COUNT_programmingBlock_NIM + 0; A_Index280++) {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index281 = 0; A_Index281 < COUNT_programmingBlock_NIM + 0; A_Index281++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index282 = 0; A_Index282 < COUNT_programmingBlock_AHK + 0; A_Index282++) {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index283 = 0; A_Index283 < COUNT_programmingBlock_AHK + 0; A_Index283++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index284 = 0; A_Index284 < COUNT_programmingBlock_SWIFT + 0; A_Index284++) {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index285 = 0; A_Index285 < COUNT_programmingBlock_SWIFT + 0; A_Index285++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index286 = 0; A_Index286 < COUNT_programmingBlock_DART + 0; A_Index286++) {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index287 = 0; A_Index287 < COUNT_programmingBlock_DART + 0; A_Index287++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index288 = 0; A_Index288 < COUNT_programmingBlock_TS + 0; A_Index288++) {
                htCode = StrReplace(htCode, "programmingBlock_TS-programmingBlock_TS-AA" + STR(A_Index288 + 1) + "AA", programmingBlock_TS[A_Index288]);
            }
        }
    } else {
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index289 = 0; A_Index289 < COUNT_programmingBlock_TS + 0; A_Index289++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index290 = 0; A_Index290 < COUNT_programmingBlock_GROOVY + 0; A_Index290++) {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index291 = 0; A_Index291 < COUNT_programmingBlock_GROOVY + 0; A_Index291++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index292 = 0; A_Index292 < COUNT_programmingBlock_HTVM + 0; A_Index292++) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index293 = 0; A_Index293 < COUNT_programmingBlock_HTVM + 0; A_Index293++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        ...
        for (let A_Index294 = 0; A_Index294 < theIdNumOfThe34 + 0; A_Index294++) {
    ...
    var correctLang = 0;
    let items295 = LoopParseFunc(instructions, "\n", "\r");
    for (let A_Index295 = 0; A_Index295 < items295.length + 0; A_Index295++) {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index296 = 0; A_Index296 < HTVM_Size(allFuncNames) + 0; A_Index296++) {
        ...
        let items297 = LoopParseFunc(allLibsToPutAtTop, "|");
        for (let A_Index297 = 0; A_Index297 < items297.length + 0; A_Index297++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index298 = 0; A_Index298 < HTVM_Size(ospDic1) + 0; A_Index298++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index299 = 0; A_Index299 < size_ospDic + 0; A_Index299++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index300 = 0; A_Index300 < size_ospDic1 + 0; A_Index300++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index301 = 0; A_Index301 < size_ospDic2 + 0; A_Index301++) {
            HTVM_Pop(ospDic2);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_htCodeFixRubyGlobalVars_EXPOSED != 0) {
        for (let A_Index302 = 0; A_Index302 < size_htCodeFixRubyGlobalVars_EXPOSED + 0; A_Index302++) {
    ...
    for (let A_Index303 = 0; A_Index303 < theIdNumOfThe34 + 0; A_Index303++) {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == langFileExtension_2) {
            for (let A_Index304 = 0; A_Index304 < HTVM_Size(weAreInMLSarr) + 0; A_Index304++) {
    ...
    if (size_weAreInMLSarr != 0) {
        for (let A_Index305 = 0; A_Index305 < size_weAreInMLSarr + 0; A_Index305++) {
...
function HTVMv2() {
    ...
    let items306 = LoopParseFunc(str0);
    for (let A_Index306 = 0; A_Index306 < items306.length + 0; A_Index306++) {
        const A_LoopField306 = items306[A_Index306 - 0];
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        let items307 = LoopParseFunc(allArgs, "\n", "\r");
        for (let A_Index307 = 0; A_Index307 < items307.length + 0; A_Index307++) {
            const A_LoopField307 = items307[A_Index307 - 0];
            if (A_Index307 == 0) {
                numOfParams++;
        ...
        for (let A_Index308 = 0; A_Index308 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index308++) {
