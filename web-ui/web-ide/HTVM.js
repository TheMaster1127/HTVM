...
function fixJAVAstrCmp_FjavaUGH(javaCode) {
    ...
    var next = 0;
    let items156 = LoopParseFunc(javaCode, " ");
    ...
    var replace4 = "";
    var varName = "";
    for (let A_Index157 = 0; A_Index157 < HTVM_Size(allJavaStringsIG) + 0; A_Index157++) {
...
function fString(line) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        ...
        let items159 = LoopParseFunc(line);
    ...
    if (langToConvertTo == "rb") {
        for (let A_Index161 = 0; A_Index161 < HTVM_Size(htCodeFixRubyGlobalVars_EXPOSED) + 0; A_Index161++) {
...
function handleMultiLineStrings(code) {
    ...
    let lookAhead = [];
    let items163 = LoopParseFunc(code, "\n", "\r");
...
function slidingWinFixCommentsRmFUNC(line) {
    ...
    let items165 = LoopParseFunc(line);
    ...
    for (let A_Index166 = 0; A_Index166 < StrLen(keyWordComment + keyWordComment) + 2 + 0; A_Index166++) {
...
function fixIfElseIfMultiLineStatementHELP(aloopfield) {
    var out = "";
    var count = 0;
    let items167 = LoopParseFunc(aloopfield);
...
function fixIfElseIfMultiLineStatement(someHTVMcode) {
    var doWeExitInsta = 1;
    let items168 = LoopParseFunc(someHTVMcode, "\n", "\r");
    ...
    for (let A_Index169 = 0; A_Index169 < 10000 + 0; A_Index169++) {
        out2 = out;
        out = "";
        doWeExit = false;
        let items170 = LoopParseFunc(out2, "\n", "\r");
...
function doseHaveInclude(TheCodeThatMightHaveInclude) {
    let items171 = LoopParseFunc(TheCodeThatMightHaveInclude, "\n", "\r");
...
function compiler(htCode, allInstructionFile, mode, langToConvertToParam = "") {
    ...
    if (HTVM_Size(argHTVMinstrMORE) > 0) {
        ...
        let items173 = LoopParseFunc(allInstructionFile_2, "\n", "\r");
    ...
    */
    ...
    let items174 = LoopParseFunc(allInstructionFile, "\n", "\r");
    ...
    if (isNotHTVMfile == 0) {
        if (langToConvertTo != langFileExtension_2) {
            ...
            if (doseHaveInclude(code)) {
                ...
                for (let A_Index176 = 0; A_Index176 < 10000 + 0; A_Index176++) {
                    ...
                    for (let A_Index177 = 0; A_Index177 < items177.length + 0; A_Index177++) {
                        ...
                        if (SubStr(StrLower(Trim(currentLine)), 1, StrLen(keyWordInclude + " ")) == StrLower(keyWordInclude + " ")) {
                            ...
                            for (let A_Index178 = 0; A_Index178 < HTVM_Size(includedFilePaths) + 0; A_Index178++) {
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (let A_Index180 = 0; A_Index180 < items180.length + 0; A_Index180++) {
            ...
            if (SubStr(Trim(A_LoopField180), 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                let items181 = LoopParseFunc(A_LoopField180);
        ...
        if (keyWordEscpaeChar == Chr(92) && langToConvertTo != langFileExtension_2) {
            ...
            let items186 = LoopParseFunc(code);
        ...
        if (langToConvertTo == "dart" || langToConvertTo == "groovy") {
            for (let A_Index188 = 0; A_Index188 < HTVM_Size(theIdNumOfThe34theVar) + 0; A_Index188++) {
        ...
        for (let A_Index189 = 0; A_Index189 < items189.length + 0; A_Index189++) {
            ...
            if (InStr(A_LoopField189, " " + keyWordComment) != false && SubStr(Trim(A_LoopField189), 1, StrLen(keyWordComment)) != keyWordComment) {
                ...
                for (let A_Index190 = 0; A_Index190 < HTVM_Size(slidingWinFixCommentsRm) + 0; A_Index190++) {
                    slidingWinFixCommentsRmI = A_Index190;
                    slidingWinFixCommentsRmHold = "";
                    for (let A_Index191 = 0; A_Index191 < StrLen(" " + keyWordComment) + 0; A_Index191++) {
        ...
        if (useCurlyBraces == "on") {
            ...
            if (keyWordCurlyBraceClose != "}") {
                ...
                for (let A_Index198 = 0; A_Index198 < items198.length + 0; A_Index198++) {
                    ...
                    let items199 = LoopParseFunc(A_LoopField198, " ");
        ...
        for (let A_Index205 = 0; A_Index205 < 2 + 0; A_Index205++) {
            outCodeFixBraces = "";
        ...
        for (let A_Index210 = 0; A_Index210 < items210.length + 0; A_Index210++) {
            ...
            if (SubStr(A_LoopField210, 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                int1 = 0;
                str17 = "";
                let items211 = LoopParseFunc(str16, " ");
                ...
                if (langToConvertTo != langFileExtension_2 && langToConvertTo != "cpp" && langToConvertTo != "go" && langToConvertTo != "cs" && langToConvertTo != "java" && langToConvertTo != "kt" && langToConvertTo != "nim" && langToConvertTo != "swift" && langToConvertTo != "dart" && langToConvertTo != "ts") {
                    if (str1 != "") {
                        str4 = "";
                        let items212 = LoopParseFunc(str1, ",");
                ...
                if (Trim(str1) == "") {
                    ...
                    str19 = "";
                    str20 = "";
                    let items213 = LoopParseFunc(str1, ",");
                    ...
                    if (Trim(str5) != "" && Trim(str10) != "") {
                        let items214 = LoopParseFunc(str5, "\n", "\r");
                        ...
                        let items215 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "go") {
                            ...
                            let items219 = LoopParseFunc(str12, ",");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index220 = 0; A_Index220 < items220.length + 0; A_Index220++) {
                                ...
                                str20 = "";
                                let items221 = LoopParseFunc(str19, " ");
                            ...
                            let items222 = LoopParseFunc(str12, ",");
                    ...
                    if (Trim(str5) != "" && Trim(str10) == "") {
                        let items223 = LoopParseFunc(str5, "\n", "\r");
                    ...
                    if (Trim(str5) == "" && Trim(str10) != "") {
                        let items224 = LoopParseFunc(str10, "\n", "\r");
                        ...
                        if (langToConvertTo == "go") {
                            ...
                            let items228 = LoopParseFunc(str11, ",");
                        ...
                        if (langToConvertTo == "java") {
                            ...
                            for (let A_Index229 = 0; A_Index229 < items229.length + 0; A_Index229++) {
                                ...
                                str20 = "";
                                let items230 = LoopParseFunc(str19, " ");
                            ...
                            let items231 = LoopParseFunc(str11, ",");
        ...
        if (langToConvertTo != "ahk" && langToConvertTo != langFileExtension_2) {
            ...
            if (haveWeEverUsedAloop == 1) {
                ...
                let items239 = LoopParseFunc(htCodeLoopfixa, "\n", "\r");
    ...
    if (COUNT_programmingBlock_HTVMsyntax != 0) {
        ...
        for (let A_Index244 = 0; A_Index244 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index244++) {
        ...
        isNotHTVMfile2 = 1;
        for (let A_Index245 = 0; A_Index245 < COUNT_programmingBlock_HTVMsyntax + 0; A_Index245++) {
    ...
    if (langToConvertTo == "go") {
        ...
        for (let A_Index261 = 0; A_Index261 < items261.length + 0; A_Index261++) {
            ...
            if (Trim(A_LoopField261) == "}" && SubStr(Trim(fixGoManGoIsSoAnnoyingBroooFurure[A_Index261 + 1]), 1, StrLen("else if ")) == "else if ") {
                ...
                let items262 = LoopParseFunc(fixGoManGoIsSoAnnoyingBroooFurure[A_Index261 + 1]);
                ...
                for (let A_Index263 = 0; A_Index263 < fixGoManGoIsSoAnnoyingBroooCount + 0; A_Index263++) {
                    fixGoManGoIsSoAnnoyingBroooCountSpaceses += " ";
                }
    ...
    if (COUNT_programmingBlock_InTheTranspiledLang != 0) {
        for (let A_Index264 = 0; A_Index264 < COUNT_programmingBlock_InTheTranspiledLang + 0; A_Index264++) {
    ...
    if (langToConvertTo == "cpp") {
        ...
        if (COUNT_programmingBlock_CPP != 0) {
            for (let A_Index266 = 0; A_Index266 < COUNT_programmingBlock_CPP + 0; A_Index266++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "py") {
        ...
        if (COUNT_programmingBlock_PY != 0) {
            for (let A_Index268 = 0; A_Index268 < COUNT_programmingBlock_PY + 0; A_Index268++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "js") {
        ...
        if (COUNT_programmingBlock_JS != 0) {
            for (let A_Index270 = 0; A_Index270 < COUNT_programmingBlock_JS + 0; A_Index270++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "go") {
        ...
        if (COUNT_programmingBlock_GO != 0) {
            for (let A_Index272 = 0; A_Index272 < COUNT_programmingBlock_GO + 0; A_Index272++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "lua") {
        ...
        if (COUNT_programmingBlock_LUA != 0) {
            for (let A_Index274 = 0; A_Index274 < COUNT_programmingBlock_LUA + 0; A_Index274++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "cs") {
        ...
        if (COUNT_programmingBlock_CS != 0) {
            for (let A_Index276 = 0; A_Index276 < COUNT_programmingBlock_CS + 0; A_Index276++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "java") {
        ...
        if (COUNT_programmingBlock_JAVA != 0) {
            for (let A_Index278 = 0; A_Index278 < COUNT_programmingBlock_JAVA + 0; A_Index278++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "kt") {
        ...
        if (COUNT_programmingBlock_KT != 0) {
            for (let A_Index280 = 0; A_Index280 < COUNT_programmingBlock_KT + 0; A_Index280++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "rb") {
        ...
        if (COUNT_programmingBlock_RB != 0) {
            for (let A_Index282 = 0; A_Index282 < COUNT_programmingBlock_RB + 0; A_Index282++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "nim") {
        ...
        if (COUNT_programmingBlock_NIM != 0) {
            for (let A_Index284 = 0; A_Index284 < COUNT_programmingBlock_NIM + 0; A_Index284++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ahk") {
        ...
        if (COUNT_programmingBlock_AHK != 0) {
            for (let A_Index286 = 0; A_Index286 < COUNT_programmingBlock_AHK + 0; A_Index286++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "swift") {
        ...
        if (COUNT_programmingBlock_SWIFT != 0) {
            for (let A_Index288 = 0; A_Index288 < COUNT_programmingBlock_SWIFT + 0; A_Index288++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "dart") {
        ...
        if (COUNT_programmingBlock_DART != 0) {
            for (let A_Index290 = 0; A_Index290 < COUNT_programmingBlock_DART + 0; A_Index290++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "ts") {
        ...
        if (COUNT_programmingBlock_TS != 0) {
            for (let A_Index292 = 0; A_Index292 < COUNT_programmingBlock_TS + 0; A_Index292++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == "groovy") {
        ...
        if (COUNT_programmingBlock_GROOVY != 0) {
            for (let A_Index294 = 0; A_Index294 < COUNT_programmingBlock_GROOVY + 0; A_Index294++) {
                if (langToConvertTo == langFileExtension_2) {
    ...
    if (langToConvertTo == langFileExtension_2) {
        ...
        if (COUNT_programmingBlock_HTVM != 0) {
            for (let A_Index296 = 0; A_Index296 < COUNT_programmingBlock_HTVM + 0; A_Index296++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        ...
        for (let A_Index297 = 0; A_Index297 < items297.length + 0; A_Index297++) {
            ...
            if (InStr(A_LoopField297, "fihuiuuhuuhtheidFor--asds")) {
                ...
                for (let A_Index298 = 0; A_Index298 < theIdNumOfThe34 + 0; A_Index298++) {
    ...
    var correctLang = 0;
    let items299 = LoopParseFunc(instructions, "\n", "\r");
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        for (let A_Index300 = 0; A_Index300 < HTVM_Size(commentsBugFix) + 0; A_Index300++) {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        for (let A_Index301 = 0; A_Index301 < HTVM_Size(allFuncNames) + 0; A_Index301++) {
        ...
        let items302 = LoopParseFunc(allLibsToPutAtTop, "|");
        for (let A_Index302 = 0; A_Index302 < items302.length + 0; A_Index302++) {
    ...
    if (langToConvertTo != langFileExtension_2) {
        for (let A_Index303 = 0; A_Index303 < HTVM_Size(ospDic1) + 0; A_Index303++) {
    ...
    if (size_ospDic != 0) {
        for (let A_Index304 = 0; A_Index304 < size_ospDic + 0; A_Index304++) {
            HTVM_Pop(ospDic);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic1 != 0) {
        for (let A_Index305 = 0; A_Index305 < size_ospDic1 + 0; A_Index305++) {
            HTVM_Pop(ospDic1);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_ospDic2 != 0) {
        for (let A_Index306 = 0; A_Index306 < size_ospDic2 + 0; A_Index306++) {
            HTVM_Pop(ospDic2);
        }
    }
    //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    if (size_htCodeFixRubyGlobalVars_EXPOSED != 0) {
        for (let A_Index307 = 0; A_Index307 < size_htCodeFixRubyGlobalVars_EXPOSED + 0; A_Index307++) {
    ...
    for (let A_Index308 = 0; A_Index308 < theIdNumOfThe34 + 0; A_Index308++) {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == langFileExtension_2) {
            for (let A_Index309 = 0; A_Index309 < HTVM_Size(weAreInMLSarr) + 0; A_Index309++) {
    ...
    if (size_weAreInMLSarr != 0) {
        for (let A_Index310 = 0; A_Index310 < size_weAreInMLSarr + 0; A_Index310++) {
...
function HTVMv2() {
    ...
    let items311 = LoopParseFunc(str0);
    for (let A_Index311 = 0; A_Index311 < items311.length + 0; A_Index311++) {
        const A_LoopField311 = items311[A_Index311 - 0];
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        let items312 = LoopParseFunc(allArgs, "\n", "\r");
        ...
        for (let A_Index313 = 0; A_Index313 < HTVM_Size(argHTVMinstrMORE) + 0; A_Index313++) {
