...
ace.define("ace/mode/ht", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/text_highlight_rules"], function (require, exports, module) {
  ...
  var HTHighlightRules = function () {
    this.$rules = {
      start: [
        { token: "comment", regex: ";.*$" },
        { token: "keywords", regex: "\\b(if|else if|else|while|for|Loop|Loop,|Loop, Parse,|continue|break|func|alliance|crew|def obj|prop|method|await|switch|case|throw|try|catch|finally|var|let|const|return|end)\\b" },
        { token: "command", regex: "\\b(StringTrimLeft|StringTrimRight|Random|Sleep|FileRead|FileAppend|FileDelete|Sort|MsgBox)(?=\\,)" },
        { token: "functions", regex: "\\b(LoopParseFunc|LoopParseFunc|LoopParseFunc|HTVM_func1|LoopParseFunc|LoopParseFunc|LoopParseFunc|MakeHotKey|HTVM_func1|print|print|STR|INT|FLOAT|STR|INT|FLOAT|INT|STR|FLOAT|InStr|Random|Sleep|input|FileRead|FileAppend|FileDelete|StrLen|Asc|Abs|ACos|ASin|ATan|Ceil|Cos|Exp|Ln|Log|Round|Sin|Sqrt|Tan|SubStr|Trim|StrReplace|StringTrimLeft|StringTrimRight|StrLower|StrSplit|Chr|Mod|Floor|Sort|getDataFromAPI|FileCreateDir|FileRemoveDir|FileExist|isWindows|GetParams|BuildInVars|RegExReplace|RunCMD|RegExMatch|ExitApp|InStr|InStr|Random|Random|Sleep|Sleep|input|FileAppend|FileDelete|FileAppend|FileRead|StrLen|Asc|StrLen|Asc|Chr|Chr|Asc|Abs|ACos|ASin|ATan|Ceil|Cos|Exp|Ln|Log|Round|Sin|Sqrt|Tan|Asc|Abs|ACos|ASin|ATan|Ceil|Cos|Exp|Ln|Log|Round|Sin|Sqrt|Tan|SubStr|SubStr|Trim|StrReplace|StringTrimLeft|StringTrimRight|StrLower|StrSplit|Chr|Mod|Floor|Trim|StrReplace|StringTrimLeft|StringTrimRight|StrLower|StrSplit|Chr|Mod|Floor|Sort|getDataFromAPI|FileCreateDir|FileRemoveDir|FileExist|isWindows|GetParams|BuildInVars|RegExReplace|RunCMD|RegExMatch|ExitApp|Sort|getDataFromAPI|getUrlParams|BuildInVars|RegExReplace|RegExMatch|MsgBox|Gui_Show|Gui_Update|Gui_Button|Gui_Edit|Gui_Text|Gui_Size|Gui_Font|Gui_Font_Id|Gui_Size_Id|GuiControl|Gui_DropDownList|Gui_Hide|Gui_Move|Gui_Color|Gui_Image|Gui_Toggle|Gui_CheckBox|getDataFromEndpoint|ErrorMsg)(?=\\()" },
